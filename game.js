...
! function () {
  ...
  s || (window.CSS = s = {}), s.supports || (s.supports = function t(e, i) {
    ...
    for (var n, a, o, r, l = /(^|not|(or)|(and))\s*\(\s*(.+?)\s*:(.+?)\)\s*|(.)/gi; o = l.exec(e);) {
      if (o[6]) return !1;
      r = t(o[4], o[5]), a = o[2] ? a || r : o[3] ? a && r : (n = !o[1], r)
    }
    return a == n
    ...
    if (!0 === e.isNew && s && i !== (i = D(i)) && (t = function (t, e) {
      for (var i = t.parentStyleSheet, s = t.parentRule, n = (s || i).cssRules, a = n.length - 1, o = 0; o <= a; o++)
        if (n[o] === t) {
          ...
          return i.insertRule(e, a), i.cssRules[a]
        }
    }(t, i)), s) {
      var n, a, o, r = t.selectorText,
        l = G(t.style);
      if (n = null == e.counters[r] ? e.counters[r] = 1 : ++e.counters[r], null != M[a = "sheet" + e.sheetId + "\n" + r + "\n" + n]) {
        if ((o = M[a]).selector === r) return o.rule = t, void (o.cssText !== l && e.toProcess.push(o));
        e.toRemove.push(o)
      } else o = M[a] = {
        key: a,
        selector: r,
    ...
    for (var t, e = [].slice.call(document.styleSheets), i = {
      ...
      if (!n.$$isPaint) {
        ...
        if (i.sheetId = n.$$paintid, i.isNew = null == i.sheetId, i.isNew) {
          if (i.sheetId = n.$$paintid = ++k, !1 === E(n)) continue;
          t = !0
        }
        L(n.sheet, I, i)
      }
    }
    for (var a = i.toRemove.length; a--;) delete M[i.toRemove[a].key];
    i.toProcess.length > 0 && W(i.toProcess.join(", ")), t && W("[data-css-paint]", !0)
  }
  ...
  function T(t) {
    var e = function (t) {
      ...
      return i.media = "print", i.$$paintid = ++k, i.appendChild(document.createTextNode(t)), e.appendChild(i), i.sheet.remove = function () {
  ...
  function O(t) {
    ...
    if (L(t, (function (t) {
      ...
      i.appendChild(document.createTextNode(e)), h.appendChild(i), x()
    }
  }
  ...
  function N(t, e) {
    e && (t.$$paintObservedProperties = null, t.$$paintGeometry && !t.$$paintGeometry.live && (t.$$paintGeometry = null)), !0 !== t.$$paintPending && (t.$$paintPending = !0, -1 === B.indexOf(t) && 1 === B.push(t) && S(U))
  }

  function U() {
    for (var t, e = 0; e < B.length; e++) B[e] && "style" === B[e].localName && (t = !0, B[e] = null);
    if (t) return S(U), void x();
  ...
  function W(t, e) {
    try {
      for (var i = document.querySelectorAll(t), s = 0; s < i.length; s++) N(i[s], e)
    } catch (t) { }
  }
  ...
  function H(t, e, i) {
    for (var s = t.length, n = function () {
      ...
      var o = new Image;
      o.onload = n, o.onerror = onerror, o.src = t[a]
    }
  }

  function q(t) {
    var e = t.$$paintId;
    return null == e && (e = t.$$paintId = ++Y), e
  }
  ...
  function _(t) {
    ...
    if (t.$$paintObservedProperties && !t.$$needsOverrides)
      ...
      } else if (t.$$paintId || f.test(G(e))) K(t, e);
    else {
      var n = t.getAttribute("style");
      f.test(n) && (t.style.cssText = n.replace(/;\s*$/, "") + "; " + t.style.cssText, K(t))
    } t.$$paintPending = !1
  }

  function z(t) {
    t.$$paintGeometry && !t.$$paintGeometry.live && (t.$$paintGeometry = null), N(t)
  }
  var $ = {
    get: function (t) {
      var e = n[t],
    ...
    getRaw: function (t) {
      ...
      return "string" == typeof e && (e = e.trim()), R[t] = e
    }
  },
    J = window.ResizeObserver && new window.ResizeObserver((function (t) {
      for (var e = 0; e < t.length; e++) {
        ...
        if (n && n.length && (n = n[0]), n) s.width = 0 | n.inlineSize, s.height = 0 | n.blockSize;
          ...
          s.width = Math.round((i.contentRect.right - i.contentRect.left || i.contentRect.width) + o), s.height = Math.round((i.contentRect.bottom - i.contentRect.top || i.contentRect.height) + r)
        }
        N(i.target, !0)
      }
    })),
      ...
      if (o.test(c) && "-webkit-border-image" !== c) {
        if (/border-image/.test(c)) {
          var x = A.width,
            ...
            O = st($.getRaw("border-image-outset").split(" "));
          x += it("0" != E.left && parseFloat(T.left) || 0, O.left || 0, !0), x += it("0" != E.right && parseFloat(T.right) || 0, O.right || 0, !0), L += it("0" != E.top && parseFloat(T.top) || 0, O.top || 0, !0), I = !0, A = {
            width: x,
            height: L += it("0" != E.bottom && parseFloat(T.bottom) || 0, O.bottom || 0, !0)
          }
        }
        for (; k = p.exec(u);) {
          !1 === S && (M = q(t)), S = !0, g += u.substring(0, k.index);
          var D = k[4] || k[5],
            B = k[3],
            N = v[D],
            U = N && N.Painter.contextOptions || {},
            W = I || !1 === U.scaling ? 1 : r,
            G = void 0;
          N && (N.Painter.inputProperties && n.push.apply(n, N.Painter.inputProperties), G = P(N)), !0 === U.nativePixels && (A.width *= r, A.height *= r, W = 1);
          var _ = W * A.width,
            z = W * A.height,
            Y = t.$$paintContext,
            K = "paint-" + M + "-" + D,
          ...
          if (!Q || Q.width != _ || Q.height != z || !0 === w && Y && K !== Y.id) {
            if (!0 === w) (Y = document.getCSSCanvasContext("2d", K, _, z)).id = K, t.$$paintContext && Y.clearRect(0, 0, _, z);
            else {
              var nt = !1;
              Q || ((Q = document.createElement("canvas")).id = K, nt = b), Q.width = _, Q.height = z, nt && (Q.style.display = "none", h.appendChild(Q)), Y = Q.getContext("2d")
            }
            t.$$paintContext = Y, Y.imageSmoothingEnabled = !1, 1 !== W && Y.scale(W, W)
          } else Y.clearRect(0, 0, _, z);
          if (G && (Y.save(), Y.beginPath(), G.paint(Y, A, $), Y.closePath(), Y.restore(), !1 === w && !b && "resetTransform" in Y && Y.resetTransform()), g += k[1], !0 === w) g += "-webkit-canvas(" + K + ")", (null == k[4] || Q && Q.id !== K) && (y = !0);
          else if (!0 === b) g += "-moz-element(#" + K + ")", null == k[4] && (y = !0), Q && Q.id !== K && (Q.id = K, y = !0);
          else {
            var at = Q.toDataURL("image/png").replace("/png", "/paint-" + D);
            if ("function" == typeof MSBlobBuilder && (at = tt(at, D)), f.push(at), g += 'url("' + at + '")', at !== B || !i) {
              var ot = B ? B.indexOf("#") : -1;
              ~ot && URL.revokeObjectURL(B.substring(0, ot)), y = !0
            }
            B = at
          }
          g += k[6], m = k.index + k[0].length
        } !1 !== S || null == l || null == l[c] ? (g += u.substring(m), y && (i || (i = j(t)), null == l && (l = t.$$paintedProperties = {}), l[c] = !0, "background" === c.substring(0, 10) && 1 !== r && et(i.style, "background-size", "100% 100%"), /mask/.test(c) && 1 !== r && (et(i.style, "mask-size", "contain"), w && et(i.style, "-webkit-mask-size", "contain")), /border-image/.test(c) && w && (et(i.style, "border-color", "initial"), et(i.style, "image-rendering", "optimizeSpeed")), 0 === f.length ? et(i.style, c, g) : H(f, et, [i.style, c, g]))) : (i || (i = j(t)), i.style.removeProperty(c), J && J.unobserve(t), t.$$paintGeometry && (t.$$paintGeometry.live = !1))
      }
    }
    ...
    return y && (s = new Promise((function (t) {
        ...
        registerPaint: function (t, e) {
          ! function (t, e, i) {
            ...
            for (var s = "", n = u.cssRules.length; n--;) {
              var a = u.cssRules[n]; - 1 !== a.style.cssText.indexOf("-" + t) && (s += a.selectorText)
            }
            s && W(s, !0)
          }(t, e, {
            context: i,
      ...
      var s = new function (t, e) {
        ...
        var s = i.contentWindow,
          n = s.document,
          a = "var window,$hook";
        for (var o in s) o in t || "eval" === o || (a += ",", a += o);
        for (var r in t) a += ",", a += r, a += "=self.", a += r;
        var l = n.createElement("script");
        l.appendChild(n.createTextNode('function $hook(self,console) {"use strict";\n\t\t' + a + ";return function() {return eval(arguments[0])}}")), n.body.appendChild(l), this.exec = s.$hook(t, console)
      }(i, d.contentDocument && d.contentDocument.body || h);
      t = (a.transpile || String)(t), s.exec(t), n && n()
    })), s
  }, !r) try {
    ! function () {
      var t = !1;
        ...
        if (!0 !== t && !Q) {
          ...
          for (var i = 0; i < e.length; i++) {
            ...
            if (!n || !("ownerSVGElement" in n))
              if ("childList" === s.type) {
                if (a = s.addedNodes)
                  for (var r = 0; r < a.length; r++) 1 === a[r].nodeType && A(a[r], N);
                if (o = s.removedNodes)
      ...
      i.value = function (t, e) {
        return "style" === t && f.test(e) && (e = D(e), q(this), this.$$needsOverrides = !0, z(this)), s.call(this, t, e)
      }, e(Element.prototype, "setAttribute", i);
      var n = Object.getOwnPropertyDescriptor(Element.prototype, "removeAttribute"),
        a = n.value;
      n.value = function (t) {
        if ("data-css-paint" !== t) return a.call(this, t)
      ...
      function w(t) {
        for (var e = t.target; e;) 1 === e.nodeType && N(e), e = e.parentNode
  ...
  function () {
    if ("undefined" != typeof document && !("adoptedStyleSheets" in document)) {
      ...
      u.replace = function (t) {
        ...
        enumerable: !0,
        get: function () {
          return I(this), l.get(this).sheet.cssRules
        }
      }), n(u, "media", {
        configurable: !0,
        enumerable: !0,
        get: function () {
          return I(this), l.get(this).sheet.media
        }
      ...
      if (D.prototype = {
        ...
        connect: function () {
          var t = T(this);
          w.get(this).observe(t, p), f.get(this).length > 0 && O(this), E(t, (function (t) {
            x(t).connect()
          }))
        },
        disconnect: function () {
        ...
        update: function (t) {
          ...
          if (!t.every(v)) throw new TypeError("Failed to set the 'adoptedStyleSheets' property on " + i + ": Failed to convert value to 'CSSStyleSheet'");
          ...
          e.sheets = t;
          var s, n, a = f.get(e),
            o = (s = t).filter((function (t, e) {
              return s.indexOf(t) === e
            }));
          (n = o, a.filter((function (t) {
          ...
          })), f.set(e, o), e.isConnected() && o.length > 0 && O(e)
        }
    ...
    function E(t, e) {
      ...
      }), null, !1), s = void 0; s = i.nextNode();) e(C(s))
    }
...
function requestWithProgress(t, e) {
  return new Promise(((i, s) => {
    ...
    n.responseType = "blob", n.addEventListener("progress", (t => {
      if (e) {
        let i = 0;
        t.lengthComputable && (i = t.loaded / t.total), e(i)
      }
    })), n.onload = e => {
...
async function addScript(t) {
  ...
  const i = new Promise(((i, s) => {
    ...
    const a = () => {
      s(new Error("unable to load srcipt " + t)), e.removeEventListener("error", a)
    };
...
class CurrencyContainer {
  ...
  animateAmount(t, {
    ...
    this.animatingDurationMs = clamp(s, 30, 100) * e * 30, this.animatingStartTime = performance.now(), this.animatingSfxEnabled = i;
    const n = !this.isAnimatingAmount;
    this.isAnimatingAmount = !0, n && this.boundAnimationLoop()
  }
  animationLoop() {
    ...
    if (i = Math.round(i), this.animatingCurrentValue != i && (this.animatingCurrentValue = i, this._setAmountText(String(i)), this.animatingSfxEnabled && performance.now() > this.lastIncrementSfxTime + 40)) {
      this.lastIncrementSfxTime = performance.now(), getMainInstance().sfx.playSound("ui/coin/pile", {
        volume: .3 * (1 - t)
      });
      const i = lerp(.7, 1, e),
        s = randInt(0, 4);
...
class UiButton {
  constructor({
    ...
    this.el = document.createElement("button"), r ? this.el.classList.add("icon-button", ...a) : this.el.classList.add("dialog-button", "blueNight", "wrinkledPaper", ...a), this.el.classList.toggle("currency-button", s), this.el.style.cssText = `\n\t\t\t--wrinkled-paper-seed: ${randInt(1, 99999)};\n\t\t`, e && (this.el.ariaLabel = e), this.textEl = document.createElement("span"), this.textEl.textContent = t, this.el.appendChild(this.textEl), this._iconEl = null, this._iconSize = h, this._iconIsInvertable = d, this._currentIcon = null, this.setIcon(l), this._visible = !0, s && (this.currencyContainer = new CurrencyContainer({
      amount: n
...
class DialogUi {
  constructor({
    ...
    customOnCurtainClickCb: e = null,
    startVisible: i = !0,
    needsCurtain: s = !0,
    needsUnlockedPointer: n = !0,
    extraClasses: a = [],
    testLabel: o = "",
    indexPriority: r = 0,
    needsWrapper: l = !1,
...
class SettingItem {
  constructor(t) {
    ...
    if (this.type = i, this.el = document.createElement("div"), this.el.classList.add("settingsItem"), this.textEl = document.createElement("div"), this.el.appendChild(this.textEl), this.textEl.textContent = e, this.textEl.classList.add("settingsItemText"), this.onValueChangeCbs = new Set, "slider" == this.type) {
      this.inputContainer = document.createElement("div"), this.inputContainer.classList.add("settingsItemSlider"), this.el.appendChild(this.inputContainer), this.sliderEl = document.createElement("input"), this.inputContainer.appendChild(this.sliderEl), this.sliderEl.type = "range", this.sliderEl.min = String(t.min), this.sliderEl.max = String(t.max), this.sliderEl.step = String(t.step || 1), this.valueEl = document.createElement("div"), this.valueEl.classList.add("settingsItemSliderValue"), this.inputContainer.appendChild(this.valueEl), this.valueEl.textContent = this.sliderEl.value;
      const e = t.triggerOnChange || !1,
        i = this.valueEl,
        s = this.sliderEl,
        n = () => {
      ...
      e && this.sliderEl.addEventListener("change", n), this.sliderEl.addEventListener("input", (() => {
        i.textContent = s.value, e || n()
      }))
    } else if ("toggle" == this.type) {
      this.toggleEl = document.createElement("input"), this.toggleEl.type = "checkbox", this.toggleEl.classList.add("dialog-checkbox-input", "wrinkledPaper"), this.el.appendChild(this.toggleEl);
...
class SettingsDialogUi extends DialogUi {
  constructor(t, e, i) {
    if (super(), this.settingsManager = t, this.dialogManager = e, this.titleEl = document.createElement("h2"), this.titleEl.classList.add("dialogTitle", "blueNight"), this.titleEl.textContent = "Settings", this.el.appendChild(this.titleEl), this.settings = new Map, this.settings.set("sfxVolume", new SettingItem({
      text: "Sound effects volume",
      type: "slider",
      min: 0,
      max: 100
    })), this.settings.set("musicVolume", new SettingItem({
      text: "Music volume",
      type: "slider",
      min: 0,
      max: 100
    })), this.settings.set("fov", new SettingItem({
      text: "Field of view",
      type: "slider",
      min: 40,
      max: 140
    })), this.settings.set("quality", new SettingItem({
      text: "Quality",
      type: "slider",
      min: .1,
      max: 3,
      step: .1
    })), this.settings.set("antialias", new SettingItem({
      text: "Anti-Aliasing",
      type: "toggle"
    })), this.settings.set("smoothFiltering", new SettingItem({
      text: "Smooth filtering",
      type: "toggle"
    })), this.settings.set("mouseSensitivity", new SettingItem({
      text: "Mouse sensitivity",
      type: "slider",
      min: .1,
      max: 5,
      step: .01
    })), this.settings.set("invertMouseY", new SettingItem({
      text: "Invert vertical mouse",
      type: "toggle"
    })), this.settings.set("mouseAcceleration", new SettingItem({
      text: "Mouse Acceleration",
      type: "toggle"
    })), this.settings.set("autoShoot", new SettingItem({
      text: "Auto shoot",
      type: "toggle"
    })), this.settings.set("walkHeadBob", new SettingItem({
      text: "Walk head bob",
      type: "toggle"
    })), this.settings.set("landHeadBob", new SettingItem({
      text: "Land head bob",
      type: "toggle"
    })), this.settings.set("theme", new SettingItem({
      text: "Theme",
      type: "enum",
      enumValues: {
    ...
    })), this.settings.set("hideUi", new SettingItem({
      text: "Hide in game UI",
      type: "toggle"
    })), this.settings.set("uiScale", new SettingItem({
      text: "UI scale",
      type: "slider",
      step: .1,
      min: .5,
      max: 2,
      triggerOnChange: !0
    })), this.settings.set("showStats", new SettingItem({
      text: "Show ping and fps",
      type: "toggle"
    })), this.settings.set("smoothCam", new SettingItem({
      text: "Smooth camera",
      type: "toggle"
    })), this.settings.set("autoSkipStatsScreen", new SettingItem({
      text: "Auto skip stats screen",
      type: "toggle"
    })), this.settings.set("chatEnabled", new SettingItem({
      text: "Show chat in squads",
      type: "toggle"
    })), i.isAprilFirst) {
      const t = new SettingItem({
    ...
    for (const [e, i] of this.settings) {
      ...
      i.setValue(s), i.onValueChange((i => {
        t.setValue(e, i)
      }))
    }
...
for (const t of classConfigs) classConfigsById.set(t.id, t);
  ...
  parseFilePositions(t) {
    ...
    for (; e < t.byteLength;) {
      ...
      this.fileLocations.push({
        ...
        start: e + 4 + i + 4,
        length: a
      }), a % 4 != 0 && (a = 4 * Math.ceil(a / 4)), e += 4 + i + 4 + a
    }
  }
  onLoad(t) {
...
class AssetsManager {
  constructor() {
    ...
    this.lastWorkerRequestId = 0, this.onWorkerMessageCbs = new Map, this.onWorkerErrorCbs = new Map, this.workerPromise = this.loadWorker()
  }
  async loadWorker() {
    const {
      worker: t
      ...
      if (t.data)
        if (t.data.requestId > 0) {
          if (t.data.dataIsError) {
            let e;
            e = t.data.data.isAggregateError ? new AggregateError(t.data.data.errors, t.data.data.message) : t.data.data.isMapLoadError ? new MapLoadError(t.data.data.message, t.data.data.name) : t.data.data;
            ...
            if (e)
              for (const {
                ...
                of e) s && !t.data.end || i(t.data.data)
          }
    ...
    return this.sendWorkerRequest("basePath", {
      basePath: e
    }, {
      overrideWorker: t
    }), t
  ...
  addPackage(t, {
    ...
    if (t in this.packages) n = this.packages[t];
      ...
      n = new AssetPackageLoader("assetPackages" + "/" + t + ".bin?v=1677494561"), this.packages[t] = n;
    ...
    if (e)
      for (; ;) {
        ...
        for (const [i, n] of Object.entries(this.packages))
          for (const a of e) i.startsWith(a) && n != t && s.push(n);
        if (!(s.length < i)) {
  ...
  async sendWorkerRequest(t, e, {
    responseCb: i = null,
    signal: s = null,
    overrideWorker: n = null
  } = {}) {
    const a = this.lastWorkerRequestId++;
    let o;
    if (o = n || await this.workerPromise, s) {
      if (s.aborted) throw new DOMException("Worker request has been aborted", "AbortError");
    ...
    i && this.onWorkerMessage(a, i);
    const r = !!s,
      l = new Promise(((t, e) => {
        this.onWorkerMessage(a, t, !0), this.onWorkerError(a, (t => {
          e(t)
        }))
      }));
  ...
  static deserializeThreeObject(t) {
    ...
    for (const i of t.geometries) {
      ...
      for (const e of i.attributes) t.setAttribute(e.name, new BufferAttribute(e.array, e.itemSize, e.normalized));
  ...
  static deserializeThreeObjectRecursive(t, e) {
    ...
    if (null != t.geo && t.geo >= 0) {
      ...
      } else t.material && (n = getMainInstance().materials.getMaterialByName(t.material) || null);
      n && (i = new Mesh(e[t.geo], n))
    }
    i || (i = new Object3D), i.name = t.name;
  ...
  async loadGlbViaWorker(t, {
    ...
    const o = await getMainInstance().assets.getPackage(e).getFileAsBuffer(t),
      r = await getMainInstance().assets.sendWorkerRequest("loadGlbAsset", {
        glbBuffer: o,
        teamId: i,
        keepCustomProperties: s,
        merge: n
    ...
    return AssetsManager.deserializeThreeObject(r)
  }
}
...
class SkinManager {
  ...
  init() {
    this.initBaseSkins(), getMainInstance().config.shopConfig.onConfigChange((async t => {
  ...
  async initBaseSkins() {
    ...
    for (const t of genders)
      for (const i of baseSkins) e.push(`baseSkins/${t}/${i}.glb`);
    for (const {
      bowId: t
    }
      of classConfigs) e.push(`bows/${t}.glb`);
    const i = {};
    for (const s of e) {
      const e = (async () => {
    ...
    await Promise.all(t), await getMainInstance().assets.sendWorkerRequest("baseSkinAssetBuffers", {
      skinBuffers: i
    })
  }
  skinObjectOptsToCacheKey(t) {
    ...
    return e.push("beardColor" + a.join(",")), e.join("-")
  }
  async getSkinObject(t, e) {
    ...
    const a = [];
    try {
      n = await getMainInstance().assets.sendWorkerRequest("buildSkin", {
        skin: i,
        teamId: t.teamId,
    ...
    if (!n && !s) {
      ...
      try {
        ...
        if (t instanceof DOMException && "AbortError" == t.name) throw t;
        throw a.push(t), new AggregateError(a)
      }
    }
    if (!n) return null;
  ...
  async getBowObject(t, e) {
    const i = await getMainInstance().assets.sendWorkerRequest("buildBow", t, {
      signal: e
    });
    return {
      bow: AssetsManager.deserializeThreeObject(i.bow),
      arrowPointIdleMatrix: (new Matrix4).fromArray(i.arrowPointIdleMatrix),
      arrowPointLoadedMatrix: (new Matrix4).fromArray(i.arrowPointLoadedMatrix)
    }
  }
  async getMeleeObject(t, e) {
    const i = await getMainInstance().assets.sendWorkerRequest("buildMelee", t, {
      signal: e
    });
    return {
      asset: AssetsManager.deserializeThreeObject(i.asset)
    }
  }
  ...
  addItemAndRemoveDuplicateSlots(t, e) {
    ...
    if (s && (e && t.add(e), s.slots))
      for (const n of s.slots)
        for (const s of t) {
          if (s == e) continue;
          const a = this.purchasableItems.get(s);
          a && a.slots && a.slots.includes(n) && (t.delete(s), i.add(s))
        }
    return i
  }
  ...
  skinNetworkDataToSkinConfig(t) {
    ...
    for (const t of processedSkinNames) {
      ...
      for (const t of baseSkins) s.add(`${e}/${t}`)
    }
    const s = [];
        ...
        if (o && o.additions)
          for (const [e, n] of Object.entries(o.additions)) {
            ...
            if (n && Array.isArray(n)) {
              ...
              for (const i of n)
                if (e.add(i), a.colorizableCategory) {
                  let e;
                  "hair" == a.colorizableCategory ? e = t.hairColorMultiplier : "eyebrows" == a.colorizableCategory ? e = t.eyebrowColorMultiplier : "beard" == a.colorizableCategory && (e = t.beardColorMultiplier), e && s.push({
                    assetName: i,
                    colorMultiplier: e,
                    joints: [o]
                  })
        ...
        if (n && n.removals)
          for (const [t, s] of Object.entries(n.removals)) {
            ...
            if (s && Array.isArray(s)) {
              const t = i.get(n);
              if (t)
                for (const i of s) baseSkins.includes(i) ? t.delete(`${e}/${i}`) : t.delete(i)
            }
          }
      }
      for (const s of t.equippedSkinIds) {
  ...
  getConfigForPreviewShopItemId(t, {
    ...
    return i && s && ("hair" == i ? a.hairColorMultiplier = s : "eyebrows" == i ? a.eyebrowColorMultiplier = s : "beard" == i && (a.beardColorMultiplier = s)), a
  }
...
class PagedView {
  ...
  createAndPushPage(t) {
    ...
    if (e.classList.add("paged-view-page"), t.headerVisible || void 0 === t.headerVisible) {
      ...
      if (a.classList.add("paged-view-page-header-title"), a.textContent = t.header || t.itemName || "", i.appendChild(a), t.rightCorner) {
        const e = document.createElement("div");
...
class PlayerSkeleton {
  constructor({
    ...
    this.player = t, this.isInit = !1, this.onInitCbs = new Set, this.onAllLinkLayerObjectsBuiltCbs = new Set, this._currentGender = e, this.poseLayers = [], this.skeletonMatrixObjects = [], this.baseSkeletonObject = null, this.headObj = null, this.bodyObj = null, this.armLObj = null, this.armRObj = null, this.legLObj = null, this.legRObj = null, this.initCalled = !1
  }
  async init() {
    if (this.initCalled) return await this.waitForLoad();
    this.initCalled = !0, this.baseSkeletonObject = await getMainInstance().skeletons.getSkeleton("male/baseRig", {
      clone: !0
    });
    ...
    this.headObj = this.baseSkeletonObject.getObjectByName("head"), this.bodyObj = this.baseSkeletonObject.getObjectByName("torso"), this.armLObj = this.baseSkeletonObject.getObjectByName("upperArmL"), this.armRObj = this.baseSkeletonObject.getObjectByName("upperArmR"), this.legLObj = this.baseSkeletonObject.getObjectByName("upperLegL"), this.legRObj = this.baseSkeletonObject.getObjectByName("upperLegR"), this.isInit = !0;
  ...
  applyLookRotation(t, e, i) {
    ...
    a.setFromAxisAngle(n, i), t.quaternion.multiply(a)
  }
  applyLayers() {
    this.assertInit();
...
class MaterialsManager {
  ...
  init() {
    ...
    this.basicUnlitMat = this.createMaterial({
      ...
      depthWrite: !1
    }), this.skyDomeMat.side = BackSide, this.lightsMat = this.createMaterial({
      name: "lights",
      fog: !1,
      applyWorldColor: !1,
      depthWrite: !1,
      depthTest: !0
    }), this.lightsMat.blending = AdditiveBlending, this.screenFlashMat = this.createMaterial({
      name: "screenFlash",
      fog: !1,
      applyWorldColor: !1,
      depthWrite: !1,
    ...
    const s = processedSkinNames.length,
      n = [];
    for (let t = 0; t < s; t++) n.push(new Matrix4);
    const a = [],
      o = [];
    for (let t = 0; t < 5; t++) a.push(0), o.push(new Vector3);
    const r = {
      vertexShaderOpts: {
  ...
  async precompileShaders() {
    ...
    if (!n) return;
    const a = s.cam.cam;
    for (const e of this.materialsCache.values()) await getMainInstance().renderer.waitForFrameRender(), i.material = e, n.compile(t, a);
  ...
  static resetWeatherUniforms(t) {
    t.uniforms.colorMultiplier.value.set(new Color(1, 1, 1)), t.uniforms.colorAdder.value.set(new Color(0, 0, 0)), t.uniforms.saturation.value = 1, t.uniforms.fogAmount.value = 0, t.uniforms.fogHeightAmountMin.value = 0, t.uniforms.fogHeightAmountMax.value = 0
  }
  setLightningValue(t) {
  ...
  createMaterial({
    ...
    e = {
      ...
      ...m,
      ...i
    }, f = s || this.buildVertexShader(e), w = n || this.buildFragShader(i), a = {
      saturation: {
        value: 1
      },
      colorMultiplier: {
...
function computeApproximateBoundingSphere(t, {
  skinMatrices: e = null
} = {}) {
  let i = null;
  const s = new Vector3;
  for (const n of traverseObject(t))
    if (n instanceof Mesh && n.geometry) {
      ...
      for (let n = 0; n < t.count; n++) {
        if (s.fromBufferAttribute(t, n), a && e) {
          const t = e[a.getX(n)];
          s.applyMatrix4(t)
        }
        i ? i.expandByPoint(s) : i = new Box3(s.clone(), s.clone())
      }
    } if (!i) return new Sphere(new Vector3(0, 0, 0), 1);
  ...
  for (const i of traverseObject(t))
    if (i instanceof Mesh && i.geometry) {
      ...
      for (let i = 0; i < t.count; i++) {
        if (s.fromBufferAttribute(t, i), o && e) {
          const t = e[o.getX(i)];
          s.applyMatrix4(t)
        }
...
class PlayerModel {
  ...
  destructor() {
    ...
    if (this.materials = [], this.obj) {
      for (const t of traverseObject(this.obj)) t instanceof Mesh && t.geometry.dispose();
      this.obj = null
    }
  ...
  async init() {
    ...
    if (t && (t.geometry.boundingSphere = new Sphere(new Vector3(0, 1, 0), 1), !this.destructed)) {
      this.obj = t;
      const e = new Map;
      this.obj.traverse((t => {
    ...
    if (!this.useWorldWeather)
      for (const t of this.materials) MaterialsManager.resetWeatherUniforms(t);
    this.isInit = !0;
    for (const t of this.onInitCbs) t();
    this.onInitCbs.clear()
  }
...
}), statClassConfigs.set("meleeAttackStrength", {}), statClassConfigs.set("meleeAttackSpeed", {}), statClassConfigs.set("meleeAttackReach", {});
class ConfirmItemPurchaseDialogUi extends DialogUi {
  constructor(t, {
    ...
    }), this.onPurchaseSuccessCbs = new Set, this.shopItem = new ShopItem(t, {
    ...
    t.price && t.price > 0 ? (i.showCurrency = !0, i.currency = t.price) : (i.text = "Get Item", t.hasRewardedAd && (i.icon = "static/img/rewardedAdIcon.svg")), this.purchaseButton = this.addButton(i), getMainInstance().shopState.isPurchasingItem(t.id) && (this.setButtonEnabled(!1), (async () => {
      await getMainInstance().shopState.waitForItemPurchase(t.id), this.setButtonEnabled(!0)
    })())
  }
  destructor() {
...
class BowAssetLoader {
  constructor({
    ...
    this.obj = new Object3D, this.obj.name = "Bow asset loader", this.arrowAssetName = "arrow.glb", this.useWorldWeather = t, this.lastFireAmount01 = 0, this.lastVisibleCount = 0, this.currentBowAsset = null, this.onFirstAssetLoadCbs = new Set, this.onAssetChangeCbs = new Set, this.currentlyLoadingAbortController = null, this.currentlyLoadedMaterials = [], this.currentArrowObjs = [], this.currentArrowOffsets = [], this.arrowPointIdle = new Object3D, this.arrowPointIdle.name = "Arrow point idle", this.obj.add(this.arrowPointIdle), this.arrowPointLoaded = new Object3D, this.arrowPointLoaded.name = "Arrow point loaded", this.obj.add(this.arrowPointLoaded)
  }
  destructor() {
    this.destroyMaterials(), this.destroyBowMeshes()
  }
  setArrowAssetName(t) {
    this.arrowAssetName = t
  }
  async setConfig(t) {
    ...
    const {
      bow: a,
      arrowPointIdleMatrix: o,
      arrowPointLoadedMatrix: r
    } = s, l = await i.arrowAssetCache.getArrowAssetWithCache(this.arrowAssetName, t.teamId);
    if (e.signal.aborted) return;
    if (this.currentBowAsset && this.obj.remove(this.currentBowAsset), this.destroyMaterials(), this.destroyBowMeshes(), this.currentBowAsset = a, this.obj.add(a), !(a instanceof Mesh)) throw new Error("Assertion failed, bow is not a mesh");
    const h = a.material;
    if (!Array.isArray(h)) throw new Error("Assertion failed, materials is not an array");
    for (let t = 0; t < h.length; t++) {
      const e = h[t].clone();
      h[t] = e, e instanceof ShaderMaterial && (this.useWorldWeather || MaterialsManager.resetWeatherUniforms(e)), this.currentlyLoadedMaterials.push(e)
    }
    for (const t of this.currentArrowObjs) t.parent && t.parent.remove(t);
    this.currentArrowObjs = [];
    const d = t.arrowCount ?? 1,
      c = "stacked" == t.arrowPositions;
    for (let t = 0; t < d; t++) {
      const e = l.clone();
      e.position.z = .6, a.add(e), this.currentArrowObjs.push(e);
      const i = new Vector2;
      c ? i.set(0, .01 * t) : (i.x = Math.cos(t) * t * .01, i.y = Math.sin(t) * t * .01), this.currentArrowOffsets.push(i)
    }
    this.arrowPointIdle.position.set(0, 0, 0), this.arrowPointIdle.quaternion.identity(), this.arrowPointIdle.scale.set(1, 1, 1), this.arrowPointIdle.applyMatrix4(o), this.arrowPointLoaded.position.set(0, 0, 0), this.arrowPointLoaded.quaternion.identity(), this.arrowPointLoaded.scale.set(1, 1, 1), this.arrowPointLoaded.applyMatrix4(r), this.updateFireAmount(this.lastFireAmount01, this.lastVisibleCount), this.currentlyLoadingAbortController = null, this.onFirstAssetLoadCbs.forEach((t => t())), this.onFirstAssetLoadCbs.clear(), this.onAssetChangeCbs.forEach((t => t(a)))
  }
  destroyMaterials() {
  ...
  destroyBowMeshes() {
    if (this.currentBowAsset)
      for (const t of traverseObject(this.currentBowAsset)) t instanceof Mesh && t.geometry.dispose()
  }
  async waitForLoad() {
  ...
  updateFireAmount(t, e) {
    ...
    for (const [i, s] of this.currentArrowObjs.entries()) {
      s.position.lerpVectors(this.arrowPointIdle.position, this.arrowPointLoaded.position, t);
      const n = this.currentArrowOffsets[i];
      s.position.x += n.x, s.position.y += n.y, s.scale.lerpVectors(this.arrowPointIdle.scale, this.arrowPointLoaded.scale, t), s.quaternion.slerpQuaternions(this.arrowPointIdle.quaternion, this.arrowPointLoaded.quaternion, t), s.visible = e > i
    }
    for (const e of this.currentlyLoadedMaterials) e instanceof ShaderMaterial && (e.uniforms.bowMorphAmount.value = t)
  }
}
class MeleeAssetLoader {
  constructor({
    useWorldWeather: t = !0
  } = {}) {
    this.obj = new Object3D, this.obj.name = "Melee asset loader", this.useWorldWeather = t, this.currentlyLoadingAbortController = null, this.currentAssetName = "", this.currentMeleeAsset = null, this.onFirstAssetLoadCbs = new Set, this.currentlyLoadedMaterials = []
  }
  destructor() {
    this.destroyMaterials(), this.destroyBowMeshes()
  }
  async setConfig(t) {
    ...
    let s;
    try {
      s = await i.skins.getMeleeObject(t, this.currentlyLoadingAbortController.signal)
    } catch (t) {
      if (t instanceof DOMException && "AbortError" == t.name) return;
      throw t
    }
    ...
    this.currentMeleeAsset && this.obj.remove(this.currentMeleeAsset), this.destroyMaterials(), this.destroyBowMeshes(), this.currentMeleeAsset = n, this.obj.add(n), this.currentlyLoadingAbortController = null, this.onFirstAssetLoadCbs.forEach((t => t())), this.onFirstAssetLoadCbs.clear()
  }
  destroyMaterials() {
    for (const t of this.currentlyLoadedMaterials) t.dispose();
    this.currentlyLoadedMaterials = []
  ...
  destroyBowMeshes() {
    if (this.currentMeleeAsset)
      for (const t of traverseObject(this.currentMeleeAsset)) t instanceof Mesh && t.geometry.dispose()
  }
  async waitForLoad() {
    if (!this.isLoadingAsset) return;
    const t = new Promise((t => this.onFirstAssetLoadCbs.add(t)));
...
class ShopItem {
  constructor(t, {
    ...
    if (this.configIndex = e, this.config = t, this.usage = i, this.renderOptions = s, this.destructed = !1, "shop" == i) this.el = document.createElement("button");
    else {
    ...
    if (this.renderView = getMainInstance().renderer.createRenderView({
      width: 200,
      height: 200
    }), (this.config.meleeSkin || this.config.bowSkin) && this.renderView.canvas.classList.add("needs-mask"), this.el.appendChild(this.renderView.canvas), this.cam = new PerspectiveCamera, this.cam.far = 10, this.camTarget = new Object3D, this.rotY = 0, this.defaultRotY = .2 * Math.PI, this.camTarget.rotation.set(-.1 * Math.PI, this.defaultRotY, 0, "YZX"), this.camTarget.add(this.cam), this.scene = new Scene, this.scene.add(this.camTarget), this.renderView.setRenderObjects(this.scene, this.cam, !1), this.skeleton = new PlayerSkeleton({
      gender: this.renderOptions.gender
    }), this.skeleton.addPoseLayer("shopItem"), this.loadingModelSym = null, this.loadingModel = null, this.visibleModel = null, this.skinObject = null, this.bowAsset = null, this.meleeAsset = null, this.currencyWrapperEl = null, this.currencyContainer = null, "shop" == i ? this.setOwned(!this.config.price && !this.config.hasRewardedAd) : this.setOwned(!0), this.lockEl = document.createElement("div"), this.lockEl.classList.add("shopItemLock"), this.lockEl.classList.toggle("rewarded-break-unlockable", this.config.hasRewardedAd || !1), this.el.appendChild(this.lockEl), this.config.statClasses) {
      const t = document.createElement("div");
      t.classList.add("shopItemStatClassesContainer"), this.el.appendChild(t);
      for (const e of Object.keys(this.config.statClasses)) {
        const i = e,
          s = statClassConfigs.get(i);
        if (!s) continue;
        const n = s.icon;
        if (!n) continue;
        const a = document.createElement("div");
        a.classList.add("shopItemStatClassIcon"), a.style.backgroundImage = `url("${n}")`, t.appendChild(a)
      }
    }
  ...
  destructor() {
    this.destructed = !0, getMainInstance().renderer.removeRenderView(this.renderView), this.loadingModel && this.loadingModel.destructor(), this.visibleModel && this.visibleModel.destructor(), this.bowAsset && this.bowAsset.destructor(), this.stopLooping(), this.intersectionObserver.unobserve(this.el), this.intersectionObserver.disconnect()
  }
  setRenderOptions(t) {
  ...
  async reloadSkinObjectNow() {
    ...
    let e;
    if (this.loadingModelSym = t, this.loadingModel && (this.loadingModel.destructor(), this.loadingModel = null), this.bowAsset && this.bowAsset.destructor(), this.meleeAsset && this.meleeAsset.destructor(), this.config.bowSkin) {
      const i = getMainInstance().skins.skinNetworkDataToBowAssetNames(this.config.bowSkin.bowId, {
      ...
      if (getMainInstance().skins.skinNetworkDataToMeleeSkinConfig({
        ...
        if (this.meleeAsset = new MeleeAssetLoader({
          useWorldWeather: !1
        }), this.meleeAsset.setConfig({
          skinAssetName: this.config.meleeSkin.skin,
          teamId: 1
        }), this.scene.add(this.meleeAsset.obj), await this.meleeAsset.waitForLoad(), t != this.loadingModelSym) return;
        e = computeApproximateBoundingSphere(this.meleeAsset.obj)
      }
    } else {
      const i = [],
      ...
      let a = {};
      if (n.additions && (a = n.additions), this.config.showFullBodyInShopItem) {
  ...
  animationLoop() {
    ...
    if (this.prevNow = t, this.isHovering || "confirmPurchase" == this.usage ? (this.rotY -= .001 * e, this.rotY = mod(this.rotY + Math.PI, 2 * Math.PI) - Math.PI) : (this.rotY = lerp(this.rotY, 0, .1), Math.abs(this.rotY) < .001 && this.stopLooping()), this.camTarget.rotation.y = this.rotY + this.defaultRotY, this.shouldStopLooping) return this.isLooping = !1, this.shouldStopLooping = !1, this.prevNow = 0, void (this.renderView && (this.renderView.alwaysDirty = !1));
  ...
  openConfirmPurchaseDialog() {
    ...
    getMainInstance().dialogManager.addDialog(t), t.onPurchaseSuccess((() => {
...
class SkinDownloaderDialogUi extends DialogUi {
  constructor(t, e, i) {
    ...
    const s = document.createElement("div");
    s.classList.add("skin-downloader-dialog-controls"), this.contentEl.appendChild(s);
    const n = document.createElement("div");
    n.textContent = "Team color ", s.appendChild(n), this.teamColorInput = document.createElement("input"), this.teamColorInput.type = "color", this.teamColorInput.value = teamColors[1].cssColor, this.teamColorInput.addEventListener("change", (() => this.reloadPreview())), n.appendChild(this.teamColorInput);
    const a = document.createElement("div");
    a.textContent = "Background color ", s.appendChild(a), this.backgroundColorInput = document.createElement("input"), this.backgroundColorInput.type = "color", this.backgroundColorInput.value = teamColors[2].cssColor, this.backgroundColorInput.addEventListener("change", (() => this.reloadPreview())), a.appendChild(this.backgroundColorInput);
    const o = document.createElement("div");
    o.textContent = "Background opacity ", s.appendChild(o), this.backgroundOpacityInput = document.createElement("input"), this.backgroundOpacityInput.type = "range", this.backgroundOpacityInput.min = "0", this.backgroundOpacityInput.max = "1", this.backgroundOpacityInput.step = "0.01", this.backgroundOpacityInput.value = "1", this.backgroundOpacityInput.addEventListener("change", (() => this.reloadPreview())), o.appendChild(this.backgroundOpacityInput);
    const r = document.createElement("div");
    r.textContent = "Shape ", s.appendChild(r), this.shapeInput = document.createElement("select");
    for (const t of ["none", "circle"]) {
      const e = document.createElement("option");
      e.value = t, e.textContent = t, this.shapeInput.appendChild(e)
    }
    this.shapeInput.value = "circle", this.shapeInput.addEventListener("change", (() => this.reloadPreview())), r.appendChild(this.shapeInput);
    const l = document.createElement("div");
    l.textContent = "Camera ", s.appendChild(l), this.cameraInput = document.createElement("select");
    ...
    h.textContent = "Pose ", s.appendChild(h), this.poseInput = document.createElement("select");
    const d = [];
    d.push(["", "None"]);
    for (const {
      uiName: t,
    ...
    c.textContent = "Size ", s.appendChild(c), this.widthInput = document.createElement("input"), this.widthInput.classList.add("skin-downloader-size-input"), this.widthInput.type = "number", this.widthInput.value = "1024", c.appendChild(this.widthInput), c.appendChild(document.createTextNode(" x ")), this.heightInput = document.createElement("input"), this.heightInput.classList.add("skin-downloader-size-input"), this.heightInput.type = "number", this.heightInput.value = "1024", c.appendChild(this.heightInput);
    const u = document.createElement("div");
    u.classList.add("skin-downloader-download-container"), s.appendChild(u);
  ...
  getCurrentAvatarConfig(t, e) {
    ...
    if (this.poseInput.value) {
      ...
      o = [t.bowId + "/shopClassItem"], r = {
        teamId: 1,
        teamColor: a,
        bowId: t.bowId,
        arrowCount: 1,
        skins: getMainInstance().skins.skinNetworkDataToBowAssetNames(t.bowId, this.skinConfig)
      }
    }
    const l = {
...
class ShopSkinPreview {
  constructor() {
    this.destructed = !1, this.el = document.createElement("div"), this.el.classList.add("shopSkinPreview", "wrinkledPaper", "wrinkled-paper-mask"), this.currentlyLoadedSkinData = null, this.currentTeamId = 1, this.el.addEventListener("click", (() => {
      ...
      rot: -1.7
    }), this.setActiveSlotPosition("full", !0), this.renderView.setRenderObjects(this.scene, this.cam), this.boundOnMouseMove = this.onMouseMove.bind(this), window.addEventListener("mousemove", this.boundOnMouseMove), this.lastMouseX = 0, this.lastMouseY = 0, this.skeleton = new PlayerSkeleton, this.skeleton.init(), this.activeExtraPoseLayer = null, this.bowAssetLoader = new BowAssetLoader({
      useWorldWeather: !1
    }), this.bowAssetLoader.updateFireAmount(1, 1), this.hoveringBowAssetLoader = new BowAssetLoader({
      useWorldWeather: !1
    }), this.hoveringBowAssetLoader.updateFireAmount(1, 1), this.bowParentObj.add(this.bowAssetLoader.obj), this.bowParentObj.add(this.hoveringBowAssetLoader.obj), this.bowSkeletonObj = null, this.currentVisibleBowId = null, this.currentEquippedSkinIds = [], this.hoveringBowVisible = !1, this.meleeAssetLoader = new MeleeAssetLoader({
      useWorldWeather: !1
    }), this.hoveringMeleeAssetLoader = new MeleeAssetLoader({
      useWorldWeather: !1
  ...
  loop(t, e) {
    ...
    this.camTarget.position.distanceTo(s) > .01 && (i = !0), this.camTarget.position.lerp(s, .1);
    Math.abs(this.camTarget.rotation.y - this.smoothCamTargetRot) > .01 && (i = !0), this.camTarget.rotation.y = lerp(this.camTarget.rotation.y, this.smoothCamTargetRot, .1), i && this.renderView.markDirty()
  }
  setHoveringModel(t) {
    if (this.hoveringModelVisible = !1, t) {
      this.hoveringModelVisible = !0;
      const e = getMainInstance().skins.skinObjectOptsToCacheKey(t);
      this.lastHoveringModelCacheKey != e && (this.lastHoveringModelCacheKey = e, this.removeModel(this.hoveringModel), this.hoveringModel = null, t && (this.hoveringModel = new PlayerModel({
        skinObjectOpts: t,
        useWorldWeather: !1
    ...
    if (this.updateVisibleModel(), this.hoveringBowVisible = !1, this.hoveringMeleeVisible = !1, t)
      if (this.currentVisibleBowId) {
        const e = getMainInstance().skins.skinNetworkDataToBowAssetNames(this.currentVisibleBowId, t.skin);
  ...
  setCurrentSkinConfig(t) {
    this.currentlyLoadedSkinData = t, this.removeModel(this.loadingModel), this.loadingModel = new PlayerModel({
      skinObjectOpts: {
        teamId: this.currentTeamId,
        skin: t
      },
  ...
  updateBowConfig() {
    if (this.currentVisibleBowId) {
      const t = getMainInstance().skins.skinNetworkDataToBowAssetNames(this.currentVisibleBowId, {
...
class ShopSkinCustomizationView {
  constructor(t, {
    ...
    let s;
    this.el = document.createElement("div"), this.el.classList.add("shopDialogContent"), this.skinManager = t, this.customizationId = e, this.onBackButtonClickCbs = new Set, this.pagedView = new PagedView({
      extraClasses: ["shop-paged-view-container"]
    }), this.el.appendChild(this.pagedView.el), this.createdGrids = new Map, this.skinPreview = new ShopSkinPreview, this.el.appendChild(this.skinPreview.el), this.updateSkinPreviewConfig(), this.filterSubPages = new Map;
    let n = null;
    if ("class" == e.type) {
      ...
      const t = [];
      for (const e of classConfigs) t.push({
        itemName: e.uiName,
        subPages: [this.createGridViewSubPage({
          itemName: "Handle",
          buttonIcon: "static/img/menuUI/shop/categoryIcons/bowHandle.svg",
    ...
    this.pagedView.setActiveStructure({
      ...
      rightCorner: i => {
        if ("class" == e.type) {
          ...
          a.classList.add("dialog-select-wrapper", "wrinkledPaper"), i.appendChild(a);
          const o = document.createElement("select");
          o.classList.add("dialog-select-input", "blueNight"), a.appendChild(o);
          const r = document.createElement("option");
          r.value = "none", r.textContent = "None", o.appendChild(r);
          for (const e of t.skinPresets.keys()) {
            const t = document.createElement("option");
            t.value = String(e), t.textContent = `Preset ${e + 1}`, o.appendChild(t)
          }
          null == n.presetId ? o.value = "none" : o.value = String(n.presetId), o.addEventListener("change", (() => {
            let t;
            t = "none" == o.value ? null : Number(o.value), this.skinManager.setClassPreset(s, t), this.updateSkinPreviewConfig()
          }))
        }
      },
      subPages: [{
        ...
        rightCorner: t => {
          ...
          const s = document.createElement("div");
          s.classList.add("gender-icon", "male"), i.appendChild(s);
          ...
          n.checked = "female" == a, n.addEventListener("change", (() => {
  ...
  resetSkinPreview({
    ...
    this.skinPreview.setActiveSlotPosition(t), this.skinPreview.setSkeletonPose(null), this.skinPreview.setBow(null), this.skinPreview.setMelee(null)
  }
  ...
  createGridViewSubPage({
    ...
    if ("none" != l && (h.rightCorner = t => {
      ...
      for (const t of s.shopCategoriesFilter) this.filterSubPages.set(t, h);
    return h
  }
    ...
    if ("uncategorized" == i) return t.filter((t => !t.categories)); {
      ...
      return t.filter((t => {
        if ("rewarded" == i) {
          ...
          if (o.has(t.id)) return !1
        }
        if (n && t.bowSkin && n != t.bowSkin.bowId) return !1;
        if (a && !t.bowSkin) return !1;
        if (!t.showFullBodyInShopItem && !t.bowSkin && !t.meleeSkin) {
  ...
  createShopItemsGrid(t, {
    ...
    t.appendChild(n.el);
    const a = () => {
      const t = this.getShopItemRenderOptions(s),
        i = getMainInstance().config.shopConfig.loadedConfigData,
        a = i ? i.purchasableItems : [],
        o = this.filterPurchasableItems(a, t.gender, e);
      n.loadShopItems(o, {
        renderOptions: t
      })
    },
      o = getMainInstance();
    if (o.config.shopConfig.onConfigChange(a), n.onHoveringItemChange((t => {
      let e = null;
    ...
    })), n.setPurchasedItems(o.shopState.purchasedItems), "preset" == this.customizationId.type) {
  ...
  destroyShopItemsGrid(t) {
    ...
    i.destructor(), this.createdGrids.delete(t), getMainInstance().config.shopConfig.removeOnConfigChange(s)
  }
}
...
class ClassSelectionItem {
  constructor(t) {
    ...
    e.classList.add("dialogTitle", "blueNight"), e.textContent = t.uiName, this.el.appendChild(e), this.onClickCbs = new Set, this.classSelectionImage = new ClassSelectionImage(t.id);
    const {
      colors: i
    } = getMainInstance().gameManager.getMyTeamColor();
...
class ShopPresetsView {
  constructor(t) {
    ...
    s.textContent = "Presets", s.classList.add("dialogTitle", "blueNight", "shop-presets-title"), e.appendChild(s), this.presetsList = document.createElement("div"), this.presetsList.classList.add("shop-skin-selection-list"), this.el.appendChild(this.presetsList), this.createdPresetItems = [], this.addPresetButton = new UiButton({
      text: "+",
...
class ShopDialogUi extends DialogUi {
  constructor() {
    ...
    this.boundUpdateShopState = this.updateShopState.bind(this), getMainInstance().shopState.onStateChanged(this.boundUpdateShopState), getMainInstance().shopState.fetchCurrentData(), this.updateShopState()
  }
  destructor() {
    getMainInstance().shopState.removeOnStateChanged(this.boundUpdateShopState), this.hideCustomizationView(), this.hidePresetsView(), super.destructor();
  ...
  updateShopState() {
    this.currencyContainer.setAmount(getMainInstance().shopState.ownedCoins), this.currentCustomizationView && this.currentCustomizationView.updateShopState(getMainInstance().shopState.purchasedItems)
  }
  ...
  showCustomizationView(t) {
    ...
    this.currentCustomizationView = new ShopSkinCustomizationView(e, t), this.el.appendChild(this.currentCustomizationView.el), this.currentCustomizationView.onBackButtonClick((() => {
  ...
  openShopItemSubPage(t, e) {
    ...
    for (const t of Object.values(s.classSkins))
      if (null != t.presetId) {
        ...
        r = 0;
    for (const [t, e] of a) e > r && (o = t, r = e);
...
class UserProfileDialogUi extends DialogUi {
  constructor() {
    super(), this.userNameText = document.createElement("input"), this.userNameText.placeholder = "Username", this.userNameText.maxLength = 20, this.userNameText.addEventListener("change", (async () => {
      ...
      onClick: async () => {
        ...
        if (t)
          if (t.success) getMainInstance().dialogManager.showAlert({
            ...
            "already-linked" == t.error ? e = "This account is already linked to you." : console.error("Account link error: " + t.error), getMainInstance().dialogManager.showAlert({
  ...
  async init() {
    await getMainInstance().auth.loginIfNotLoggedIn(!0) ? (this.linkAccountButton.visible = !0, this.logoutButton.visible = !0, this.logoutEverywhereButton.visible = !0) : this.close(), this.boundUpdateProfileState = this.updateProfileState.bind(this), getMainInstance().profileState.onStateChanged(this.boundUpdateProfileState), getMainInstance().profileState.fetchCurrentData(), this.updateProfileState()
  }
  updateProfileState() {
...
class CornerProfile {
  ...
  setUsername(t) {
    t || (t = "Guest"), this.usernameEl.textContent = t, this.usernameEl.classList.toggle("blueNight", stringContainsOnlyBlueNightGlyphs(t))
  }
}
class MainMenuPromoBanner {
  ...
  loadNewBestPromo() {
    ...
    let e = null,
      ...
      s = this.activePromos;
    for (const n of s) {
      if (!n || !n.id || !n.image) continue;
      if (n.actionShopItem && this.shopStateManager.itemIsPurchased(n.actionShopItem)) continue;
      if (n.seasonalRange) {
        const t = n.seasonalRange;
        if (t.startDay && t.endDay && t.startMonth && t.endMonth) {
          const e = new Date,
            i = new Date(e.getFullYear(), t.startMonth - 1, t.startDay),
            s = new Date(e.getFullYear(), t.endMonth - 1, t.endDay),
            n = new Date(e.getFullYear(), e.getMonth(), e.getDate());
          if (n < i || n > s) continue
        }
      }
      t.delete(n.id);
      const s = this.getPromoViewData(n.id),
        a = n.maxViewCount || 5; - 1 != a && s.viewCount >= a || s.viewCount <= i && (e = n, i = s.viewCount)
    }
...
class SquadSettingsDialogUi extends DialogUi {
  constructor(t) {
    super(), this.squadManager = t, this.settings = new Map, this.settings.set("privateSquad", new SettingItem({
      text: "Private squad",
      type: "toggle",
      min: 0,
      max: 100
...
class SquadDialogUi extends DialogUi {
  constructor(t, e, i, s, n) {
    super(), this.networkManager = t, this.squadManager = e, this.gameManager = i, this.avatarsManager = s, this.skinManager = n;
    const a = document.createElement("div");
    a.classList.add("squad-split-container"), this.el.appendChild(a);
    const o = document.createElement("div");
    o.classList.add("squad-split-section"), a.appendChild(o);
    const r = document.createElement("h3");
    r.classList.add("dialogTitle", "blueNight"), r.textContent = "Invite someone", o.appendChild(r);
    const l = document.createElement("div");
    l.classList.add("squad-id-block"), o.appendChild(l);
    const h = document.createElement("div");
    h.textContent = "Invite Code:", l.appendChild(h);
    const d = document.createElement("div");
    d.classList.add("squad-id-container"), l.appendChild(d), this.currentSquadId = null, this.squadIdText = document.createElement("div"), this.squadIdText.classList.add("allow-select", "squad-id"), d.appendChild(this.squadIdText);
    const c = document.createElement("div");
    c.classList.add("squad-id-copied-text"), c.textContent = "Copied!", this.copyUrlButton = new UiButton({
      isIconButton: !0,
      ariaLabel: "Copy squad id to clipboard",
      icon: "static/img/menuUI/copy.svg",
      extraClasses: ["squad-id-button"],
      onClick: async () => {
        null != this.currentSquadId && (await navigator.clipboard.writeText(this.currentSquadId), c.classList.remove("animating"), c.offsetHeight, c.classList.add("animating"))
      }
    }), d.appendChild(this.copyUrlButton.el), this.copyUrlButton.el.appendChild(c), this.clipboardPermissionGranted = !1, this.updateCopyUrlButtonVisibility(), this.queryClipboardPermission();
    const u = document.createElement("div");
    u.classList.add("squad-split-divider"), a.appendChild(u);
    const p = document.createElement("div");
    p.classList.add("squad-split-divider-line", "wrinkledLine"), p.style.cssText = "--wrinkled-line-seed: 18", u.appendChild(p);
    const g = document.createElement("span");
    g.textContent = "or", u.appendChild(g);
    const m = document.createElement("div");
    m.classList.add("squad-split-divider-line", "wrinkledLine"), m.style.cssText = "--wrinkled-line-seed: 12", u.appendChild(m);
    const f = document.createElement("div");
    f.classList.add("squad-split-section"), a.appendChild(f);
    const w = document.createElement("h3");
    w.classList.add("dialogTitle", "blueNight"), w.textContent = "Join existing squad", f.appendChild(w);
    const b = document.createElement("form");
    b.classList.add("text-with-submit-form"), f.appendChild(b), b.addEventListener("submit", (async t => {
    ...
    }), b.appendChild(this.joinSquadIdInput.el), this.joinSquadIdButton = new UiButton({
      text: "Join"
    }), b.appendChild(this.joinSquadIdButton.el), this.updateJoinButtonVisibility();
    const y = document.createElement("div");
    y.classList.add("in-squad-content"), this.el.appendChild(y);
    const S = document.createElement("div");
    S.classList.add("squad-players-list", "wrinkledPaper", "wrinkled-paper-mask"), S.style.cssText = `\n\t\t\t--wrinkled-paper-seed: ${randInt(1, 99999)};\n\t\t`, y.appendChild(S);
    const C = document.createElement("table");
    C.classList.add("itemsTable"), S.appendChild(C), this.membersTbody = document.createElement("tbody"), C.appendChild(this.membersTbody), this.inSquadButtonsContainer = document.createElement("div"), this.inSquadButtonsContainer.classList.add("in-squad-buttons"), y.appendChild(this.inSquadButtonsContainer);
    ...
    this.inSquadButtonsContainer.appendChild(v.el), v.enabled = i.readyToJoin, this.boundOnReadyToJoinChange = t => {
      v.enabled = t
    }, i.onReadyToJoinChange(this.boundOnReadyToJoinChange), this.startButton = new UiButton({
      text: "Start",
      onClick: () => {
        e.startSquad()
      }
    ...
    const M = new UiButton({
      ...
      iconSize: 1.5,
      onClick: () => {
        this.squadSettingsDialog || (this.squadSettingsDialog = new SquadSettingsDialogUi(this.squadManager), getMainInstance().dialogManager.addDialog(this.squadSettingsDialog), this.squadSettingsDialog.addOnCloseCb((() => {
          this.squadSettingsDialog = null
        })))
      }
    });
    this.el.appendChild(M.el), this.currentAvatarBlobUrlReferences = new Set, this.boundUpdateSquadId = this.updateSquadId.bind(this), this.boundOnSquadIdChange = this.onSquadIdChanged.bind(this), e.onUserVisibleSquadIdChange(this.boundOnSquadIdChange), e.onIsJoiningSquadChange(this.boundUpdateSquadId), this.boundOnSquadMembersChange = () => {
      this.updateMembersUi(), this.updateReadyStartButtonVisibility()
    }, e.onSquadMembersChange(this.boundOnSquadMembersChange), this.boundUpdateStartButtonEnabled = this.updateStartButtonEnabled.bind(this), e.onServerReadyForStartStateChange(this.boundUpdateStartButtonEnabled), this.boundUpdateStartButtonEnabledFromStartClicked = () => {
    ...
    }, i.onActiveGameChange(this.boundOnInGameChange), this.updateSquadId(), this.updateMembersUi(), this.updateReadyStartButtonVisibility(), this.handleRequestInitialSquadId()
  }
  destructor() {
    super.destructor(), this.squadManager.removeOnUserVisibleSquadIdChange(this.boundOnSquadIdChange), this.squadManager.removeOnIsJoiningSquadChange(this.boundUpdateSquadId), this.squadManager.removeOnSquadMembersChange(this.boundOnSquadMembersChange), this.squadManager.removeOnServerReadyForStartStateChange(this.boundUpdateStartButtonEnabled), this.squadManager.removeOnStartClickedChange(this.boundUpdateStartButtonEnabledFromStartClicked), this.gameManager.removeOnReadyToJoinChange(this.boundOnReadyToJoinChange), this.gameManager.removeOnCurrentGameChange(this.boundOnInGameChange), this.squadSettingsDialog && this.squadSettingsDialog.close();
  ...
  async handleRequestInitialSquadId() {
    try {
      ...
      t instanceof MatchMakeConnectionError && (e = "Could not connect to the server. Please try again later."), getMainInstance().dialogManager.showAlert({
  ...
  updateMembersUi() {
    ...
    for (const s of t) {
      ...
      if (n.classList.add("squad-players-leader-container"), t.appendChild(n), s.leader) {
        const t = document.createElement("div");
        t.classList.add("squad-leader-icon"), n.appendChild(t)
      }
      const a = document.createElement("td");
      a.classList.add("squad-players-avatar-container"), t.appendChild(a);
      const o = document.createElement("div");
      o.classList.add("player-avatar"), a.appendChild(o);
      ...
      t.appendChild(h), h.textContent = s.name;
      let d = "";
      if (s.joined && !i ? d = "Joined" : s.ready && !e && (d = "Ready"), d) {
        const t = document.createElement("span");
        t.classList.add("players-list-label"), t.textContent = d, h.appendChild(t)
      }
    }
    for (const t of s) t.destructor();
  ...
  updateReadyStartButtonVisibility() {
    ...
    const e = !this.gameManager.getOnlineGame() && null != this.squadManager.userVisibleSquadId && t;
...
async function installServiceWorker() {
  if (installCalled) throw new Error("install() is already called");
  ...
  })), registration.waiting && markUpdateReady(), navigator.serviceWorker.addEventListener("controllerchange", (() => {
...
function markUpdateReady() {
  updateReady = !0, onUpdateReadyCbs.forEach((t => t()))
}
...
function skipWaiting() {
  if (!registration) throw new Error("No active service worker registration");
...
window.addEventListener("beforeinstallprompt", (t => {
  onInstallAvailableCbs.forEach((t => t())), beforeInstallPromptEvent = t, t.preventDefault()
}));
...
async function promptInstall() {
  if (!beforeInstallPromptEvent) throw new Error("Install available event hasn't fired yet");
  return beforeInstallPromptEvent.prompt(), await beforeInstallPromptEvent.userChoice
}
class Timeout {
  constructor(t, e, i = !1) {
...
class PhysicsValue {
  constructor({
    ...
    this.value = t, this.target = t, this.velocity = 0, this.springMultiplier = e, this.maxSpring = i, this.dampening = s, this.loopValue = n, this.loopStart = a, this.loopEnd = o
  }
  loop(t, e) {
    ...
    if (this.loopValue) {
      ...
      const t = this.loopEnd - this.loopStart,
        ...
        o = s - this.value,
        r = n - this.value;
      i = a, Math.abs(o) < Math.abs(i) && (i = o), Math.abs(r) < Math.abs(i) && (i = r)
    }
    i *= this.springMultiplier, i = clamp(i, -this.maxSpring, this.maxSpring), this.velocity += i, this.velocity *= this.dampening, this.value += this.velocity * e, this.loopValue && (this.value = this.performValueLoop(this.value))
  }
  performValueLoop(t) {
...
class PlayerHoldingHandler {
  constructor(t, {
    ...
    this.player = t, this.holdingObject = e, this.usePrimaryParent = !0, this.thirdPersonParentName = i, this.secondaryThirdPersonParentName = s || null, this.firstPersonPosOffset = new Vector3, this.firstPersonRotOffset = new Quaternion, this.smoothFirstPersonPosOffset = new Vector3, this.smoothFirstPersonRotOffset = new Quaternion, this.smoothFirstPersonPosFovMultiplierX = 0, this.smoothFirstPersonPosBaseFovMultiplierX = 0, this.smoothFirstPersonPosFovMultiplierY = 0, this.smoothFirstPersonWalkBobMultiplier = 0, this.smoothFirstPersonPitchHeightMultiplier = 0, this.smoothFirstPersonMinFov = 0, this.smoothFirstPersonMaxFov = 0, this.prevCamPosValid = !1, this.prevCamRotValid = !1, this.prevCamPos = new Vector3, this.prevCamRotForwardVector = new Vector3, this.camPosOffsetPhysics = new PhysicsValue3d({
      ...
      maxSpring: .001,
      dampening: .8
    }), this.renderOverlay = getMainInstance().renderer.createRenderOverlay(), this.firstPersonObjContainer = new Object3D, this.firstPersonObjContainer.name = "FirstPersonObjContainer", this.renderOverlay.scene.add(this.firstPersonObjContainer), this.linkedThirdPersonObject = null, this.firstPersonConfig = {
      ...configDefaults
  ...
  destructor() {
    this.player.removeHoldingHandler(this), getMainInstance().renderer.removeRenderOverlay(this.renderOverlay), this.firstPersonObjContainer.parent && this.firstPersonObjContainer.parent.remove(this.firstPersonObjContainer), this.holdingObject.parent && this.holdingObject.parent.remove(this.holdingObject)
  }
  ...
  loop(t, e) {
    if (this.player.useFirstPersonHoldingHandlers) {
      ...
      this.prevCamRotForwardVector.clone().cross(a).y > 0 && (o *= -1), this.prevCamPos.copy(i), this.prevCamRotForwardVector.copy(a);
      const r = n.clone();
      r.clampLength(0, .07), this.camPosOffsetPhysics.target = r, this.camPosOffsetPhysics.loop(t, e), this.camRotOffsetPhysics.target = o, this.camRotOffsetPhysics.loop(t, e), this.updateFirstPersonPosition()
  ...
  updateFirstPersonPosition() {
    ...
    const t = getMainInstance(),
      ...
      l = o.clone();
    a.y < .1 && (l.copy(a), o.y > 0 && l.negate()), l.y = 0;
    let h = l.angleTo(s);
...
class MatchMakingManager {
    ...
    this.matchMakingSocketUrl = "", this.ws = null, this.onJoinServerReceivedCbs = new Set, this.nextCloseIsIntentional = !1, this.onConnectionCloseCbs = new Set, this.onConnectionOpenCbs = new Set, this.onConnectionCloseDuringMatchMakingCbs = new Set, this.onSquadMessageCbs = new Set, this.onIsMatchMakingChangeCbs = new Set, this.matchMakingLoadingText = null, this.isMatchMaking = !1, this.shouldApplyLoadingText = !0, this.smoothSkillLevel = 0, this.smoothSkillLevelGameCount = 0, this.isInUnreadyQueue = !1, this.initConnectionInstance = new SingleInstancePromise((async () => {
      ...
      for (let t = 0; t < 3; t++) {
        ...
        if (e) return this.send({
          op: "myClientVersion",
          version: "1677494561"
        }), this.sendDownloadedMapHashes(), this.sendSkillLevel(), this.onConnectionOpenCbs.forEach((t => t())), e.addEventListener("close", (() => {
  ...
  init() {
    ...
    const t = parseSearch();
    if ("local" != getMainInstance().env || t.useProductionServers) this.matchMakingSocketUrl = "wss://matchmaking.narrow-one.com/";
    else {
      let t = "wss";
  ...
  async saveSmoothSkillLevel() {
    try {
      await getMainInstance().indexedDb.set("matchMakeSavedValues", {
  ...
  async assertInitConnection() {
    if (!await this.initConnection()) throw new MatchMakeConnectionError
  }
  get connected() {
  ...
  async attemptSingleWsConnection() {
    ...
    return this.ws.addEventListener("message", (i => {
      ...
      } else "reloadMapsConfig" == s.op ? getMainInstance().config.mapsConfig.load() : e.includes(s.op) && this.onSquadMessageCbs.forEach((t => t(s)))
    })), await new Promise((e => {
  ...
  async updateQueueState({
    ...
    let n;
    n = null == e ? s || i.preferredMapManager.isForcingSoloMap ? 0 : Math.min(5e3, 1e3 * this.smoothSkillLevelGameCount) : e, this.send({
      op: "updateQueueState",
      maxWaitTimeMs: n,
      isFirstGame: s,
      isReadyToJoin: t
  ...
  updateSmoothSkillLevel(t) {
    ...
    this.smoothSkillLevel = lerp(this.smoothSkillLevel, t, e), this.saveSmoothSkillLevel()
  }
...
class SquadManager {
  constructor(t, e, i) {
    this.networkManager = t, this.matchMakeManager = e, this.gameManager = i, this.isJoiningSquad = !1, this.matchmakeServerSquadId = null, this.gameServerSquadId = null, this.onBeforeJoinFired = !1, this.lastSentUsername = null, this.lastSentSkinDataStr = null, this.shouldShowSquadDialogForCurrentSquadId = !1, this.matchMakeSquadMembers = new Map, this.matchMakeSquadMembersOnGameJoin = new Map, this.includeUnjoinedMembers = !1, this.includeUnjoinedMembersTimeout = new Timeout((() => {
      this.includeUnjoinedMembers = !1, this.updateSquadMembersData()
    }), 3e4), this.gameSquadPlayers = [], this.mySquadPlayerId = 0, this.matchMakeAllReady = !1, this.serverReadyForStartState = !1, this.onServerReadyForStartStateChangeCbs = new Set, this.onServerReadyForStartTrueCbs = new Set, this.clientStartClicked = !1, this.clientStartClickedTimeout = new Timeout((() => {
      ...
      if ("squadId" == t.op) this.setIsJoiningSquad(!1), this.setMatchmakeServerSquadId(t.squadId), this.sendCurrentUsername(), this.sendMySkinIds(), this.setMyClientIsSquadLeader(!1), this.shouldShowSquadDialogForCurrentSquadId && (this.shouldShowSquadDialogForCurrentSquadId = !1, t.willJoinImmediately || getMainInstance().mainMenu.openSquadDialog()), this.lastSquadLeaderToken && this.matchMakeManager.sendRequestSquadLeadership(this.lastSquadLeaderToken);
        ...
        e || (e = {
          ...
          leader: !1
        }, this.matchMakeSquadMembers.set(t.member.id, e)), e.name = t.member.name, e.ready = t.member.ready, e.skinData = parseSkinDataString(t.member.skinDataStr), e.leader = t.member.leader, this.updateSquadMembersData()
      ...
      t.sendSquadData(this.userVisibleSquadId || "", this.mySquadPlayerId)
      ...
      t instanceof Game && (t && t.onSquadPlayersChange(this.boundUpdateGameSquadPlayers), this.updateGameSquadPlayers())
  ...
  handleSquadJoinError(t, e) {
    if (this.setIsJoiningSquad(!1), "squad-not-found" == t) {
      ...
      null != e && (t = `The squad with code "${e}" does not exist.`), getMainInstance().dialogManager.showAlert({
      ...
      } else getMainInstance().dialogManager.showAlert({
        title: "Joining squad failed",
        text: "Your version is too old to join this squad. Refresh the page to update to the latest version."
      });
    else "client-version-too-new" == t ? getMainInstance().dialogManager.showAlert({
      title: "Joining squad failed",
  ...
  async joinExistingSquad(t, e = !0, i = !0) {
    ...
    try {
      ...
      return console.error(t), getMainInstance().dialogManager.showAlert({
...
function normalize(t, e = -1, i = 1, s = 8) {
  return t = mapValue(e, i, 0, 2 ** s - 1, t, !0), t = Math.round(t)
}
...
class NetworkManager {
  ...
  onMessage(t) {
    ...
    if (this.lastReceiveMessageTime = performance.now(), s[0] == NetworkManager.ReceiveAction.JOINED_GAME_ID) getMainInstance().gameManager.joinedGameId(s[1]);
    ...
    } else if (s[0] == NetworkManager.ReceiveAction.PING) this.send([NetworkManager.SendAction.PONG]);
      ...
      t.setSameSquadPlayerIds(i.playerDatas)
  ...
  fireConnectionClosed() {
    this.ws = null, this.joiningLoadingText && this.joiningLoadingText.setIsLoading(!1), getMainInstance().gameManager.connectionClosed(), this.onConnectionClosedCbs.forEach((t => t(this.nextCloseIsIntentional, this.lastDisconnectReason)));
    if (!this.nextCloseIsIntentional) {
      ...
      switch (this.lastDisconnectReason) {
        case "version-out-of-date":
          e = "Your version is out of date, update your client in order to play online.", getUpdateReady() && (t = [{
            text: "Update now",
            onClick: () => {
              skipWaiting()
            }
  ...
  sendCurrentVersion() {
    this.sendStringMessage(NetworkManager.SendAction.MY_CLIENT_VERSION, "1677494561")
  }
  sendMySkillLevel() {
    const t = new ArrayBuffer(8),
      e = new Uint32Array(t),
      i = new Float32Array(t);
    e[0] = NetworkManager.SendAction.MY_SKILL_LEVEL, i[1] = this.matchMaking.getMappedSmoothSkillLevel(), this.send(t)
  }
  sendMySkinData(t) {
    const e = JSON.stringify(t);
    e != this.lastSentSkinData && (this.lastSentSkinData = e, this.sendStringMessage(NetworkManager.SendAction.EQUIPPED_SKIN_DATA, e))
  }
  sendJoinGameId(t, e = null) {
    ...
    const s = new ArrayBuffer(i),
      n = new Uint32Array(s);
    if (n[0] = NetworkManager.SendAction.REQUEST_JOIN_GAME_ID, n[1] = t, e) {
  ...
  sendPlayerData(t, e, {
    ...
    if (t != getMainInstance().gameManager.getOnlineGame()) return;
    const r = new ArrayBuffer(16),
      l = new Uint32Array(r, 0, 1),
      h = new Uint16Array(r, 0);
    l[0] = NetworkManager.SendAction.PLAYER_DATA, h[2] = e;
    const [d, c, u] = this.mapWorldPosToNetworkPos(t, i, s, n);
    h[3] = d, h[4] = c, h[5] = u;
    const p = 2 * Math.PI;
    h[6] = normalizeU8(mod(a, p), p), h[7] = normalizeS8(o, .5 * Math.PI), this.send(r)
  }
  getWorldBounds(t) {
    let e = 0,
      i = 0,
    ...
    if (t) {
      ...
      r && (e = r.min.x - 5, i = r.min.y - 5, s = r.min.z - 5, n = r.max.x + 5, a = r.max.y + 5, o = r.max.z + 5)
    }
    return {
      minX: e,
      minY: i,
  ...
  sendCreateArrow(t, e, {
    ...
    r[0] = NetworkManager.SendAction.CREATE_ARROW, l[2] = e, l[3] = i;
    const [h, d, c] = this.mapWorldPosToNetworkPos(t, s.x, s.y, s.z);
    l[4] = h, l[5] = d, l[6] = c;
    const [u, p, g] = this.mapNetworkPosToWorldPos(t, h, d, c), m = normalizeS16(n.x, -1, 1), f = normalizeS16(n.y, -1, 1), w = normalizeS16(n.z, -1, 1);
    l[7] = m, l[8] = f, l[9] = w;
  ...
  sendReportCheater(t, e, i) {
    i = normalizeU16(i), this.send([NetworkManager.SendAction.REPORT_CHEATER, t, e, i])
  }
  ...
  sendSquadData(t, e) {
    ...
    this.sendStringMessage(NetworkManager.SendAction.SQUAD_DATA, JSON.stringify(i))
  }
  sendRequestSquadId() {
...
class MapCollider {
  constructor(t, {
    ...
    movePlayerUp: h = !0,
    slippery: d = !1,
    slowDownPlayerAmount: c = 0,
    triggerHingeId: u = -1,
    triggerAppearingObjectId: p = -1
  }) {
    this.invWorldMatrix = t.clone().invert(), this.invWorldMatrixNoTranslate = this.invWorldMatrix.clone().setPosition(0, 0, 0), this.worldMatrix = t, this.aabb = null, this.ignoreArrows = e, this.isLadder = i, this.isLadderAllSides = s, this.isDeathTrigger = a, this.shootSfx = o, this.allowJump = r, this.allowWalk = l, this.movePlayerUp = h, this.slippery = d, this.slowDownPlayerAmount = c, this.triggerHingeId = u, this.triggerAppearingObjectId = p, this.excludeTeamId = n
  }
  rayCast(t, e) {
...
class BoxMapCollider extends MapCollider {
  constructor(...t) {
    super(...t), this.box = new Box3(new Vector3(-1, -1, -1), new Vector3(1, 1, 1)), this.aabb = this.box.clone(), this.aabb.applyMatrix4(this.worldMatrix), this.cachedUpFaces = null
  }
  getSphereManifold(t, e) {
...
class PlayerRigidBody extends RigidBody {
  constructor(t, e) {
    super(), this.physicsManager = t, this.player = e, this.pos = new Vector3, this.velocity = new Vector3, this.totalForce = new Vector3, this.colliders = [new PlayerSphereCollider(this, .4, .4, "feet", 1 / 3), new PlayerSphereCollider(this, .5, 1.1, "body", .5), new PlayerSphereCollider(this, .3, 1.7, "head", 1)], this.aabb = new Box3;
  ...
  stepVelocity(t) {
    ...
    let e = .9995,
      i = e;
    this.isOnSlipperyCollider ? (e = .2, i = .2) : this.climbingLadder ? (e = .9999, i = .9999) : this.wasOnFloorLastFrame || (i = .2, e = .9);
  ...
  endPhysicsSteps() {
    this.isOnFloor && !this.wasOnFloorLastFrame && (this.prevLastFloorTouchTime = this.lastFloorTouchTime, this.lastLandTime = getMainInstance().now), (this.isOnFloor || this.climbingLadder) && (this.updateLastFloorTouchTime(), this.inAirAfterJump = !1), this.isOnJumpableCollider && (this.lastJumpableColliderTouchTime = getMainInstance().now), this.totalForce.set(0, 0, 0)
  }
  get inAirTime() {
  ...
  getPlayerManifolds() {
    const t = this.getCurrentPlayerAabb();
    return this.getManifoldsHelper(t, this.colliders)
  }
  getManifoldsHelper(t, e) {
    const i = [];
    for (const s of this.physicsManager.getCollidersForAabbUsingOctree(t))
      if (s.aabb && s.aabb.intersectsBox(t) && s.excludeTeamId != this.player.teamId)
        for (const t of e) {
          const e = s.getSphereManifold(t.center, t.radius);
          e.penetration > 0 && i.push({
            manifold: e,
            mapCollider: s,
            playerCollider: t
          })
  ...
  isAboveJumpableCollider() {
    ...
    const n = this.getManifoldsHelper(s, e);
    for (const {
      manifold: t
    }
      of n) {
  ...
  resolveMapCollisionsOctree(t) {
    const e = this.getPlayerManifolds();
    ...
    for (const {
      ...
      of e) {
      const e = t.normal.dot(new Vector3(0, 1, 0));
      if (s.isDeathTrigger) continue;
      if (s.slowDownPlayerAmount > 0) continue;
      if (!s.movePlayerUp) continue;
      if (this.needsLadderPhysics(t, s)) continue;
      let a = !1;
      if ("feet" == n.bodyPart && (e > .6 || this.manifoldShouldMovePlayerUp(t, e)) && (a = !0), a && t.penetration > 0) {
        const e = t.normal.clone();
        e.setLength(t.penetration + 1e-7);
        const n = t.normal.clone().cross(new Vector3(0, 1, 0));
        if (n.lengthSq() > 0) {
          const i = n.clone().cross(t.normal);
          let s = 0;
          0 != i.x ? s = Math.abs(e.x / i.x) : 0 != i.z && (s = Math.abs(e.z / i.z)), i.multiplyScalar(s), e.add(i)
        }
        e.y > 0 && e.y < 1 && (i = Math.max(e.y, i), this.isOnFloor = !0, s.allowJump && (this.isOnJumpableCollider = !0), s.allowWalk || (this.isOnUnwalkableCollider = !0), s.slippery && (this.isOnSlipperyCollider = !0))
      }
    }
    let s = e;
    if (i > 0) {
      ...
      for (const {
        ...
        of e) {
        let e = n.get(i) || 0;
        e = Math.max(e, t.penetration), n.set(i, e)
      }
      let a = !1;
      const o = this.getPlayerManifolds();
      for (const {
        manifold: t,
        mapCollider: e
      }
    ...
    for (const {
      ...
      of s) {
      const s = this.needsLadderPhysics(t, e);
      ...
      if (a < 0) {
        const o = t.normal.dot(new Vector3(0, 1, 0));
        e.isDeathTrigger ? this.player.dieFromFall() : s && (e.isLadderAllSides || "head" != i.bodyPart && o > -.1) && (n = e, this.climbingLadderNormal = t.normal.clone()), this.velocity.addScaledVector(t.normal, -a);
        const r = .8,
          l = .001,
          h = Math.max(t.penetration - l, 0) * r,
          d = t.normal.clone().multiplyScalar(h);
        this.pos.add(d), "feet" == i.bodyPart && o > .3 && !s && (this.isOnFloor = !0, e.allowJump && (this.isOnJumpableCollider = !0), e.allowWalk || (this.isOnUnwalkableCollider = !0), e.slippery && (this.isOnSlipperyCollider = !0))
      }
    }
    if (!n) {
      ...
      if (t)
        for (const e of this.colliders) {
          t.getSphereManifold(e.center, e.radius).penetration > -.05 && (n = t)
        }
    } !n && this.climbingLadder && getMainInstance().now - this.lastJumpTime > 300 && (this.velocity.y *= .3), this.climbingLadder = n
  }
  needsLadderPhysics(t, e) {
    if (!(e instanceof BoxMapCollider)) return !1;
  ...
  jump(t) {
    this.isOnFloor = !1, this.isOnJumpableCollider = !1, this.isOnUnwalkableCollider = !1, this.isOnSlipperyCollider = !1, this.inAirAfterJump = !0, this.lastJumpTime = getMainInstance().now;
...
class ActivityWeight {
  ...
  loop(t, e) {
    t ? this.weight += e * this.speed : this.weight -= e * this.speed, t != this.active && (this.active = t, this.onActiveChangeCbs.forEach((e => e(t)))), this.weight = clamp01(this.weight)
  }
  onActiveChange(t) {
...
function randomRotateVec(t, e) {
  ...
  s.setFromAxisAngle(t, Math.random() * Math.PI * 2), i.applyQuaternion(s);
  const n = new Quaternion;
  return n.setFromAxisAngle(i, lerp(-e, e, Math.random())), t.clone().applyQuaternion(n)
}
class HoldingHandlerManager {
  constructor(t, {
    ...
    if (this.holdingHandler = t, this.upConfig = e, this.downConfig = i, !s) {
      let t, e;
      i.posOffset ? (t = i.posOffset.clone(), t.y -= .5) : t = new Vector3(-.6, -2, -1.3), e = i.rotOffset ? i.rotOffset.clone() : new Vector3(-.6, 0, -1.3), s = {
        posOffset: t,
        rotOffset: e,
  ...
  loop(t, e, {
    ...
    let a = !1;
    this.usePrimaryPosition != this.prevUsePrimaryPosition && (this.prevUsePrimaryPosition = this.usePrimaryPosition, a = !0), n != this.holdingHandlerDown && (this.holdingHandlerDown = n, a = !0), s != this.forcedConfig && (this.forcedConfig = s, a = !0), a && this.updateHoldingHandler()
  }
...
class Weapon {
  constructor(t, e, i) {
    this.player = t, this.actionIsDown = !1, this.rawActionIsDown = !1, this.isPrimaryWeapon = !0, this.equipSfxName = "", this.holdingHandler = this.player.createHoldingHandler({
      holdingObject: e,
  ...
  setIsPrimaryWeapon(t) {
    this.isPrimaryWeapon != t && (this.isPrimaryWeapon = t, this.holdingHandler.setUsePrimaryParent(this.isPrimaryWeapon), this.holdingHandlerManager.setUsePrimaryPosition(this.isPrimaryWeapon), t ? this.equipSfxName && this.playSfx(this.equipSfxName) : this.actionUp())
  }
  playSfx(t, e) {
...
class WeaponBow extends Weapon {
  constructor(t, e, i) {
    ...
    super(t, s.obj, i), this.bowWeaponId = e, this.equipSfxName = "weapon/equipBow", s.setArrowAssetName(this.player.game.getArrowAssetName()), this.bowAssetLoader = s
  }
  destructor() {
  ...
  actionUp() {
    this.rawActionIsDown = !1, this.actionIsDown && (!this.getAutoShootEnabled() || this.getAutoShootActionUp() || this.player.dead) && (this.actionIsDown = !1, this.onActionUp())
  }
  shootArrow(t) {
...
class WeaponSmallBow extends WeaponBow {
  constructor(...t) {
    ...
    }), this.shootingActivity = new ActivityWeight, this.shootingMultipleActivity = new ActivityWeight, this.fireAmount01 = 0, this.arrowCount = 1, this.nextArrowTimer = 0, this.lastFireUp = 0, this.prevArrowReady = !1, this.isShootingMultiple = !1, this.shootingMultipleVisualLoadState = !1, this.shootingMultipleVisualFireAmount = 0, this.pullSfx = new PullingBowSfx("weapon/bow/pull", {
      player: this.player,
      sfxOptions: {
        minPitch: 1.3,
        maxPitch: 1.5
  ...
  onActionUp() {
    this.getFireUpCooldownActive() || (this.shootMultiple(this.arrowCount, this.fireAmount01), this.arrowCount = 1, this.fireAmount01 = 0, this.lastFireUp = getMainInstance().now)
  }
  async shootMultiple(t, e) {
    this.isShootingMultiple = !0;
    for (let i = 0; i < t; i++) this.shootArrow(e), getMainInstance().sfx.playSound("weapon/bow/shoot", {
      pos: this.player.getSfxPos(),
      minPitch: 1,
      maxPitch: 1.1
    }), this.holdingHandler.addFirstPersonImpulse(new Vector3(0, 0, .005 * e)), i < t - 1 && (await Timeout.promise(50), this.shootingMultipleVisualLoadState = !0, await Timeout.promise(50), this.shootingMultipleVisualLoadState = !1);
    this.isShootingMultiple = !1
  }
  getFireUpCooldownActive() {
    return !!this.isShootingMultiple || getMainInstance().now - this.lastFireUp < 300
  }
  getIsPullingBow() {
  ...
  loop(t, e) {
    ...
    this.pullSfx.setPlayingState(i), i && (this.fireAmount01 += .003 * e, this.fireAmount01 = clamp01(this.fireAmount01)), this.fireAmount01 >= 1 && this.arrowCount < 3 ? (this.nextArrowTimer += .01 * e, this.nextArrowTimer > 1 && (this.nextArrowTimer = 0, this.arrowCount++, this.playArrowReadySfx())) : this.nextArrowTimer = 0;
    const s = !this.getFireUpCooldownActive();
    s != this.prevArrowReady && (s && this.playArrowReadySfx(), this.prevArrowReady = s), this.shootingMultipleActivity.loop(this.shootingMultipleVisualLoadState, e);
    const n = s && this.isPrimaryWeapon;
    this.bowAssetLoader.updateFireAmount(this.getVisualFireAmount(), n ? this.arrowCount : 0), this.holdingHandlerManager.loop(i, this.player), this.shootingActivity.loop(i || this.isShootingMultiple, e)
  }
  getAutoShootActionUp() {
  ...
  updateBowAsset() {
    const t = getMainInstance().skins.skinNetworkDataToBowAssetNames("smallBow", this.player.equippedSkinData);
    this.bowAssetLoader.setConfig({
      bowId: "smallBow",
...
class WeaponMediumBow extends WeaponBow {
  constructor(...t) {
    ...
    }), this.shootingActivity = new ActivityWeight, this.fireAmount01 = 0, this.lastFireUp = 0, this.prevArrowReady = !1, this.pullSfx = new PullingBowSfx("weapon/bow/pull", {
      player: this.player,
      sfxOptions: {
        minPitch: .7,
        maxPitch: 1
  ...
  onActionUp() {
    this.getFireUpCooldownActive() || (this.shootArrow(this.fireAmount01), this.holdingHandler.addFirstPersonImpulse(new Vector3(0, 0, .005 * this.fireAmount01)), getMainInstance().sfx.playSound("weapon/bow/shoot", {
      pos: this.player.getSfxPos(),
      minPitch: .9,
      maxPitch: 1
    }), this.fireAmount01 = 0, this.lastFireUp = getMainInstance().now)
  }
  getFireUpCooldownActive() {
    return getMainInstance().now - this.lastFireUp < 400
  }
  getIsPullingBow() {
    return this.actionIsDown && !this.getFireUpCooldownActive()
  }
  loop(t, e) {
    super.loop(t, e);
    const i = this.getIsPullingBow();
    this.pullSfx.setPlayingState(i), i && (this.fireAmount01 += .002 * e, this.fireAmount01 = clamp01(this.fireAmount01));
    const s = !this.getFireUpCooldownActive();
    ...
    const n = s && this.isPrimaryWeapon;
    this.bowAssetLoader.updateFireAmount(this.fireAmount01, n ? 1 : 0), this.holdingHandlerManager.loop(i, this.player), this.shootingActivity.loop(i, e)
  }
  getAutoShootActionUp() {
  ...
  getThirdPersonSkeletonMultipliers(t) {
    if ("female" == t) return getDefaultSkeletonMultipliers(this.shootingActivity.weight, .4, -.2);
    if ("male" == t) return getDefaultSkeletonMultipliers(this.shootingActivity.weight, .4, 0);
  ...
  updateBowAsset() {
    const t = getMainInstance().skins.skinNetworkDataToBowAssetNames("mediumBow", this.player.equippedSkinData);
    this.bowAssetLoader.setConfig({
      bowId: "mediumBow",
      teamId: this.player.teamId,
      skins: t
...
class WeaponLargeBow extends WeaponBow {
  constructor(...t) {
    ...
    }), this.shootingActivity = new ActivityWeight, this.fireAmount01 = 0, this.lastFireDown = 0, this.lastFireUp = 0, this.prevCooldownActive = !1, this.isPullingBow = !1, this.pullSfx = new PullingBowSfx("weapon/bow/pullHeavy", {
      player: this.player,
      sfxOptions: {
        minPitch: .9,
        maxPitch: 1.1
  ...
  onActionUp() {
    this.getFireCooldownActive() || (this.shootArrow(this.fireAmount01), this.holdingHandler.addFirstPersonImpulse(new Vector3(0, 0, .01 * this.fireAmount01)), getMainInstance().sfx.playSound("weapon/largeBow/shoot", {
      pos: this.player.getSfxPos(),
      minPitch: .9,
      maxPitch: 1.1
    }), this.fireAmount01 = 0, this.lastFireUp = getMainInstance().now, this.isPullingBow = !1)
  }
  getFireCooldownActive() {
    const t = getMainInstance().now;
    return !this.isPullingBow && t - this.lastFireDown < 1200 || t - this.lastFireUp < 400
  }
  getIsPullingBow() {
  ...
  loop(t, e) {
    super.loop(t, e);
    const i = this.getIsPullingBow();
    i != this.isPullingBow && (i && (this.lastFireDown = t), this.isPullingBow = i), this.pullSfx.setPlayingState(i), i && (this.fireAmount01 += 8e-4 * e, this.fireAmount01 = clamp01(this.fireAmount01));
  ...
  updateBowAsset() {
    const t = getMainInstance().skins.skinNetworkDataToBowAssetNames("largeBow", this.player.equippedSkinData);
    this.bowAssetLoader.setConfig({
      bowId: "largeBow",
      teamId: this.player.teamId,
      skins: t
...
class WeaponSmallCrossBow extends WeaponBow {
  constructor(...t) {
    ...
    }), this.lastFireTime = 0, this.prevArrowVisible = !1, this.playNextFirstPersonLoadAnimation = !1, this.loadingActivity = new ActivityWeight, this.shootingActivity = new ActivityWeight, this.updateBowAsset()
  }
  getAccuracyOffset() {
    return 10
  }
  ...
  onActionDown() {
    this.getFireUpCooldownActive() || (this.shootArrow(1), this.holdingHandler.addFirstPersonImpulse(new Vector3(0, 0, .005)), getMainInstance().sfx.playSound("weapon/smallCrossbow/shoot", {
      pos: this.player.getSfxPos(),
      minPitch: .9,
      maxPitch: 1.1
    }), this.fireAmount01 = 0, this.lastFireTime = getMainInstance().now, this.playNextFirstPersonLoadAnimation = !this.holdingHandlerManager.holdingHandlerDown)
  }
  getFireUpCooldownActive() {
    return getMainInstance().now - this.lastFireTime < 500
  }
  loop(t, e) {
    super.loop(t, e);
    const i = t - this.lastFireTime,
      ...
      o = mapValue(200, 500, 0, 1, i, !0),
      r = i > 200;
    r != this.prevArrowVisible && (r && getMainInstance().sfx.playSound("weapon/bow/arrowReady", {
      pos: this.player.getSfxPos(),
      minPitch: .95,
      maxPitch: 1.05
    }), this.prevArrowVisible = r), this.bowAssetLoader.updateFireAmount(o, r && this.isPrimaryWeapon ? 1 : 0), this.holdingHandlerManager.loop(s, this.player, {
      forceDown: a
  ...
  getThirdPersonSkeletonMultipliers(t) {
    ...
    if ("female" == t) return getDefaultSkeletonMultipliers(e, .4, 0);
    if ("male" == t) return getDefaultSkeletonMultipliers(e, .4, -.2);
    throw new Error("invalid gender")
  }
  playerSkinUpdated() {
    this.updateBowAsset()
  ...
  updateBowAsset() {
    const t = getMainInstance().skins.skinNetworkDataToBowAssetNames("smallCrossbow", this.player.equippedSkinData);
    this.bowAssetLoader.setConfig({
      bowId: "smallCrossbow",
      teamId: this.player.teamId,
      skins: t
...
const MAX_ARROW_LOAD_COUNT = 10,
  SHOOT_ARROW_INTERVAL = 250,
  LOAD_ARROW_INTERVAL = 100,
...
class WeaponRepeatingCrossbow extends WeaponBow {
  constructor(...t) {
    ...
    }), this.loadingOrShootingState = !1, this.loadedArrowCount = 10, this.shootOrLoadTimer = 0, this.hasReleasedAction = !0, this.loadingActivity = new ActivityWeight, this.loadingEndActivity = new ActivityWeight, this.shootingActivity = new ActivityWeight, this.currentHandleObject = null, this.currentArrowBoxObject = null, this.bowAssetLoader.onAssetChange((t => {
  ...
  getFireAmount() {
    return this.isFiringArrows() ? this.shootOrLoadTimer / 250 : 0
  }
  loop(t, e) {
    super.loop(t, e), this.hasReleasedAction && this.actionIsDown && (this.shootOrLoadTimer += e, this.loadingOrShootingState ? this.shootOrLoadTimer > 100 && (this.shootOrLoadTimer = 0, getMainInstance().sfx.playSound("weapon/bow/arrowReady", {
      pos: this.player.getSfxPos(),
      minPitch: .95,
      maxPitch: 1.05
    }), this.loadedArrowCount++, this.loadedArrowCount >= 10 && (this.loadingOrShootingState = !1, this.hasReleasedAction = !1)) : this.shootOrLoadTimer > 250 && (this.shootOrLoadTimer = 0, this.shootArrow(1), getMainInstance().sfx.playSound("weapon/bow/shoot", {
      pos: this.player.getSfxPos(),
      minPitch: .9,
      maxPitch: 1.1
    ...
    let n = null;
    s ? n = this.loadingFirstPersonConfig : this.loadingOrShootingState && (n = this.emptyFirstPersonConfig), this.holdingHandlerManager.loop(this.isFiringArrows(), this.player, {
      forceConfig: n
    }), this.loadingActivity.loop(s, e), this.loadingEndActivity.loop(this.shootOrLoadTimer < 125, e), this.shootingActivity.loop(this.isFiringArrows(), e);
    const a = 1 - i;
    this.currentHandleObject && (this.currentHandleObject.rotation.x = lerp(0, 1, a)), this.currentArrowBoxObject && (this.currentArrowBoxObject.rotation.x = lerp(0, .2, a * (1 - this.loadingActivity.weight)))
  }
  getAutoShootActionUp() {
  ...
  updateBowAsset() {
    const t = getMainInstance().skins.skinNetworkDataToBowAssetNames("repeatingCrossbow", this.player.equippedSkinData);
    this.bowAssetLoader.setConfig({
      bowId: "repeatingCrossbow",
      teamId: this.player.teamId,
      skins: t,
...
class WeaponLargeCrossbow extends WeaponBow {
  constructor(...t) {
    ...
    }), this.loadAmount01 = 1, this.lastShootTime = 0, this.prevArrowReady = !1, this.loadWeightStart = new ActivityWeight, this.shootingWeight = new ActivityWeight, this.pullSfx = new PullingBowSfx("weapon/bow/pullHeavy", {
      player: this.player,
      sfxOptions: {
        minPitch: 1.3,
        maxPitch: 1.5
  ...
  onActionDown() {
    this.weaponIsLoaded() && (this.shootArrow(1), this.holdingHandler.addFirstPersonImpulse(new Vector3(0, 0, .005)), getMainInstance().sfx.playSound("weapon/largeCrossbow/shoot", {
      pos: this.player.getSfxPos(),
      minPitch: .9,
      maxPitch: 1.1
    }), this.loadAmount01 = 0, this.lastShootTime = getMainInstance().now)
  }
  onPlayerRespawned() {
    this.loadAmount01 = 1
  }
  getFireUpCooldownActive() {
    return getMainInstance().now - this.lastShootTime < 400
  }
  weaponIsLoaded() {
  ...
  loop(t, e) {
    ...
    this.pullSfx.setPlayingState(i), i ? (this.loadAmount01 += .00125 * e, this.loadAmount01 = clamp01(this.loadAmount01)) : this.weaponIsLoaded() || (this.loadAmount01 = 0);
    const s = !this.getFireUpCooldownActive();
    s != this.prevArrowReady && (s && getMainInstance().sfx.playSound("weapon/bow/arrowReady", {
      pos: this.player.getSfxPos(),
      minPitch: .95,
    ...
    this.holdingHandlerManager.loop(i, this.player, {
      forceConfig: a
    }), this.loadWeightStart.loop(i, e), this.shootingWeight.loop(this.weaponIsLoaded(), e)
  }
  getAutoShootActionUp() {
  ...
  getThirdPersonSkeletonMultipliers(t) {
    ...
    if ("female" == t) return getDefaultSkeletonMultipliers(e, .5, .5);
    if ("male" == t) return getDefaultSkeletonMultipliers(e, .5, 1);
    throw new Error("Invalid gender")
  }
  playerSkinUpdated() {
    this.updateBowAsset()
  ...
  updateBowAsset() {
    const t = getMainInstance().skins.skinNetworkDataToBowAssetNames("largeCrossbow", this.player.equippedSkinData);
    this.bowAssetLoader.setConfig({
      bowId: "largeCrossbow",
      teamId: this.player.teamId,
      skins: t
...
class WeaponMelee extends Weapon {
  ...
  attack() {
    ...
    for (const n of this.player.game.physics.getPlayerColliders()) {
      if (n.rigidBody.player.teamId == this.player.teamId) continue;
      if (n.rigidBody.player.dead) continue;
      ...
      const l = o.angleTo(r),
        h = o.clone(),
        d = new Quaternion;
      d.setFromAxisAngle(new Vector3(0, 1, 0), .5 * Math.PI), h.applyQuaternion(d);
      const c = e.clone();
      c.projectOnPlane(h);
      const u = a.angleTo(c),
        p = a.length();
    ...
    if (s) {
      ...
      return n.addMeleeHitFlash(), getMainInstance().sfx.playSound("feedback/hitPlayer"), this.playHitSfx(), getMainInstance().network.sendMeleeHitPlayer(n.id, n.currentSpawnId, this.player.id), !0
    }
    return !1
  }
  playHitSfx() {
...
class WeaponMeleeBladedLight extends WeaponMelee {
  constructor(...t) {
    super(...t, {
    ...
    }), this.hitSfxName = "weapon/melee/bladedHit", this.attackT = 0, this.stamina = 1, this.isAttacking = !1, this.longAttackHelper = new LongMeleeAttackHelper(this), this.attackStartPos = new Vector3, this.attackEndPos = new Vector3, this.attackStartConfig = {
      ...
      minFov: 60,
      maxFov: 90
    }, this.attackStartActivity = new ActivityWeight, this.attackEndActivity = new ActivityWeight, this.attackEndActivity.onActiveChange((t => {
      t ? (this.playSfx("weapon/melee/bladedSwing", {
        minPitch: 1.1,
        maxPitch: 1.3,
        volume: .02
      }), this.longAttackHelper.startAttacking()) : (this.attackStartPos.set(randRange(-.1, .1), 0, randRange(-.7, -.5)), this.attackEndPos.set(randRange(-.4, -.2), 0, randRange(-1.1, -.8)), this.longAttackHelper.stopAttacking())
    }))
  }
  getWalkSpeedMultiplier() {
  ...
  loop(t, e) {
    ...
    if (this.actionIsDown && (this.isAttacking = !0), this.isAttacking) {
      ...
      }, s = !0), this.stamina -= 3e-4 * e
    } else this.stamina += 3e-4 * e;
    this.stamina = clamp01(this.stamina), this.holdingHandlerManager.loop(this.isAttacking, this.player, {
      forceConfig: i
    }), this.attackStartActivity.loop(s, e), this.attackEndActivity.loop(n, e), this.longAttackHelper.loop()
  }
  onActionDown() {
...
class HoldAttackManager {
  ...
  onActionUp() {
    this.actionIsDown = !1, this.isPreparingAttack && (this.attackTime = Math.max(this.attackTime, getMainInstance().now))
  }
  get timeSinceAttack() {
...
class WeaponMeleeBladedHeavy extends WeaponMelee {
  constructor(...t) {
    ...
    }), this.hitSfxName = "weapon/melee/bladedHit", this.holdAttack = new HoldAttackManager({
      weapon: this,
    ...
    }), this.longAttackHelper = new LongMeleeAttackHelper(this), this.attackStartActivity = new ActivityWeight, this.attackEndActivity = new ActivityWeight, this.attackEndActivity.onActiveChange((t => {
  ...
  loop(t, e) {
    ...
    let n = null,
      a = !1,
      o = !1;
    i ? (n = this.randomizer.getCurrentConfig().start, a = !0) : s && (n = this.randomizer.getCurrentConfig().end, a = !0, o = !0), this.longAttackHelper.isAttacking && this.holdAttack.timeSinceAttack > 200 && this.longAttackHelper.stopAttacking(), this.holdingHandlerManager.loop(this.actionIsDown, this.player, {
      forceConfig: n
    }), this.attackStartActivity.loop(a, e), this.attackEndActivity.loop(o, e), this.longAttackHelper.loop()
  }
  getThirdPersonSkeletonLayers() {
...
class WeaponMeleeBluntHeavy extends WeaponMelee {
  constructor(...t) {
    ...
    }), this.hitSfxName = "weapon/melee/bluntHit", this.holdAttack = new HoldAttackManager({
      weapon: this,
      prepareDurationMsLowAttackSpeed: 500,
      prepareDurationMsHighAttackSpeed: 200,
      cooldownDurationMsLowAttackSpeed: 700,
      cooldownDurationMsHighAttackSpeed: 200
    }), this.longAttackHelper = new LongMeleeAttackHelper(this), this.attackStartTime = 0, this.attackStartActivity = new ActivityWeight({
      speed: .003
    }), this.attackStartActivity.onActiveChange((t => {
      t && (this.attackStartTime = getMainInstance().now)
    })), this.attackEndActivity = new ActivityWeight, this.attackEndActivity.onActiveChange((t => {
  ...
  loop(t, e) {
    ...
    let n = null,
      a = !1,
      o = !1;
    s ? (n = this.attackStartConfig, a = !0) : i && (n = this.attackEndConfig, o = !0), this.holdingHandlerManager.loop(this.actionIsDown, this.player, {
      forceConfig: n
    }), this.longAttackHelper.isAttacking && this.holdAttack.timeSinceAttack > 400 && this.longAttackHelper.stopAttacking(), this.attackStartActivity.loop(a, e), this.attackEndActivity.loop(o, e), this.longAttackHelper.loop()
  }
  getThirdPersonSkeletonLayers() {
...
class WeaponMeleeBluntLight extends WeaponMelee {
  constructor(...t) {
    super(...t, {
      ...
      minPitch: 1.3,
      maxPitch: 1.4
    }, this.longAttackHelper = new LongMeleeAttackHelper(this), this.lastActionDownTime = 0, this.didHit = !1, this.lastHitTime = 0, this.attackStartConfig = {
  ...
  loop(t, e) {
    ...
    a < r ? (i = this.attackStartConfig, s = !0, this.didHit = !1) : this.didHit ? o < 100 && (i = this.attackBounceConfig, n = !0) : a < l && (i = this.attackSwingConfig, n = !0), this.holdingHandlerManager.loop(a < 1e3, this.player, {
      forceConfig: i
    }), this.longAttackHelper.isAttacking && a > 300 && this.longAttackHelper.stopAttacking(), this.attackStartActivity.loop(s, e), this.attackEndActivity.loop(n, e);
...
class WeaponMeleePokeLight extends WeaponMelee {
  constructor(...t) {
    super(...t, {
    ...
    }), this.hitSfxName = "weapon/melee/pokeHit", this.lastActionDownTime = 0, this.stamina = 1, this.isAttacking = !1, this.attackEndActiveCountSinceStaminaReset = 0, this.longAttackHelper = new LongMeleeAttackHelper(this), this.attackStartPos = new Vector3, this.attackEndPos = new Vector3, this.attackStartConfig = {
      posOffset: this.attackStartPos,
      rotOffset: new Vector3(-1.9, 0, 0),
      posFovMultiplierX: .4,
      posFovMultiplierY: .5,
      ...
      t ? (this.playSfx("weapon/melee/pokeSwing", {
        ...
        maxPitch: 1.3,
        volume: .03
      }), this.longAttackHelper.startAttacking(), this.attackEndActiveCountSinceStaminaReset++) : (this.attackStartPos.set(randRange(-.1, .1), 0, randRange(.1, .3)), this.attackEndPos.set(randRange(-.2, .1), -.1, randRange(-1.1, -.9)), this.longAttackHelper.stopAttacking())
    }))
  }
  getDamageMultiplier() {
    return .4
  ...
  getAdditionalWalkAcceleration() {
    let t = 0;
    return this.isAttacking && this.attackEndActiveCountSinceStaminaReset < 3 && (t = this.attackEndActivity.active ? 3.5 : -1.5, 2 == this.attackEndActiveCountSinceStaminaReset && (t *= .5)), new Vector2(0, -t)
  }
  getAdditionalWalkAccelerationClampLength() {
    return 3.5
  }
  ...
  loop(t, e) {
    ...
    if (this.actionIsDown && (this.isAttacking = !0), this.isAttacking) {
      ...
      o < 100 && !this.actionIsDown && !this.attackEndActivity.active ? this.isAttacking = !1 : o < 100 ? (i = {
        ...
        ...this.attackStartConfig
      }, s = !0), this.stamina -= 5e-4 * e
    } else this.stamina += 5e-4 * e;
    this.stamina = clamp01(this.stamina), this.stamina >= 1 && (this.attackEndActiveCountSinceStaminaReset = 0), this.holdingHandlerManager.loop(this.isAttacking, this.player, {
      forceConfig: i
    }), this.attackStartActivity.loop(s, e), this.attackEndActivity.loop(n, e), this.longAttackHelper.loop()
  }
  onActionDown() {
...
class WeaponMeleePokeHeavy extends WeaponMelee {
  constructor(...t) {
    ...
    }), this.hitSfxName = "weapon/melee/pokeHit", this.chargeDuration = 0, this.lastChargeDuration = 0, this.lastActionUpTime = 0, this.longAttackHelper = new LongMeleeAttackHelper(this), this.attackStartActivity = new ActivityWeight, this.attackEndActivity = new ActivityWeight, this.attackEndActivity.onActiveChange((t => {
      t ? (this.playSfx("weapon/melee/pokeSwing", {
        minPitch: .9,
        maxPitch: 1.1
  ...
  getAdditionalWalkAcceleration() {
    ...
    return t *= mapValue(100, this.getCooldownDuration(), 0, 1, this.lastChargeDuration, !0), new Vector2(0, -t)
  }
  getAdditionalWalkAccelerationClampLength() {
    return 3
  }
  ...
  onActionUp() {
    this.getAttackCooldownActive() || (this.lastActionUpTime = getMainInstance().now, this.lastChargeDuration = this.chargeDuration, this.chargeDuration = 0)
  }
  getRequiredVerticalAngleMultiplier() {
    return .4
  }
  ...
  loop(t, e) {
    ...
    let i = null,
      s = !1,
      n = !1;
    if (this.getIsCharging()) this.chargeDuration += e, i = this.attackStartConfig, s = !0;
    else {
      const e = lerp(400, 200, this.getAttackSpeedStat());
      t - this.lastActionUpTime < e && (i = this.attackEndConfig, n = !0)
    }
...
class WeaponSelectionItemUi {
  constructor({
    ...
    this.keyNumber = e, this.el = document.createElement("div"), this.el.classList.add("weaponSelectionItem"), this.classSelectionImage = new ClassSelectionImage(t, {
...
async function loadSelectedWeaponIndex() {
  if (loadSelectedWeaponIndexCalled) return;
  loadSelectedWeaponIndexCalled = !0;
  let t = await getMainInstance().indexedDb.get("selectedWeaponId");
  t = sanitizeSelectedWeaponId(t), isNaN(t) || t == currentSelectedWeaponIndex || (currentSelectedWeaponIndex = t, fireSelectionChangeCbs())
}

function sanitizeSelectedWeaponId(t) {
  let e = Number(t);
  return isNaN(e) && (e = 1), e = mod(e, classConfigs.length), e
}
class WeaponSelectionDialogUi extends DialogUi {
  constructor() {
    ...
    }, onWeaponSelectionChange(this.boundUpdateSelectedUi), loadSelectedWeaponIndex(), getMainInstance()
  }
  destructor() {
    super.destructor(), this.prevKey.removeCb(this.boundPrevPress), this.nextKey.removeCb(this.boundNextPress), window.removeEventListener("keydown", this.boundKeyDown), removeOnWeaponSelectionChange(this.boundUpdateSelectedUi), getMainInstance()
  }
  updateSelectedUi() {
    for (const [t, e] of this.weaponSelectionItems.entries()) e.selected = t == currentSelectedWeaponIndex
  }
  ...
  selectWeapon(t) {
    return !!this.visible && (currentSelectedWeaponIndex = sanitizeSelectedWeaponId(t), getMainInstance().indexedDb.set("selectedWeaponId", currentSelectedWeaponIndex), fireSelectionChangeCbs(), !0)
  }
  deltaSelectWeapon(t) {
...
class Player {
  constructor(t, e, i, s, n, a, o, {
    ...
    }, getMainInstance().skins.onSkinConfigChange(this.onSkinConfigChange), this.smoothCamSetting = !1, this.smoothCamDebug = !1, this.smoothCam = !1, this.nextHitFlashIndex = 0, this.obj = null, this.legsMoveT = 0, this.legsMoveAmount = 0, this.walkHeadBobAmount = 0, this.legsMoveSpeed = 2, this.lastSfxStep = 0, this.updateUseFirstPersonHoldingHandlers(), this.icon = this.hudIconsManager.createIcon({
      url: "static/img/hudIcons/playerIcon.svg",
      size: .03
    }), this.destructed = !1
  }
  init() {
    this.skeleton && (this.skeleton.init(), this.skeleton.addPoseLayer("baseRig"), this.equippingWeaponLayer = this.skeleton.addPoseLayer("equippingWeapon"), this.deadForwardLayer = this.skeleton.addPoseLayer("deadForward"), this.deadBackwardLayer = this.skeleton.addPoseLayer("deadBackward"), this.waitForSkeletonLoad()), this.resetDeadPoseWeights(), this.setPlayerEquippedSkinData(this.equippedSkinData), this.updateIconVisibility()
  }
  ...
  removeActiveBowWeapon() {
    this.bowWeapon && (this.recentlyDestroyedWeapons.set(this.bowWeapon.bowWeaponId, performance.now()), this.bowWeapon.destructor()), this.bowWeapon = null
  }
  ...
  setActiveBowWeapon(t, e = !1) {
    ...
    if (this.removeActiveBowWeapon(), t < 0 || t >= classConfigs.length) return;
    getMainInstance().renderer.renderWorthyEventHappened();
    const i = classConfigs[t],
      s = new (0, bowWeaponTypes[i.bowId])(this, t);
    this.bowWeapon = s, this.updateActiveWeapon(), this.hasOwnership && getMainInstance().network.sendChangeSelectedClass(this.id, t)
  }
  ...
  setActiveMeleeWeapon(t) {
    if (t != this.meleeWeaponId) {
      ...
      getMainInstance().renderer.renderWorthyEventHappened(), this.updateActiveWeapon()
    }
  }
  ...
  get currentToggleWeaponCooldown() {
    let t = 0,
      e = 0;
    return this.bowWeapon && (t = this.bowWeapon.getToggleCooldownValue()), this.meleeWeapon && (e = this.meleeWeapon.getToggleCooldownValue()), Math.max(t, e)
  }
  ...
  loop(t, e) {
    ...
    if (this.didUpdateActiveWeaponAfterToggle || this.activeWeaponToggleCooldownActive || (this.didUpdateActiveWeaponAfterToggle = !0, this.updateActiveWeapon()), this.bowWeapon && (this.bowWeapon.loop(t, e), this.weaponAccuracyOffset && (this.weaponAccuracyOffset.offset = this.bowWeapon.getAccuracyOffset())), this.meleeWeapon && this.meleeWeapon.loop(t, e), this.hasOwnership) {
      if (!this.deadFromFall) {
        ...
        t.y = clamp(t.y, .5 * -Math.PI, e), this.cachedCamRotDirty = !0
      }
      let a = new Vector2;
      s.mainMenu.visible || s.dialogManager.needsUnlockedPointer || (a = this.inputManager.walkInput), a.length() > .01 && (s.renderer.renderWorthyEventHappened(), s.gameManager.joinIfNotJoined());
      const o = new Vector3(a.x, 0, a.y);
      if (o.applyQuaternion(this.getClampedCamRot()), o.clampLength(0, 1), this.activeWeapon) {
        const t = this.activeWeapon.getAdditionalWalkAcceleration();
        if (t) {
          const e = new Vector3(t.x, 0, t.y);
          e.applyQuaternion(this.getCamRot()), o.add(e), o.clampLength(0, this.activeWeapon.getAdditionalWalkAccelerationClampLength())
        }
      }
      const r = o.length();
      this.noclip || (o.y = 0), o.setLength(r);
      ...
      const h = .8;
      l *= 1 / (this.rigidBody.slowDownColliderAmount * h + 1), l *= lerp(.9, 1.1, this.getStatClassValue("movementSpeed")), this.activeWeapon && (l *= this.activeWeapon.getWalkSpeedMultiplier());
      for (const e of this.recentStunEvents) {
        ...
        } else this.recentStunEvents.delete(e)
      }
      if (this.rigidBody.climbingLadder && this.rigidBody.climbingLadderNormal) {
        ...
        if (t > 0 && !e && (i = !1), i) {
          ...
          t.setFromUnitVectors(new Vector3(0, 1, 0), this.rigidBody.climbingLadderNormal), o.applyQuaternion(t)
        }
      ...
      if (this.noclip && (this.inputManager.getKey("flyUp").pressed && (o.y += 1, s.renderer.renderWorthyEventHappened()), this.inputManager.getKey("flyDown").pressed && (o.y -= 1, s.renderer.renderWorthyEventHappened())), o.multiplyScalar(l), this.noclip && this.noclipCamVelocity && this.noclipCamPos) {
        const t = e / 1e3;
        this.noclipCamVelocity.addScaledVector(o, t * 1.001 ** this.noclipSpeed), this.noclipCamVelocity.multiplyScalar(.1 ** t), this.noclipCamPos.addScaledVector(this.noclipCamVelocity, t)
      } else this.dead || this.rigidBody.applyForce(o);
      let d = 0,
        c = 0;
      const u = this.rigidBody.velocity,
        p = new Vector2(u.x, u.z);
      if (c = Math.max(0, u.y), d = p.length(), this.rigidBody.inAirTime < 200 && !this.rigidBody.climbingLadder && (this.legsMoveT += d * (e / 1e3) * this.physicsManager.timeScale), this.legsMoveAmount += .005 * e, this.legsMoveAmount = Math.min(this.legsMoveAmount, d), this.legsMoveAmount = clamp01(this.legsMoveAmount), this.walkHeadBobAmount += 3e-4 * e, this.walkHeadBobAmount = Math.min(this.walkHeadBobAmount, d), this.walkHeadBobAmount = clamp01(this.walkHeadBobAmount), this.movementAccuracyOffset && (this.movementAccuracyOffset.offset = 10 * c + 2 * d), !this.dead && n) {
        const t = 1.5;
        if (this.holdingFlag)
        ...
        for (const e of n.getMyFlags(this.teamId))
          if (!e.isNearDefaultPos && !e.currentHoldingPlayer) {
            ...
            s.addReturnProgress(e * i), n.crosshair.setFlagReturnProgress(s.returnProgress), s.returnProgress > 1 && this.sendChangeFlag(s.id, NetworkManager.FlagChangeOperation.RETURN)
          }
      ...
      for (let t = 0; t < m; t++) this.positionHistory.unshift(this.pos.clone());
      ...
      a.clampLength(0, this.maxPredictedServerPosDistance - .01), this.predictedServerPos.copy(this.serverPos).add(a), i < 100 && this.predictedServerVelocity.addScaledVector(this.predictedServerAcceleration, e);
      const o = .02;
      ...
      this.rigidBody.inAirTime < 200 && (this.legsMoveT += h), this.legsMoveAmount += .005 * e, this.legsMoveAmount = Math.min(this.legsMoveAmount, 1e3 * h / e), this.legsMoveAmount = clamp01(this.legsMoveAmount), this.pos.distanceTo(this.serverPos) > this.maxPredictedServerPosDistance ? (this.rigidBody.pos.copy(this.serverPos), this.serverPosSmooth.copy(this.serverPos), this.rigidBody.velocity.set(0, 0, 0)) : this.rigidBody.pos.copy(this.serverPosSmooth);
      ...
      if (this.rigidBody.inAirTime > 200 && !this.rigidBody.climbingLadder) {
        if (t - d < 200) {
          ...
          t.multiplyScalar(mapValue(0, Math.PI, 1, 0, i, !0)), this.antiFlyAccumulator += t.length(), this.antiFlyInAirTimeRaw += e, this.antiFlyInAirTimeAccumulator += e * mapValue(2, 10, 0, 10, this.lastAntiFlyRaycastDist, !0)
        }
      ...
      if (!this.dead && this.hasTouchedFloorEver) {
        ...
        let i = 0;
        if (t - d < 200 && (i = mapValue(0, 1e4, 0, 1, this.antiFlyInAirTimeAccumulator, !0)), this.antiFlyInAirTimeRaw > 5e3) {
    ...
    if (this.dead) {
      ...
      this.deadAnimationWeight = 1 - Math.pow(2, -e), this.legsMoveAmount = Math.min(this.legsMoveAmount, 1 - this.deadAnimationWeight);
    ...
    if (this.health < 1 && !this.dead) {
      const i = t - this.lastHitTime,
        s = clamp01((.3 * (i / 1e3 - 4)) ** 5);
      this.hasOwnership && (s > .1 ? this.startHealthRegenSound() : this.stopHealthRegenSound()), this.health += 5e-4 * e * s, this.health = Math.min(1, this.health), this.hasOwnership && this.updateHealthUi()
    }
    const a = this.health < 0;
    if (a != this.prevHealthIsNegative && (this.prevHealthIsNegative = a, a && (this.negativeHealthStartTime = t)), a && !this.dead) {
      t - this.negativeHealthStartTime > 1e3 && (this.health = 1, this.hasOwnership && this.updateHealthUi(), this.negativeHealthCounter++, this.negativeHealthCounter >= 2 && (this.report(CheatKickReason.INVULNERABLE, 1), this.negativeHealthCounter = 0))
    }
  ...
  afterPhysicsLoop(t, e) {
    if (this.prevWasOnFloor != this.rigidBody.isOnFloor && (this.prevWasOnFloor = this.rigidBody.isOnFloor, this.rigidBody.isOnFloor && this.rigidBody.prevInAirTime > 300)) {
      ...
      const e = this.highestInAirPoint - this.pos.y,
        i = this.sfxManager.cachedSfx["player/land"],
      ...
      }), this.lastJumpLandTime = t, this.lastJumpLandAmount = s), this.highestInAirPoint = this.pos.y, this.hasTouchedFloorEver = !0
    }
    if (this.rigidBody.isOnFloor || (this.highestInAirPoint = Math.max(this.highestInAirPoint, this.pos.y)), this.hasOwnership && (this.rigidBody.inAirTime > 50 ? this.startFallSound() : this.stopFallSound(), !this.hasWalkedAwayFromSpawn && this.game.gameStarted)) {
      this.pos.distanceTo(this.lastRespawnPosition) > 5 && (this.hasWalkedAwayFromSpawn = !0, this.setWeaponSelectionDialogVisibility(!1), getMainInstance().adBanners.setPageVisibility("respawn", !1))
    }
    if (this.holdingFlag && this.holdingFlag.updateRenderPosition(), this.deadFromFall || this.pos.copy(this.rigidBody.pos), this.cachedCamPosDirty = !0, this.activeModel && this.activeModel.isInit && this.obj) {
      ...
      let e = this.lookRot;
      if (this.dead && (e = this.deadLookRot), this.obj.rotation.y = e.x + Math.PI, this.obj.updateWorldMatrix(!1, !0), this.skeleton && this.skeleton.isInit) {
        ...
        i -= this.currentToggleWeaponCooldown, i /= 150, this.equippingWeaponLayer && (this.equippingWeaponLayer.weight = Math.max(0, 1 - Math.abs(i)));
        ...
        if (s != this.lastWeaponLayersKey) {
          ...
          this.weaponLayers = [];
          for (const [t, i] of e.entries()) this.weaponLayers[t] = this.skeleton.insertPoseLayer(t + 1, i.name);
        ...
        let a = this.lookRot;
        this.dead && (a = this.deadLookRot.clone(), a.y = lerp(this.deadLookRot.y, 0, this.deadAnimationWeight)), this.skeleton.setLookRotY(-a.y, n), this.skeleton.legLObj && (this.skeleton.legLObj.rotation.x = .5 * Math.cos(this.legsMoveTForCos) * this.legsMoveAmount), this.skeleton.legRObj && (this.skeleton.legRObj.rotation.x = .5 * -Math.cos(this.legsMoveTForCos) * this.legsMoveAmount), this.skeleton.updateMatrices(), this.activeModel.applySkeleton(this.skeleton)
      }
    }
  ...
  sendPlayerDataToServer() {
    getMainInstance().network.sendPlayerData(this.game, this.id, {
      ...
      rotX: this.lookRot.x,
      rotY: this.lookRot.y
    }), this.lastPosSentTime = getMainInstance().now, this.lastSentPos.copy(this.pos), this.lastSentRot.copy(this.lookRot), this.holdingFlag && this.holdingFlag.sendFlagReturnProgressToServer(this.pos)
  }
  ...
  receivedPerformAction(t) {
    this.hasOwnership || (this.lastReceivedActionTime = getMainInstance().now, t == Player.PlayerAction.JUMP ? this.onJumpPress() : t == Player.PlayerAction.FIRE_DOWN ? this.onFireDown() : t == Player.PlayerAction.FIRE_UP ? this.onFireUp() : t == Player.PlayerAction.DIE && this.die())
  }
  receiveChangeClassFromServer(t) {
    this.hasOwnership || this.setActiveBowWeapon(t)
  }
  setHasOwnership(t) {
    t != this.hasOwnership && (this.hasOwnership = t, t ? (this.didInitRespawn || (this.respawn(), this.didInitRespawn = !0), this.weaponAccuracyOffset = this.game.crosshair.createAccuracyOffset()) : this.weaponAccuracyOffset && (this.game.crosshair.deleteAccuracyOffset(this.weaponAccuracyOffset), this.weaponAccuracyOffset = null), this.setHasKeyEvents(t), this.setHasMovementAccuracyOffset(t), this.updateModelVisibility(), this.updateUseFirstPersonHoldingHandlers(), this.updateToggleWeaponTouchButtonVisibility())
  }
  setPlayerName(t) {
    this.playerName = t
  }
  ...
  setTeamId(t) {
    if (this.teamId != t)
      if (this.teamId = t, this.updateMySelectedWeapon(!0), this.reloadPlayerModel(), this.hasOwnership) {
        if (!(this.game instanceof Game)) throw new Error("Setting team id is not supported for offline games");
        this.game.updateMyTeamColor(), this.game.updatePlayerIconVisibilities()
      } else this.updateIconVisibility()
  }
  setIsSameSquadPlayer(t, e) {
    this.isSameSquadPlayer = t, this.squadPlayerId = e
  }
  setScores({
    flags: t,
    kills: e,
    ...
    this.scoreFlags = t, this.scoreKills = e, this.scoreDeaths = i, this.scoreTotal = s, this.scoreSkillLevel = n
  }
  ...
  setHasKeyEvents(t) {
    ...
    t ? (i.onPressedDown(this.boundOnJumpPress), s.onPressedDown(this.boundOnFireDown), s.onPressedUp(this.boundOnFireUp), n.onPressedDown(this.boundToggleActiveWeapon), e.dialogManager.onNeedsUnlockedPointerChange(this.boundUpdateSmoothCam), e.cam.onThirdPersonChange(this.boundOnThirdPersonChange), e.input.touch.onTouchSupportedChange(this.boundUpdateToggleWeaponTouchButtonVisibility), onWeaponSelectionChange(this.onWeaponSelectionChangeFromDialog), e.settingsManager.onValueChange("smoothCam", (t => {
      this.smoothCamSetting = t, this.updateSmoothCam()
    })), this.smoothCamSetting = e.settingsManager.getValue("smoothCam"), this.updateSmoothCam()) : (i.removeCb(this.boundOnJumpPress), s.removeCb(this.boundOnFireDown), s.removeCb(this.boundOnFireUp), e.dialogManager.removeOnNeedsUnlockedPointerChange(this.boundUpdateSmoothCam), e.cam.removeOnThirdPersonChange(this.boundOnThirdPersonChange), e.input.touch.removeOnTouchSupportedChange(this.boundUpdateToggleWeaponTouchButtonVisibility), removeOnWeaponSelectionChange(this.onWeaponSelectionChangeFromDialog))
  }
  updateSmoothCam() {
  ...
  getStatClassValue(t) {
    ...
    const e = this.statClassValues.get(t) || 0;
    return clamp01(e / 5)
  }
  reloadPlayerModel() {
  ...
  setPlayerEquippedSkinData(t) {
    this.equippedSkinData = t, this.statClassValues = getMainInstance().skins.getStatClassValuesFromShopSkinIds(t.equippedSkinIds || []), this.bowWeapon && this.bowWeapon.playerSkinUpdated(), this.meleeWeapon && this.meleeWeapon.playerSkinUpdated(), this.updateActiveMeleeWeapon(), this.needsPlayerModel && (this.loadingModel && this.loadingModel.destructor(), this.loadingModel = null, this.loadingModel = new PlayerModel({
      skinObjectOpts: {
        teamId: this.teamId,
        skin: t
      }
  ...
  async replaceLoadingModel() {
    ...
    this.activeModel && this.activeModel.destructor(), this.activeModel = this.loadingModel, this.loadingModel = null, this.obj && getMainInstance().scene.remove(this.obj);
    const t = this.activeModel.obj;
    this.obj = t, t && (t.name = "player", getMainInstance().scene.add(t));
    for (const t of this.holdingHandlers) t.playerObjectChanged();
    this.updateModelVisibility(), getMainInstance().renderer.renderWorthyEventHappened()
  }
  ...
  jump() {
    ...
    e > 0 && (this.lastJumpTime = getMainInstance().now, this.sendPerformAction(Player.PlayerAction.JUMP), this.sfxManager.playSound(`player/jump/${this.gender}/${randInt(1, 4)}`, {
      pos: this.getSfxPos()
  ...
  onFireDown() {
    if (!this.dead) {
      if (this.hasOwnership) {
        if (getMainInstance().mainMenu.visible) return;
        getMainInstance().gameManager.joinIfNotJoined()
      }
      this.weaponActionIsDown = !0, this.sendPerformAction(Player.PlayerAction.FIRE_DOWN), getMainInstance().renderer.renderWorthyEventHappened(), this.activeWeapon && this.activeWeapon.actionDown()
    }
  }
  onFireUp() {
    this.weaponActionIsDown = !1, this.dead || (this.sendPerformAction(Player.PlayerAction.FIRE_UP), getMainInstance().renderer.renderWorthyEventHappened(), this.activeWeapon && this.activeWeapon.actionUp())
  }
  startToggleActiveWeaponCooldown() {
    this.lastActiveWeaponToggleTime = getMainInstance().now, this.didUpdateActiveWeaponAfterToggle = !1
  }
  toggleActiveWeapon() {
    this.hasOwnership && (this.meleeWeapon || this.hasActiveMeleeWeapon) && (this.hasActiveMeleeWeapon = !this.hasActiveMeleeWeapon, this.startToggleActiveWeaponCooldown(), this.updateActiveWeapon(), getMainInstance().renderer.renderWorthyEventHappened(), this.hasOwnership && getMainInstance().network.sendChangeActiveWeaponType(this.id, this.hasActiveMeleeWeapon))
  }
  receiveChangeWeaponTypeFromServer(t) {
    this.hasOwnership || t == this.hasActiveMeleeWeapon || (this.hasActiveMeleeWeapon = t, this.startToggleActiveWeaponCooldown(), this.updateActiveWeapon(), getMainInstance().renderer.renderWorthyEventHappened())
  }
  updateActiveWeapon() {
    this.bowWeapon && this.bowWeapon.setIsPrimaryWeapon(!this.hasActiveMeleeWeapon && !this.activeWeaponToggleCooldownActive), this.meleeWeapon && this.meleeWeapon.setIsPrimaryWeapon(this.hasActiveMeleeWeapon && !this.activeWeaponToggleCooldownActive), this.activeWeapon && this.weaponActionIsDown && !this.activeWeapon.actionIsDown && this.activeWeapon.actionDown()
  }
  onThirdPersonChange() {
    "front" == getMainInstance().cam.thirdPersonMode && (this.frontThirdPersonLookRot.copy(this.lookRot), this.frontThirdPersonLookRot.x += Math.PI), this.updateModelVisibility(), this.updateUseFirstPersonHoldingHandlers()
  }
  addHitFlash(t) {
    const e = new Vector3;
  ...
  playerClaimedHitByArrow(t, e, i) {
    ...
    if (s) {
      ...
      const a = 3;
      let o = !1;
      if ([].push([s.center.clone(), s.center.clone().add(new Vector3(0, 5, 0)), 16777215]), n) {
        if (i.prevPos) {
          let t = 1 / 0;
        ...
        if (o) this.onValidArrowHitFromServer(t, i, s);
        else {
          let e = !1,
          ...
          i.onTravel((o => {
            ...
            h.distanceTo(s.center) < a && (e = !0, this.onValidArrowHitFromServer(t, i, s))
          })), setTimeout((() => {
            if (!e) {
              const e = performance.now();
              this.recentInvalidArrowTimes.push(e), this.recentInvalidArrowTimes = this.recentInvalidArrowTimes.filter((t => e - t < 3e3)), this.recentInvalidArrowTimes.length >= 3 && (t.report(CheatKickReason.INVALID_ARROW, 1), this.recentInvalidArrowTimes = [])
            }
          }), 1e3)
        }
      } else t.report(CheatKickReason.INVALID_ARROW, 1)
    }
    this.hasOwnership || (t.hasOwnership || this.addHitFlash(i), this.sfxManager.playSound(`player/takeDamage/${this.gender}/${randInt(1, 4)}`, {
      pos: this.getSfxPos()
    }))
  }
  onValidArrowHitFromServer(t, e, i) {
    ...
    let n = null;
    e && (n = e.lookDirection);
    this.applyDamage(s, n) && getMainInstance().network.sendValidArrowHit(t.id, e.arrowId, this.health)
  }
  hitByMeleeFromServer(t) {
    ...
    if (i *= lerp(.5, 1.5, t.getStatClassValue("meleeAttackStrength")), this.applyDamage(i, e), this.hasOwnership || t.hasOwnership || (this.addMeleeHitFlash(), t.meleeWeapon.playHitSfx()), this.hasOwnership) {
      const e = t.meleeWeapon.getStunData();
      e && this.applyStun(e)
    }
  }
  applyStun(t) {
    this.recentStunEvents.add({
  ...
  applyDamage(t, e) {
    ...
    for (let t = this.damageReceivedHistory.length - 1; t >= 0; t--) {
      if (!(i - this.damageReceivedHistory[t].time > 1e3)) break;
      this.damageReceivedHistory.splice(t, 1)
    }
    let s = 1.1 * t,
      n = t * lerp(1.1, .9, this.getStatClassValue("armorStrength"));
    s = this.computeDamageWithCooldown(s), n = this.computeDamageWithCooldown(n);
    const a = {
      damage: n,
      time: i,
      appliedDamage: 0
    ...
    if (this.damageReceivedHistory.unshift(a), n > .001) {
      ...
      return this.game.gameStarted && (this.health -= n), this.setHealthFromHit(this.health, e, n, t), !0
    }
    return !1
  }
  ...
  setHealthFromHit(t, e, i, s) {
    this.health = t, this.lastHitTime = getMainInstance().now, this.hasOwnership && (getMainInstance().screenFlash.flash(e, i), this.sfxManager.playSound(`player/takeDamage/${this.gender}/${randInt(1, 4)}`), this.updateHealthUi(s), this.health < .05 && this.die())
  }
  getCamPos() {
    if (this.cachedCamPosDirty) {
      this.cachedCamPos.copy(this.pos), this.cachedCamPos.y += 1.6, this.noclip && this.noclipCamPos && this.cachedCamPos.add(this.noclipCamPos);
      const t = getMainInstance();
    ...
    if ("back" == t.cam.thirdPersonMode) {
      ...
      if (e) {
        ...
        if (t) {
          ...
          return o.setFromAxisAngle(new Vector3(0, 1, 0), a), e.applyQuaternion(o), e
        }
      }
    }
    const e = new Vector3(0, 0, -1);
  ...
  setServerData(t, e, i, s, n, a = !1) {
    ...
    this.serverPos.set(t, e, i), this.hasValidPosition || (this.hasValidPosition = !0, this.hasOwnership || this.sfxManager.playSound("player/spawn", {
      pos: this.getSfxPos()
    }), this.updateModelVisibility()), this.predictedServerVelocity.copy(this.serverPos), this.predictedServerVelocity.sub(o);
    const r = getMainInstance().now - this.lastReceivedServerPosTime;
    if (this.lastReceivedServerPosTime = getMainInstance().now, r <= 0 || this.predictedServerVelocity.length() > 5 ? (this.predictedServerVelocity.set(0, 0, 0), this.predictedServerAcceleration.set(0, 0, 0)) : (this.predictedServerVelocity.divideScalar(r), this.predictedServerAcceleration.copy(this.predictedServerVelocity), this.predictedServerAcceleration.sub(this.lastPredictedServerVelocity), this.predictedServerAcceleration.divideScalar(r)), this.hasOwnership && a) {
      let t = !1;
  ...
  updateIconVisibility(t) {
    ...
    this.game instanceof Game ? (void 0 === t && (t = this.game.getMyTeamId()), t != this.teamId && (e = !1)) : e = !1, this.icon.setVisibility(1)
  ...
  dieFromFall() {
    this.hasOwnership && (this.deadFromFall = !0, this.holdingFlag && this.sendChangeFlag(this.holdingFlag.id, NetworkManager.FlagChangeOperation.RETURN, !1), this.die())
  }
  die() {
    if (this.dead) return;
    const t = this.game instanceof Game ? this.game : null;
    this.hasOwnership && (this.sfxManager.playSound("feedback/die"), t && t.showKilledNotification(), this.setWeaponSelectionDialogVisibility(!0), this.game.gameStarted && getMainInstance().adBanners.setPageVisibility("respawn", !0), this.deadFromFall || getMainInstance().cam.setThirdPersonMode("dead"), this.game.crosshair.setDeadVisibility(!1)), this.dead = !0, this.activeWeapon && this.activeWeapon.actionUp(), this.bowWeapon && this.bowWeapon.onPlayerDied(), this.meleeWeapon && this.meleeWeapon.onPlayerDied(), this.sendPerformAction(Player.PlayerAction.DIE), this.dieTime = getMainInstance().now, this.deadFallForward = this.computeDeadFallDirection(), this.deadLookRot.copy(this.lookRot), this.updateMySelectedWeapon(), this.stopFallSound(), this.updateModelVisibility(), this.hasOwnership && setTimeout((() => {
  ...
  respawn() {
    ...
    const {
      pos: t,
      rot: e
    } = this.game.getSpawnPosition(this.teamId), i = new Vector3(0, 0, 1);
    i.applyQuaternion(e), i.y = 0;
    const s = new Vector3(0, 0, 1);
    let n = i.angleTo(s);
    s.cross(i).y < 0 && (n *= -1), this.dead = !1, this.deadFromFall = !1, this.currentSpawnId++, getMainInstance().network.sendPlayerSpawn(this.id, this.currentSpawnId), getMainInstance().renderer.renderWorthyEventHappened(), this.setPosition(t), this.resetDeadPoseWeights(), this.hasOwnership && getMainInstance().cam.setThirdPersonMode("none"), this.hasWalkedAwayFromSpawn = !1, this.lastRespawnPosition.copy(t), this.setWeaponSelectionDialogVisibility(!0), this.game.gameStarted && getMainInstance().adBanners.setPageVisibility("respawn", !0), this.updateMySelectedWeapon(), this.lookRot.set(n, 0), this.resetSmoothLookRot(), this.updateModelVisibility(), getMainInstance().cam.playerRespawned(), this.sfxManager.playSound("player/spawn"), this.health = 1, this.bowWeapon && this.bowWeapon.onPlayerRespawned(), this.meleeWeapon && this.meleeWeapon.onPlayerRespawned(), this.game.crosshair.setDeadVisibility(!0), this.updateHealthUi(), this.sendPlayerDataToServer(), this.sendMyEquippedSkinData()
  }
  receivedSpawn(t) {
    this.currentSpawnId = t, this.dead = !1, this.resetDeadPoseWeights(), this.health = 1, this.hasValidPosition = !1, this.activeWeapon && this.activeWeapon.onPlayerRespawned(), this.updateModelVisibility()
  }
  ...
  updateHealthUi(t) {
    this.game instanceof Game && (this.game.healthUi.setHealth(this.health), void 0 !== t && this.game.healthUi.flashDamageProtection(t))
  }
  setPosition(t) {
  ...
  changeFlagFromServer(t, e) {
    e == NetworkManager.FlagChangeOperation.GRAB ? (this.holdingFlag = t, t.startHoldByPlayer(this), this.sfxManager.playSound("flag/grab", {
      pos: this.pos
    })) : e == NetworkManager.FlagChangeOperation.CAPTURE ? (this.holdingFlag = null, t.returnToDefaultPos()) : e == NetworkManager.FlagChangeOperation.DROP ? (this.holdingFlag = null, t.setDroppedPosition(this.pos.x, this.pos.y, this.pos.z, this.velocity.x, this.velocity.y, this.velocity.z), t.removeCurrentHoldingPlayer(), this.sfxManager.playSound("flag/drop", {
      pos: this.pos
    })) : e == NetworkManager.FlagChangeOperation.RETURN && (this.holdingFlag == t && (this.holdingFlag = null), t.returnToDefaultPos()), this.removeChangeFlagFromQueue(t.id, e)
  }
  stopHoldingFlag(t) {
  ...
  report(t, e) {
    if (!(this.game instanceof Game)) throw new Error("Reporting players is not supported in offline games");
...
class FlagRigidBody extends RigidBody {
  constructor(t, e) {
    super(), this.physicsManager = t, this.flag = e, this.pos = new Vector3, this.velocity = new Vector3, this.isOnFloor = !1, this.radius = .5;
    const i = this.radius;
...
class Flag {
  constructor(t, e, i, s, n, a) {
    this.id = t, this.teamId = e, this.defaultPosition = i, this.defaultRotation = s, this.position = i.clone(), this.game = n, this.physicsManager = a, this.isOnDefaultPos = !0, this.rigidBody = new FlagRigidBody(this.game.physics, this), this.rigidBody.enabled = !1, a.registerRigidBody(this.rigidBody), this.obj = new Object3D, this.obj.name = "flag", this.obj.position.copy(i), this.obj.quaternion.copy(s), getMainInstance().scene.add(this.obj), this.grabAnimationContainer = new Object3D, this.grabAnimationContainer.name = "flagGrabAnimationContainer", this.obj.add(this.grabAnimationContainer), this.obj.updateWorldMatrix(!1, !0), this.grabStartTime = 0, this.returnProgress = 0, this.onNearDefaultPosChangeCbs = new Set, this.isNearDefaultPos = !0, this.onCurrentHoldingPlayerChangeCbs = new Set, this.currentHoldingPlayer = null, this.prevIsBeingHeld = !1, this.holdingHandler = null, this.icon = getMainInstance().hudIcons.createIcon({
      url: `static/img/hudIcons/flag${teamColors[e].nameCapitalized}.svg`
    }), this.initModel(), this.destructed = !1
  }
  destructor() {
    this.destructed = !0, getMainInstance().hudIcons.removeIcon(this.icon), this.removeCurrentHoldingPlayer(), this.destroyHoldingHandler(), this.obj.parent == getMainInstance().scene && getMainInstance().scene.remove(this.obj), this.physicsManager.removeRigidBody(this.rigidBody)
  }
  async initModel() {
  ...
  startHoldByPlayer(t) {
    t != this.currentHoldingPlayer && (this.removeCurrentHoldingPlayer(), this.currentHoldingPlayer = t, this.grabStartTime = getMainInstance().now, this.updateRenderState(), this.onCurrentHoldingPlayerChangeCbs.forEach((t => t())))
  }
  destroyHoldingHandler() {
    this.holdingHandler && (this.holdingHandler.destructor(), this.holdingHandler = null, getMainInstance().scene.add(this.obj))
  }
  returnToDefaultPos() {
  ...
  setDroppedPosition(t, e, i, s, n, a) {
    this.isOnDefaultPos = !1, this.position.set(t, e + this.rigidBody.radius, i), this.updateIsNearDefaultPos(), this.currentHoldingPlayer || (this.rigidBody.pos.copy(this.position), this.rigidBody.velocity.set(s, n, a), this.rigidBody.enabled = !0, this.returnProgress = 0, this.updateRenderState())
  }
...
class Arrow {
  constructor(t, e, i, {
    ...
    this.physics = t, this.hingeManager = e, this.shotBy = i, this.arrowId = s, this.startPos = n, this.consumed = !1, this.arrowManager = l, this.scene = h, this.networkOffsetPos = a, this.networkStartPos = n.clone().add(a), this.dir = o, this.arrowWeaponOpts = {
    ...
    }, this.playerDamageMultiplier = lerp(.8, 1.2, i.getStatClassValue("bowAttackStrength")), i.bowWeapon && (this.arrowWeaponOpts = {
      ...this.arrowWeaponOpts,
      ...i.bowWeapon.getArrowOpts(r)
    }), this.strength = lerp(10, 500 * this.arrowWeaponOpts.travelDistanceMultiplier, r), this.dir.setLength(this.strength), this.existingTime = 0;
    const d = this.getParabolaExtremePoint();
    this.parabolaXDist = 2 * d.x;
    const c = this.parabolaXDist + 2 * d.y;
    this.xSpeed = 0 == c ? 1 : Math.abs(this.parabolaXDist / c), this.xSpeed *= mapValue(100, 500, .05, .15, this.strength), this.visualStartPos = this.getParabolaPoint3d(0), this.obj = new Object3D, this.obj.name = "Arrow container " + this.arrowId, this.obj.position.copy(this.networkStartPos), this.obj.scale.copy(this.arrowWeaponOpts.scale), this.scene.add(this.obj), this.prevPos = null, this.prevRaycastPos = null, this.cachedRays = [], this.travelledPositions = [], this.onTravelCbs = new Set, this.lookDirection = new Vector3, this.sphere = null, this.trailObj = null, this.trailGeo = null, this.trailMat = null, this.stuckInHingeId = -1, this.hingeImpactMatrix = null, this.boundUpdateHingePosition = this.updateHingePosition.bind(this), this.didHitWorld = !1, this.didHitPlayer = !1, this.worldHitTime = 0, this.worldHitRot = null, this.worldHitTangent = null, this.worldHitLastRayDistance = 0, this.destructed = !1
  }
  destructor() {
  ...
  async initModel() {
    const t = await getMainInstance().arrowAssetCache.getArrowAssetWithCache(this.arrowManager.arrowAssetName, this.shotBy.teamId);
    if (this.destructed) return;
    this.obj.add(t.clone());
    const e = this.arrowManager.getSphereGeo(this.shotBy.teamId);
    this.sphere = new Mesh(e, getMainInstance().materials.basicUnlitMat), this.sphere.name = "Arrow sphere", this.sphere.position.z = -1, this.obj.add(this.sphere)
  }
  initTrail() {
    ...
    for (let t = 0; t < e; t++) {
      ...
      for (let t = 0; t < 3; t++) {
        ...
        e.applyQuaternion(g);
        const s = e.clone();
        n[3 * l + 0] = c.x, n[3 * l + 1] = c.y, n[3 * l + 2] = c.z, o[3 * l + 0] = s.x, o[3 * l + 1] = s.y, o[3 * l + 2] = s.z, a[l] = d, l++
      }
      if (t < 29) {
        const e = 3 * t,
          i = e + 3;
        for (let t = 0; t < 3; t++) {
          const s = (t + 1) % 3;
          r.push(e + t, e + s, i + t), r.push(e + s, i + s, i + t)
        }
      }
    }
    const d = new BufferGeometry;
    d.setAttribute("position", new BufferAttribute(n, 3)), d.setAttribute("arrowT", new BufferAttribute(a, 1)), d.setAttribute("normal", new BufferAttribute(o, 3)), d.setIndex(r), this.trailGeo = d;
    const c = getMainInstance().materials.arrowTrailMat;
    if (!c) throw new Error("Couldn't find arrow trail material.");
    this.trailMat = c.clone(), this.trailMat.uniforms.shootStartPos.value.copy(this.visualStartPos);
    const u = .1 * this.strength,
      p = Math.max(u, Math.abs(this.parabolaXDist)) * this.arrowWeaponOpts.trailDurationMultiplier;
    this.trailMat.uniforms.estimatedXLength.value = p, this.trailObj = new Mesh(d, this.trailMat), this.trailObj.name = "Arrow trail " + this.arrowId, this.scene.add(this.trailObj)
  }
  loop(t, e) {
    if (!this.didHitWorld && !this.didHitPlayer) {
      ...
      this.prevPos.copy(i), this.prevRaycastPos.copy(s), this.obj.quaternion.setFromUnitVectors(new Vector3(0, 0, 1), this.lookDirection), this.didHitWorld || this.obj.position.copy(o)
    }
        ...
        if (i) {
          ...
          if (!e) {
            ...
            if (this.didHitPlayer = !0, this.shotBy.hasOwnership) {
              ...
              t.addHitFlash(e), getMainInstance().sfx.playSound("feedback/hitPlayer");
              "head" == i.collider.bodyPart && getMainInstance().sfx.playSound("feedback/headShot"), getMainInstance().network.sendHitByArrow(t.id, t.currentSpawnId, this.shotBy.id, this.arrowId, e)
            }
            this.obj.visible = !1
          }
        }
  ...
  updateHingePosition(t) {
    ...
    const e = this.getImpactShake(getMainInstance().now),
      i = new Quaternion;
    i.setFromAxisAngle(new Vector3(1, 0, 0), e), this.obj.matrix.makeRotationFromQuaternion(i), this.obj.matrix.premultiply(this.hingeImpactMatrix), this.obj.matrix.premultiply(t.object.matrixWorld), this.obj.updateWorldMatrix(!1, !0)
  }
  onTravel(t) {
  ...
  getParabolaPoint3d(t, e = !1, i = !0) {
    ...
    } = this.map3dDirTo2d(this.dir), a = this.getParabolaPoint2d(s.x, s.y, t);
    e && 0 == s.x && (a.x = 0);
    const o = new Vector3(a.x, a.y, 0);
    o.applyQuaternion(n), o.add(this.startPos);
    const r = this.getNearbyStartAmount(o);
    if (i) {
      const t = this.arrowWeaponOpts.visualOffset.clone();
      t.multiplyScalar(r), t.applyQuaternion(n), o.add(t)
    }
  ...
  getParabolaPoint2d(t, e, i) {
    ...
    let n = 0;
    return 0 == s ? n = -Math.pow(i, 2) * (1 / t) : 0 == t ? n = (1 - Math.pow(2 * (i / s - .5), 2)) * e * .5 : (n = (1 - Math.pow((i / s - t) / t, 2)) * e * .5, n *= s), new Vector2(i, n)
  }
  sCurve(t, e = Math.E) {
...
class DebugLine {
  static setCurrentScene(t) {
    this.scene = t, this.drawLinesNextFrame = [], this.removeLinesNextFrame = [], this.material || (this.material = new LineBasicMaterial({
      color: 16777215,
      vertexColors: !0
    }))
  }
...
class ArrowManager {
  constructor(t, e, i) {
    this.physics = t, this.hingeManager = e, this.teamCount = i, this.arrowAssetName = "arrow.glb", this.arrows = new Map, this.oldPlayerArrows = new Set, this.sphereGeos = [];
    for (let t = 0; t < i; t++) {
      ...
      if (r) {
        const [t, e, i] = rgbToHsv(n, a, o), s = {
          h: t,
          s: e,
          v: i
        };
        r(s), [n, a, o] = hsvToRgb(s.h, s.s, s.v)
      }
      const l = [n, a, o];
      for (let t = 0; t < s.byteLength; t += 3)
        for (let e = 0; e < l.length; e++) s[t + e] = .3 * l[e];
      e.setAttribute("color", new BufferAttribute(s, 3)), this.sphereGeos.push(e)
    }
    getMainInstance(), this.destructed = !1
  }
  destructor() {
    this.destructed = !0;
  ...
  createArrow(t, e) {
    ...
    a || (a = new Map, this.arrows.set(n, a));
    const o = a.get(s);
    o && this.oldPlayerArrows.add(o), a.set(s, i), getMainInstance().renderer.renderWorthyEventHappened()
  }
  getArrowById(t, e) {
...
class Crosshair {
  ...
  setFlagReturnProgress(t) {
    ...
    this.flagReturnProgressPath1.setAttribute("d", s), this.flagReturnProgressPath2.setAttribute("d", s)
  }
  ...
  updateThirdPersonVisibility() {
    this.thirdPersonVisibility = "front" != getMainInstance().cam.thirdPersonMode, this.updateVisibility()
  }
  updateVisibility() {
...
class FlagScoreUiItem {
  constructor(t) {
    this.el = document.createElement("div"), this.el.classList.add("flagScoreItem"), this.iconEl = document.createElement("div"), this.iconEl.classList.add("flagScoreIcon"), this.teamId = t, this.teamName = teamColors[t].nameCapitalized, this.iconEl.style.background = `url("static/img/scoreUI/flag${this.teamName}.svg")`, this.el.appendChild(this.iconEl), this.onNeedsNotificationCbs = new Set, this.hasReceivedScore = !1, this.maxScore = 3, this.score = 0, this.grabbedState = "return", this.pointEls = [];
  ...
  updatePointIcons() {
    for (const [t, e] of this.pointEls.entries()) {
      let i = "pointEmpty";
      t == this.score && ("grab" == this.grabbedState ? i = "pointGrabbed" : "drop" == this.grabbedState && (i = "pointDropped")), t < this.score && (i = "pointCaptured" + this.teamName), e.style.background = `url("static/img/scoreUI/${i}.svg")`
    }
  }
  getFinalFlagHeld() {
...
class FlagScoreUi {
  constructor(t) {
    this.el = document.createElement("div"), this.el.classList.add("flagScoreContainer"), document.body.appendChild(this.el), this.onNeedsNotificationCbs = new Set, this.scoreItems = [];
    for (let e = 0; e < t; e++) {
      if (0 == e) continue;
      const t = new FlagScoreUiItem(e);
      this.el.appendChild(t.el), this.scoreItems[e] = t, t.onNeedsNotification((t => {
...
class HealthUi {
  ...
  flashDamageProtection(t) {
    t = 100 * clamp01(t), this.damageProtectionBarContainer2.style.left = `${t}%`, this.damageProtectionBar.style.transform = `translateX(-${t}%)`, this.damageProtectionBar.style.opacity = "1", this.damageProtectionBar.style.transition = "none", recalculateStyle(this.damageProtectionBar), this.damageProtectionBar.style.opacity = "0", this.damageProtectionBar.style.transition = ""
  }
  setVisible(t) {
    this.el.style.display = t ? "" : "none"
  }
...
function testResized() {
  ...
  t == prevW && e == prevH || (prevW = t, prevH = e, listeners.forEach((t => t())))
}
...
class PlayersListDialogUi extends DialogUi {
  constructor(t, e, i) {
    ...
    for (const [t, e] of teamColors.entries()) {
      ...
      o.classList.add("playersListHead"), a.appendChild(o);
      const r = [{
        text: "",
        width: 100,
        colOnly: !0
      ...
      for (const t of r) {
        ...
        if (e.style.width = t.width + "px", n.appendChild(e), t.colOnly) continue;
      ...
      s.appendChild(l), this.teamEls[t] = {
        containerEl: i,
        tbody: l,
        name: e.name
      }
    }
    this.skipText = new SkipDialogText, this.el.appendChild(this.skipText.el), this.skipText.setVisibility(!1), this.scoresFrozen = !1, this.playersListDirty = !0, this.updateTeamsOrder(), this.boundOnResize = this.onResize.bind(this), addResizeListener(this.boundOnResize), this.onResize(), this.setUnsetTeamVisibility(!0)
  }
  destructor() {
    super.destructor(), addResizeListener(this.boundOnResize);
    for (const t of this.currentAvatarBlobUrlReferences) t.destructor();
    this.currentAvatarBlobUrlReferences.clear()
  }
  onVisibilityChange() {
  ...
  updatePlayersList() {
    ...
    for (const e of i) {
      ...
      for (const s of n) {
        const n = document.createElement("td");
        if (s.isPlayerName || (n.textContent = String(s.text)), s.isScore) n.classList.add("playersListItemScore"), n.style.cssText = `\n\t\t\t\t\t\t--wrinkled-paper-seed: ${e.id};\n\t\t\t\t\t`;
        else if (s.isAvatar) {
          const i = document.createElement("div");
          ...
          this.currentAvatarBlobUrlReferences.add(s), (async () => {
            const e = await s.getBlobUrl(),
              ...
              o = t.get(a);
            let r = null;
            o && o.length > 0 && (r = o.pop()), r ? (n.removeChild(i), n.appendChild(r), t.delete(e)) : i.style.backgroundImage = a
          })()
        } else if (s.isPlayerName) {
          const t = document.createElement("span");
          if (t.classList.add("player-list-username"), t.textContent = s.text, n.appendChild(t), n.classList.add("players-list-item-username"), s.verified) {
            const t = document.createElement("div");
        ...
        if (s.label) {
          const t = document.createElement("span");
          t.textContent = s.label, t.classList.add("players-list-label"), t.style.background = teamColors[e.teamId].cssColor, n.appendChild(t)
        }
        i.appendChild(n)
      }
    }
...
class ScoreOffsetNotificationsUi {
  ...
  showOffsetNotification(t, e) {
    ...
    const a = document.createElement("div");
    if (a.classList.add("scoreOffsetNotificationAnim"), a.style.animation = `1s notificationIconFade ${s}s both, 0.2s notificationIconPop`, n.appendChild(a), i.text) {
      const t = document.createTextNode(i.text + " ");
      a.appendChild(t)
    }
    const o = document.createElement("span");
    o.classList.add("scoreOffsetNotificationScore"), o.textContent = `+${t}`, a.appendChild(o), this.destroyOldNotifications(), this.updateNotificationOffsets()
  }
...
class GameOverStatsDialogUi extends DialogUi {
  constructor({
    ...
    a.style.color = o.cssColor, this.el.appendChild(a), this.statsContainer = document.createElement("div"), this.statsContainer.classList.add("gameoverStatsContainer", "wrinkledPaper"), this.statsContainer.style.cssText = `\n\t\t\tbackground: ${o.cssColorLight};\n\t\t\tbackground: paint(wrinkledPaper);\n\t\t\t--team-bg-color-light: ${o.cssColorLight};\n\t\t\t--team-bg-color-dark: ${o.cssColorDark};\n\t\t\t--wrinkled-paper-seed: ${randInt(1, 99999)};\n\t\t`, this.el.appendChild(this.statsContainer);
    const r = document.createElement("table");
    r.classList.add("gameOverStatsTable", "itemsTable"), this.statsContainer.appendChild(r);
    const l = document.createElement("tbody");
    r.appendChild(l);
    for (const [e, i] of ScoreOffsetReasonConfigs.entries()) {
      ...
      a.classList.add("tableItem"), l.appendChild(a);
      const o = document.createElement("td");
      o.textContent = n || "", a.appendChild(o);
      const r = document.createElement("td");
      r.textContent = String(s), a.appendChild(r)
    }
    const h = document.createElement("tr");
    h.classList.add("tableItem", "totalScoreRow"), l.appendChild(h);
    const d = document.createElement("td");
    d.textContent = "Total", h.appendChild(d);
    const c = document.createElement("td");
    if (c.textContent = String(e), h.appendChild(c), this.didWatchRewardedAd = !1, this.rewardedAdFailed = !1, this.onRewardedAdIsPlayingChangeCbs = new Set, s > 0) {
      const t = document.createElement("div");
      t.classList.add("game-over-stats-coins-container"), this.el.appendChild(t);
      const e = new CurrencyContainer;
      e.animateAmount(s), t.appendChild(e.el);
      const i = new UiButton({
        text: "Claim x2",
        ...
        onClick: async () => {
          ...
          if (this.didWatchRewardedAd) {
            ...
            a.success ? (i.visible = !1, e.animateAmount(2 * s), n && this.skipText.startTimer(6), t = !0) : (getMainInstance().dialogManager.showAlert({
              title: "Server error",
              text: "An error occurred while doubling your coins."
            }), console.error(a.error), i.enabled = !0, this.rewardedAdFailed = !0)
          }
    ...
    this.skipText = new SkipDialogText, this.el.appendChild(this.skipText.el), this.boundOnResize = this.onResize.bind(this), addResizeListener(this.boundOnResize), this.onResize()
  }
  onResize() {
...
class CornerStatsUi {
  constructor(t) {
    this.game = t, this.container = document.createElement("div"), this.container.classList.add("corner-stats-container", "hidden"), document.body.appendChild(this.container), this.createdStats = [], this.fpsStat = this.createCornerStat({
      name: "FPS"
      ...
      name: "Network",
      redThreshold: 5
    }), this.visible = !1, this._onVisiblityChangeCbs = new Set, getMainInstance().settingsManager.onValueChange("showStats", (() => {
      this.updateVisibility()
    })), this.updateVisibility()
  }
  destructor() {
...
class ChatManager {
  constructor(t) {
    this.game = t, this.createdMessages = [], this.visible = !1, this.toggledVisible = !0, this.el = document.createElement("div"), this.el.classList.add("chat-container", "wrinkledPaper"), this.el.style.cssText = `\n\t\t--wrinkled-paper-seed: ${randInt(1, 99999)};\n\t\t`, document.body.appendChild(this.el), this.chatLogEl = document.createElement("div"), this.chatLogEl.classList.add("chat-log-container"), this.el.appendChild(this.chatLogEl), this.formEl = document.createElement("form"), this.formEl.addEventListener("submit", (t => {
    ...
    const e = getMainInstance();
    this.chatKey = e.input.getKey("chat"), this.boundChatKeyCb = () => {
      e.network.squadManager.isInSquad && (e.settingsManager.getValue("chatEnabled") && this.textBoxEl.focus(), this.updateVisibility())
    }, this.chatKey.onPressedDown(this.boundChatKeyCb), this.chatVisibilityKey = e.input.getKey("toggleChatVisibility"), this.boundChatVisibilityKeyCb = () => {
    ...
    }, e.network.squadManager.onUserVisibleSquadIdChange(this.boundUpdateVisibilities), this.boundOnTouchSupported = () => {
      this.el.classList.toggle("touch", e.input.touch.touchSupported), e.input.touch.touchSupported && (this.toggledVisible = !1, this.textBoxEl.placeholder = "Type to chat with your squad", this.updateVisibility()), this.updateTouchButtonVisibility()
    }, e.input.touch.onTouchSupportedChange(this.boundOnTouchSupported), e.settingsManager.onValueChange("chatEnabled", this.boundUpdateVisibilities), e.settingsManager.onValueChange("hideUi", this.boundUpdateVisibilities), t.cornerStatsUi.onVisibilityChange((() => {
      this.updateHeight()
    })), t.onGameEndFinish((() => {
      this.updateVisibility()
  ...
  destructor() {
    document.body.removeChild(this.el), this.chatKey.removeCb(this.boundChatKeyCb), this.chatVisibilityKey.removeCb(this.boundChatVisibilityKeyCb);
    const t = getMainInstance();
  ...
  destroyMessage(t) {
    t.avatarBlobReference && t.avatarBlobReference.destructor(), this.chatLogEl.removeChild(t.messageEl), this.createdMessages = this.createdMessages.filter((e => e != t)), 0 == this.createdMessages.length && getMainInstance().input.touch.touchSupported && (this.toggledVisible = !1, this.updateVisibility())
  }
  sendMessage() {
    const t = this.textBoxEl.value;
    this.textBoxEl.value = "", this.textBoxEl.blur(), t && getMainInstance().network.sendChatMessage(t)
  }
  receivedChatMessage(t) {
    ...
    if ("playerMessage" == t.type) {
      ...
      if (!e || i != e.playerId) {
        ...
        const a = document.createElement("div");
        if (a.classList.add("chat-message-content"), t.appendChild(a), n) {
          const t = document.createElement("h3");
          t.classList.add("chat-message-name"), t.textContent = n.playerName, a.appendChild(t)
        }
        e = {
          messageEl: t,
          contentsEl: a,
      ...
      n = n.map((t => containsBadLanguage(t) ? new Array(t.length + 1).join("*") : t)), s.textContent = n.join(" "), e.contentsEl.appendChild(s), s.scrollIntoView({
        behavior: "smooth"
...
class SphereMapCollider extends MapCollider {
  constructor(...t) {
    super(...t), this.radius = this.worldMatrix.getMaxScaleOnAxis(), this.pos = new Vector3, this.pos.setFromMatrixPosition(this.worldMatrix);
...
class OctreeNode {
  ...
  subdivide() {
    ...
    for (let s = 0; s < 8; s++) {
      ...
      this.children.add(a), this.allChildren[s] = a
    }
  } * traverseDown(t = (() => !0)) {
    if (t(this)) {
      yield this;
...
class PhysicsManager {
  constructor() {
    this.rigidBodies = new Set, this.mapColliders = [], this.rootOctreeNode = null, this.octreeMaxDepth = 5, this.mapBounds = null, this.octreeAxisVoxelCount = 0, this.worldToOctreeVoxelSpaceMultiplier = new Vector3, this.isLoweringTimeScale = !1, this.timeScale = 1, this.stepCount = 10
  }
  destructor() { }
  loop(t, e) {
  ...
  addMapCollider(t) {
    ...
    let i;
    return i = "sphere" == t.colliderType ? new SphereMapCollider(e, t) : new BoxMapCollider(e, t), this.mapColliders.push(i), i
  }
  removeMapColliders() {
  ...
  buildOctree() {
    ...
    this.worldToOctreeVoxelSpaceMultiplier.set(1, 1, 1), this.worldToOctreeVoxelSpaceMultiplier.divide(e), this.worldToOctreeVoxelSpaceMultiplier.multiplyScalar(this.octreeAxisVoxelCount), this.rootOctreeNode = new OctreeNode(t), this.rootOctreeNode.addItems(this.mapColliders), this.rootOctreeNode.subdivideRecursive({
  ...
  octreeVoxelSpaceToNodePath(t) {
    ...
    for (let t = 0; t < this.octreeMaxDepth; t++) {
      const t = n >> 1,
        ...
        h = o >> 1;
      let d = 0;
      e % n >= t && (d += 1), i % a >= l && (d += 2), s % o >= h && (d += 4), r.push(d), n = t, a = l, o = h
    }
    return r
  }
...
class MapLoader {
  constructor(t, e) {
    this.configManager = t, this.mapsConfig = e, this.onIsLoadingMapChangeCbs = new Set, this.isLoadingMap = !1, this.loadCloudsCalled = !1, this.environmentIsInit = !1, this.cachedMapHashes = new Set, this.fetchingMapCbs = new Map, this.onOneMapAvailableCbs = new Set, this.firstMapDownloaded = !1, this.onFirstMapDownloadedCbs = new Set, this.onMapCachedCbs = new Set, this.mapVariablesManager = new MapVariablesManager, this.mapVariablesManager.onVariablesChanged((() => {
      this.updateWeatherParams(), this.updateCloudHeight()
    })), this.cloudsObj = null
  }
  async init() {
    if (getMainInstance(), this.mapsConfig.onConfigChange((async t => {
      ...
      if (e) {
        ...
        for (const n of t.maps) {
          ...
          const a = (async i => {
            ...
            a && (s = !0, this.markMapAsCached(n.hash, !1))
          })();
          i.push(a)
        }
  ...
  async loadConfigMap(t, e, {
    retryOnFail: i = !1
  } = {}) {
    const s = this.mapsConfig.getListedMapConfigByHash(t);
    try {
      if (!s) throw new MapLoadError(`Failed to load map, "${t}" is not in the mapsConfig.`, "map-not-in-config");
      await this.loadMap({
        request: {
          type: "config",
          config: s
      ...
      if (!(s instanceof MapLoadError)) throw s;
      if (!i) throw s;
  ...
  async loadConfigMapWithDialogMessage(t, e) {
    try {
      ...
      if (t instanceof MapLoadError && "hash-validation-failed" == t.name) i.showAlert({
        title: s,
  ...
  async loadMap(t, e) {
    ...
    const s = getMainInstance().assets;
    try {
      await s.sendWorkerRequest("loadMap", t, {
        responseCb: t => {
          this.loadMapResponseCbReceived(i, t, e)
        }
      })
    } finally {
  ...
  async reloadMapsConfigAndRetryLoadConfigMap(t, e) {
    return await this.mapsConfig.load(), await this.loadConfigMap(t, e, {
      retryOnFail: !1
    })
  }
  loadMapResponseCbReceived(t, e, i) {
    if ("mapDownloadedNotification" == e.dataType) {
    ...
    } else if ("scene" == e.dataType) {
      const t = AssetsManager.deserializeThreeObject(e.scene);
      t.traverse((t => {
        t.frustumCulled = !1
      }));
      const s = [];
      for (const {
        ...
        of e.hingeObjects) {
        const e = AssetsManager.deserializeThreeObject(t);
        s.push({
          hinge: e,
          behavior: i
        })
      ...
      for (const {
        ...
        of e.appearingObjects) {
        const e = [];
        for (const i of t) {
          const t = AssetsManager.deserializeThreeObject(i.object),
      ...
      if (i({
        ...
        const t = e.lobbyCamPositions.map((t => ({
        ...
        getMainInstance().cam.setLobbyCamPositions(t)
      }
      e.mapConfig ? this.mapVariablesManager.setVariables(e.mapConfig.globalMapVariables || null, e.mapConfig.randomMapVariableSets || []) : this.mapVariablesManager.setVariables(null, []), this.fireFirstMapAvailable()
    } else if ("gameplayObjects" == e.dataType) {
      const t = e.flags.map((t => ({
        flagTeamId: t.flagTeamId,
        pos: (new Vector3).fromArray(t.pos),
        rot: (new Quaternion).fromArray(t.rot)
      }))),
        s = e.spawnPositions.map((t => t.map((t => ({
          pos: (new Vector3).fromArray(t.pos),
          rot: (new Quaternion).fromArray(t.rot)
        })))));
      i({
    ...
    } else "progress" == e.dataType && t.setPercentage(e.progress)
  }
  initEnvironment() {
    if (this.environmentIsInit) return;
    getMainInstance().materials.precompileShaders(), this.updateWeatherParams();
    const t = new SphereGeometry(700, 8, 6),
      e = new Mesh(t, getMainInstance().materials.skyDomeMat);
    e.frustumCulled = !1, e.name = "skydome", e.renderOrder = -1, getMainInstance().scene.add(e), this.environmentIsInit = !0
  }
  updateWeatherParams() {
    ...
    e.addScalar(this.mapVariablesManager.get("colorAdderAdjust")), getMainInstance().materials.applyWeatherParams({
      colorMultiplier: t,
      colorAdder: e,
  ...
  async loadClouds() {
    ...
    const t = await getMainInstance().assets.getPackage("main").getFileAsBuffer("clouds.glb"),
      e = await getMainInstance().assets.sendWorkerRequest("loadClouds", {
        glbBuffer: t
      });
    this.cloudsObj = AssetsManager.deserializeThreeObject(e), this.cloudsObj && getMainInstance().scene.add(this.cloudsObj), this.updateCloudHeight()
  }
}
class PreferredMapManager {
  ...
  getMatchMakePreferredMapHashes() {
    ...
    for (const n of this.mapsConfigLoader.loadedConfigData.maps) {
      if (e && e !== n.hash) continue;
      if (!this.mapLoader.hasCachedMap(n.hash)) continue;
      let a = 0;
      const o = this.votedScores.get(n.assetName);
      o && (a = o.votedScore, o.hasTemporaryBoost && (a += .5), a -= mapValue(0, 3, 1, 0, o.lastPlayedCounter, !0)), i = Math.min(i, a), s = Math.max(s, a), t.push({
        hash: n.hash,
        preference: a
      })
    }
    if (i = clamp01(i), s = clamp(s, i, 1), i == s)
      for (const e of t) e.preference = 0;
    else
      for (const e of t) e.preference = mapValue(i, s, 0, 1, e.preference, !0);
    return t
  }
  getMatchMakeData() {
    if (!this.mapsConfigLoader.loadedConfigData) return null;
...
class HingeManager {
  ...
  setHingeObjects(t) {
    ...
    for (const {
      ...
      (new Quaternion).setFromRotationMatrix(i.matrixWorld), this.hingeObjects.push({
        object: i,
        behavior: s,
  ...
  shootHinge(t, e, i) {
    ...
    let n = .99,
      a = 5e-4,
      o = .001;
    "light-sturdy" == s.behavior && (n = .9, a = .01, o = .001);
    ...
    return r.physicsValue.velocity += o * h.z, s
  }
  onHingeMove(t, e) {
  ...
  loop(t, e) {
    for (const [i, s] of this.activeHingeObjects) {
      const n = this.hingeObjects[i],
        {
          object: a,
          defaultWorldMatrix: o
        } = n;
      s.physicsValue.loop(t, e), a.matrix.makeRotationZ(s.physicsValue.value), a.matrix.premultiply(o), a.matrixWorld.copy(a.matrix), Math.abs(s.physicsValue.value) < 1e-4 && Math.abs(s.physicsValue.velocity) < 1e-5 && this.activeHingeObjects.delete(i);
...
class Game {
  constructor() {
    this.teamCount = 3, this.useCandyCaneArrow = !1, this.physics = new PhysicsManager, this.players = new Map, this.hingeManager = new HingeManager, this.arrowManager = new ArrowManager(this.physics, this.hingeManager, this.teamCount), this.crosshair = new Crosshair, this.flags = [], this.appearingObjectsManager = new AppearingObjectsManager, this.gameIsVisible = !1, this.receivedColliders = !1, this.scene = null, this.onGameIsVisibleCbs = new Set, this.onUsedForCamShotsOnlyChangeCbs = new Set, this._usedForCameraShotsOnly = !1, this.uiVisible = !1, this.flagScoreUi = new FlagScoreUi(this.teamCount), this.flagScoreUi.onNeedsNotification(this.showFlagNotification.bind(this)), this.healthUi = new HealthUi, this.weaponSelectionDialog = new WeaponSelectionDialogUi, getMainInstance().dialogManager.addDialog(this.weaponSelectionDialog), this.playersListDialog = new PlayersListDialogUi(this.players, getMainInstance().skins, (() => (this.playersListDialog.visible = !1, !1))), getMainInstance().dialogManager.addDialog(this.playersListDialog), this.gameOverStatsDialog = null, this.cornerNotificationsUi = new NotificationIconsUi, this.gameOverNotificationsUi = new NotificationIconsUi("centerbig"), this.crosshairNotificationsUi = new NotificationIconsUi("crosshair"), this.scoreOffsetNotificationsUi = new ScoreOffsetNotificationsUi, this.cornerStatsUi = new CornerStatsUi(this), this.waitingForPlayersInfoText = getMainInstance().mainInfoTextManager.requestInfoText("Waiting for players...", {
      shouldBounce: !1,
      showInMainMenu: !1
    }), this.gameEndLoweringTimeScaleDuration = 6, this.gameEndTitleDurationWin = 3, this.gameEndTitleDurationLose = 2, this.gameEndPlayersListDuration = 6, this.gameEndShowStatsDuration = 8, this.gameEndRewardedAdDuration = 15, this.gameEndShowStatsAfterRewardedDuration = 6, this.trackedMyPlayerScores = new Map, this.spawnPositions = [], this.lobbypawnPositions = [], this.isForegroundGame = !1, this.gameStartTime = 0, this.gameStarted = !1, this.gameEnded = !1, this.gameSeed = 0, this.onGameSeedChangeCbs = new Set, this.finishedGameEndFlow = !1, this.destructed = !1, this.shouldPlayFinalFlagMusic = !1, this.currentFinalFlagMusic = null, this.currentGameEndWaitingMusic = null, this.onMyPlayerChangeCbs = new Set, this.onGameEndCbs = new Set, this.onGameEndFinishCbs = new Set, this.gameEndWaitTimers = [], this.gameEndTimerSuddenChangeDisabled = !1, this.onEstimatedMaxGameEndWaitTimeSuddenChangeCbs = new Set, this.onSdkGameplayStartedChangeCbs = new Set, this.onSquadPlayersChangeCbs = new Set, this.onGameEndAccountStatsChangeCbs = new Set, this.gameEndStepsReachedStatScreens = !1, this.onGameEndStatsScreenCbs = new Set, this.isDoingGameEndSteps = !1, this.gameEndMyTotalScore = 0, this.gameEndReceivedCoins = 0, this.gameEndShowStatsScreen = !1, this.gameEndStatsShowTimer = null, this.gameEndAdBreakTimer = null, this.gameEndRewardedAdTimer = null, this.gameEndStatsAfterRewardedAdTimer = null, this.currentLoadedMapHash = null, this.boundUpdateUiVisible = this.updateUiVisible.bind(this), getMainInstance().mainMenu.onVisibilityChange(this.boundUpdateUiVisible), this.updateUiVisible(), this.boundOnPlayerListDown = this.onPlayerListDown.bind(this), this.boundOnPlayerListUp = this.onPlayerListUp.bind(this);
    const t = getMainInstance().input.getKey("playerList");
    t.onPressedDown(this.boundOnPlayerListDown), t.onPressedUp(this.boundOnPlayerListUp);
    getMainInstance().input.getKey("playerListTouch").onPressedDown(this.boundOnPlayerListDown), this.antiCheat = new AntiCheatManager, this.antiCheat.onPlayerNeedsReport(((t, e, i) => {
      getMainInstance().network.sendReportCheater(t, e, i)
    })), this.chat = new ChatManager(this), getMainInstance().cam.setThirdPersonMode("none")
  }
  destructor() {
    if (this.destructed) return;
    ...
    this.flagScoreUi.destructor(), this.healthUi.destructor(), this.cornerNotificationsUi.destructor(), this.gameOverNotificationsUi.destructor(), this.crosshairNotificationsUi.destructor(), this.scoreOffsetNotificationsUi.destructor(), this.cornerStatsUi && this.cornerStatsUi.destructor(), getMainInstance().mainInfoTextManager.removeInfoText(this.waitingForPlayersInfoText), this.chat.destructor(), getMainInstance().mainMenu.removeOnVisibilityChange(this.boundUpdateUiVisible);
    const t = getMainInstance().input.getKey("playerList");
    t.removeCb(this.boundOnPlayerListDown), t.removeCb(this.boundOnPlayerListUp);
    getMainInstance().input.getKey("playerListTouch").removeCb(this.boundOnPlayerListDown), this.playersListDialog.close(), this.closeGameOverStatsDialog(), this.weaponSelectionDialog.close(), this.gameEndWaitTimers = [], getMainInstance().adBanners.setPageVisibility("gameEnd", !1), this.currentFinalFlagMusic && (this.currentFinalFlagMusic.stop(), this.currentFinalFlagMusic = null), this.currentGameEndWaitingMusic && (this.currentGameEndWaitingMusic.stop(), this.currentGameEndWaitingMusic = null), getMainInstance().classSelectionImageManager.setTeamId(null)
  }
  ...
  async loadMap(t) {
    const e = e => {
      ...
      } else "scene" == e.type && (this.destructed ? MapLoader.disposeMapGeometries(e.scene) : this.setMapScene(e.scene, t), this.hingeManager.setHingeObjects(e.hinges), this.appearingObjectsManager.setAppearingObjects(e.appearingObjects))
    },
      i = getMainInstance(),
      s = i.mapLoader;
  ...
  setMapScene(t, e) {
    this.scene && (MapLoader.disposeMapGeometries(this.scene), getMainInstance().scene.remove(this.scene)), this.scene = t, t && getMainInstance().scene.add(t), this.updateSceneVisibility(), this.updateGameIsVisible(), this.currentLoadedMapHash = e, this.notifyServerCurrentMap()
  }
  updateMapGameplayData(t) {
    if (!this.destructed) {
      ...
      this.spawnPositions = t.spawnPositions, this.arrowManager.arrowAssetName = this.getArrowAssetName()
    }
  }
  getArrowAssetName() {
    return this.useCandyCaneArrow ? "arrowCandyCane.glb" : "arrow.glb"
  }
  setServerGameTime(t) {
  ...
  notifyServerCurrentMap() {
    ...
    this.physics.mapBounds && t.network.sendWorldBounds(this), t.network.sendDefaultFlagPositions(this)
  }
  createPlayer(t, e) {
    const i = getMainInstance(),
  ...
  destroyPlayer(t) {
    ...
    if (e) {
      ...
      e.destructor(), this.players.delete(t), this.playersListDialog.playersListChanged(), getMainInstance().renderer.renderWorthyEventHappened(), i && this.fireSquadPlayersChange()
    }
  }
  setPlayerOwnership(t, e) {
    const i = this.players.get(t);
    i && i.setHasOwnership(e), this.updateUsedForCameraShotsOnly(), getMainInstance().mainMenu.setJoinState("joined"), getMainInstance().gameManager.setJoinedOnce(), this.updatePlayerIconVisibilities(), this.playersListDialog.playersListChanged();
  ...
  updateMyTeamColor() {
    ...
    this.weaponSelectionDialog.setCssColor(t.cssColor, t.cssColorDark), this.healthUi.setCssColor(t.cssColor, t.cssColorDark), getMainInstance().classSelectionImageManager.setTeamId(e)
  }
  setPlayerName(t, e) {
    const i = this.players.get(t);
  ...
  setSameSquadPlayerIds(t) {
    ...
    for (const {
      ...
      t && (t.setIsSameSquadPlayer(!0, s), e = !0)
    }
  ...
  playerChangeFlag(t, e, i) {
    ...
    if (s) {
      const e = this.players.get(t);
      this.gameEnded || (i == NetworkManager.FlagChangeOperation.GRAB || i == NetworkManager.FlagChangeOperation.CAPTURE ? e && e.dead && e.report(CheatKickReason.INVALID_DEATH_OPERATION, 1) : i == NetworkManager.FlagChangeOperation.RETURN && e && e.dead && e.report(CheatKickReason.INVALID_DEATH_OPERATION, 1)), e ? e.changeFlagFromServer(s, i) : i == NetworkManager.FlagChangeOperation.RETURN && s.returnToDefaultPos()
    }
  }
  showFlagNotification(t) {
    ...
    if (1 == t.teamId ? i = 2 : 2 == t.teamId && (i = 1), i) {
      ...
      "capture" == t.type && (a += "Important"), getMainInstance().sfx.playSound("flag/" + a)
    }
  ...
  loop(t, e) {
    ...
    this.chat.loop(), this.hingeManager.loop(t, e), this.arrowManager.loop(t, e), this.crosshair.loop(t, e), this.appearingObjectsManager.loop(t, e);
    const i = getMainInstance(),
      s = i.mapLoader.cloudsObj;
    s && (s.rotation.y = 1e-5 * t, s.updateWorldMatrix(!1, !0));
  ...
  setPlayerServerData(t, e, i, s, n, a, o = !1) {
    ...
    r && r.setServerData(e, i, s, n, a, o), getMainInstance().renderer.renderWorthyEventHappened()
  }
  ...
  createServerArrow(t, e, i, s, n, a, o, r, l) {
    ...
    if (h) {
      const t = new Vector3(i, s, n),
        ...
        u = h.getCamPos(),
        p = u.clone().add(c);
      t.distanceTo(u) > 3 && t.distanceTo(p) > 3 && (t.copy(u), c.set(0, 0, 0)), this.arrowManager.createArrow(h, {
        arrowId: e,
        pos: t,
        networkOffsetPos: c,
        dir: d,
  ...
  offsetPlayerScore(t, e, i) {
    ...
    if (s && s.hasOwnership) {
      ...
      s && (t = s), t += e, this.trackedMyPlayerScores.set(i, t), this.uiVisible && (this.scoreOffsetNotificationsUi.showOffsetNotification(e, i), e > 0 && i == NetworkManager.PlayerScoreOffsetReason.KILL && (this.showKillNotification(), getMainInstance().sfx.playSound("feedback/kill")))
    }
  }
  notifyGameStarted() {
  ...
  receivedGameEndAccountStats(t) {
    this.gameEndReceivedCoins = t.receivedCoins, t.receivedCoins > 0 && getMainInstance().shopState.provideNewCoinCount(t.newCoinCount), this.updateGameEndShowStatsScreen()
  }
  ...
  notifyGameEnded() {
    this.gameEnded = !0, this.updateFinalFlagMusic(), this.updateUsedForCameraShotsOnly(), this.cornerStatsUi.updateVisibility(), getMainInstance().network.markNextCloseAsIntentional(), this.fireSdkGameplayStartedChange(), this.playersListDialog.visible = !1, this.playersListDialog.freezeScores();
    const t = this.getMyPlayer();
    if (t) {
  ...
  async doGameEndSteps() {
    ...
    this.updateUiVisible(), t.mainMenu.hideUi || this.gameOverNotificationsUi.showIcon(`static/img/notificationIcons/gameOver/${n}.svg`), t.cam.setThirdPersonMode("back"), t.sfx.playSound("gameEnd/" + (s ? "win" : "lose")), this.gameEndMyTotalScore = 0, i && (this.gameEndMyTotalScore = i.scoreTotal);
    ...
    if (this.gameEndStatsShowTimer = this.createGameEndWaitTimer(0, "stats"), this.gameEndAdBreakTimer = this.createGameEndWaitTimer(10, "adbreak"), this.updateGameEndShowStatsScreen(), o.start(), await Timeout.promise(1e3 * this.gameEndLoweringTimeScaleDuration), this.destructed || this.finishedGameEndFlow) return;
    if (this.physics.startLoweringTimeScale(), await Timeout.promise(1e3 * a), this.destructed || this.finishedGameEndFlow) return;
    this.currentGameEndWaitingMusic || (this.currentGameEndWaitingMusic = await t.sfx.playSound("music/waiting")), o.clear(), this.playersListDialog.showTeamWonTitle(e), this.playersListDialog.visible = !0, this.playersListDialog.skipText.setVisibility(!0);
    const l = t.settingsManager.getValue("autoSkipStatsScreen");
    if (l && this.playersListDialog.skipText.startTimer(this.gameEndPlayersListDuration), this.playersListDialog.skipText.startCreationCooldown(), t.adBanners.setPageVisibility("gameEnd", !0), this.gameEndStepsReachedStatScreens = !0, this.onGameEndStatsScreenCbs.forEach((t => t())), i && i.updateSmoothCam(), r.start(), await this.playersListDialog.skipText.waitForSkip(), !this.destructed && !this.finishedGameEndFlow) {
      if (r.clear(), this.playersListDialog.visible = !1, this.gameEndShowStatsScreen) {
        let e = 0;
        if (i && (e = i.teamId), this.gameOverStatsDialog = new GameOverStatsDialogUi({
        ...
        })), t.dialogManager.addDialog(this.gameOverStatsDialog), l && this.gameOverStatsDialog.skipText.startTimer(this.gameEndShowStatsDuration), this.gameEndStatsShowTimer.start(), await this.gameOverStatsDialog.skipText.waitForSkip(), this.destructed || this.finishedGameEndFlow) return;
  ...
  finishGameEndFlow() {
    if (this.isDoingGameEndSteps) {
      ...
      this.onMyPlayerChangeCbs.forEach((t => t())), this.finishedGameEndFlow = !0, this.updateUsedForCameraShotsOnly(), this.gameOverNotificationsUi.removeIcon(), this.playersListDialog.visible = !1, this.closeGameOverStatsDialog(), getMainInstance().network.closeCurrentConnection(!0), this.onGameEndFinishCbs.forEach((t => t()))
    }
  }
  onPlayerListDown() {
  ...
  updateGameIsVisible() {
    ...
    t != this.gameIsVisible && (this.gameIsVisible = t, this.updateSceneVisibility(), this.onGameIsVisibleCbs.forEach((t => t())), getMainInstance().renderer.renderWorthyEventHappened())
  }
  onGameIsVisible(t) {
  ...
  updateUiVisible() {
    ...
    this.setUiVisible(t), getMainInstance().hudIcons.setGlobalVisibility(t)
  }
  setUiVisible(t) {
    this.uiVisible = t, this.healthUi.setVisible(t), this.flagScoreUi.setVisible(t), this.crosshair.setGameUiVisibility(t), t || (this.cornerNotificationsUi.removeIcon(), this.crosshairNotificationsUi.removeIcon(), this.scoreOffsetNotificationsUi.removeAll())
  }
}
class MainMenu {
  constructor() {
    ...
    this.el.addEventListener("mousedown", (t => {
      t.target == this.el && (this.onPointerLockElClick(), t.stopImmediatePropagation())
    })), this.currentJoinState = "joinable", this.loadScreenHidden = !1, this.toggledVisibilityState = !1, this.toggleMenuButton = new UiButton({
      isIconButton: !0,
    ...
    }), this.toggleMenuButton.visible = !1, document.body.appendChild(this.toggleMenuButton.el), document.addEventListener("keydown", (t => {
      "Escape" == t.code && this.makeMainMenuVisibleFromUserGesture()
    })), this.visible = !0, this.onVisibilityChangeCbs = new Set, this.contentVisible = !1, this.cornerProfile = new CornerProfile, this.el.appendChild(this.cornerProfile.el), this.menuButtonsContainer = document.createElement("div"), this.menuButtonsContainer.classList.add("menuButtonsContainer", "hidden"), this.el.appendChild(this.menuButtonsContainer), this.settingsDialog = null, this.settingsButton = new MenuButton({
      text: "Settings",
      icon: "static/img/menuUI/settings.svg",
      ...
      onClick: () => {
        const t = getMainInstance();
        this.settingsDialog = new SettingsDialogUi(t.settingsManager, t.dialogManager, t.aprilFools), getMainInstance().dialogManager.addDialog(this.settingsDialog)
      }
    }), this.menuButtonsContainer.appendChild(this.settingsButton.containerEl), this.shopDialog = null, this.shopButton = new MenuButton({
      text: "Shop",
    ...
    }), this.menuButtonsContainer.appendChild(this.shopButton.containerEl), this.userProfileDialog = null, this.loginButton = new MenuButton({
      text: "Account",
      icon: "static/img/menuUI/login.svg",
      testLabel: "account",
      onClick: () => {
        this.userProfileDialog || (this.userProfileDialog = new UserProfileDialogUi, getMainInstance().dialogManager.addDialog(this.userProfileDialog), this.userProfileDialog.addOnCloseCb((() => {
          this.userProfileDialog = null
        })))
      }
    }), this.menuButtonsContainer.appendChild(this.loginButton.containerEl), this.squadDialog = null, this.squadButton = new MenuButton({
      text: "Squad",
    ...
    }), this.menuButtonsContainer.appendChild(this.squadButton.containerEl), this.mapsDialog = null, this.mapsButton = new MenuButton({
      text: "Maps",
    ...
    }), this.menuButtonsContainer.appendChild(this.mapsButton.containerEl), this.installButton = new MenuButton({
      text: "Install",
    ...
    }), this.installButton.setVisibility(!1), this.menuButtonsContainer.appendChild(this.installButton.containerEl), onInstallAvailable((() => {
    ...
    }), this.updateButton.setVisibility(!1), this.menuButtonsContainer.appendChild(this.updateButton.containerEl), onUpdateReady((() => {
      this.updateButton.setVisibility(!0)
    })), this.promoBanner = null;
    const t = document.createElement("ul");
    t.classList.add("bottom-texts", "whiteBigText", "blueNight"), this.el.appendChild(t);
    const e = document.createElement("li");
    e.textContent = "v1677494561", t.appendChild(e);
    const i = document.createElement("li");
    t.appendChild(i);
    const s = document.createElement("a");
    s.textContent = "Privacy Policy", s.href = "https://privacy.pelicanparty.co/", s.target = "_blank", i.appendChild(s), this.currentMusicSfx = null, this.hideUi = !1
  }
  init() {
    const t = getMainInstance();
    t.poki.gameLoadingStart(), t.input.onPointerLockChange(((t, e) => {
    ...
    })), this.cornerProfile.init(), t.network.squadManager.onSquadMembersChange((() => {
  ...
  setJoinState(t) {
    this.currentJoinState = t, getMainInstance().mainInfoTextManager.updateText(), this.updateVisibility(), this.updatePlayingMusic()
  }
  updateSquadButtonText() {
    let t = "Squad";
    getMainInstance().network.squadManager.isInSquad && (t += ` (${getMainInstance().network.squadManager.totalSquadMemberCount})`), this.squadButton.setText(t)
  }
  onPointerLockElClick() {
    if (getMainInstance().renderer.webglCreationFailed) return;
    const {
      didShowSquadDialog: t
    } = getMainInstance().gameManager.joinIfNotJoined(!0);
    t || (this.toggledVisibilityState = !1, this.updateVisibility())
  }
  makeMainMenuVisibleFromUserGesture() {
    this.toggledVisibilityState = !0, this.makeContentVisible(), this.updateVisibility()
  }
  makeContentVisible() {
    if (this.contentVisible) return;
    this.contentVisible = !0, this.menuButtonsContainer.classList.remove("hidden");
    const t = getMainInstance();
    this.promoBanner = new MainMenuPromoBanner(t.config, this, t.gameManager, t.shopState, t.poki, t.dialogManager, t.skins, t.indexedDb), this.el.appendChild(this.promoBanner.el), this.promoBanner.init()
  }
  updateVisibility() {
    let t = !0;
    const e = getMainInstance().gameManager.activeGame;
    if (getMainInstance().input.pointerLocked ? t = !1 : e instanceof Game && e.usedForCameraShotsOnly ? t = !0 : e && e.gameEnded ? t = !1 : this.toggledVisibilityState ? t = !0 : e && e.gameIsVisible && e.getMyPlayer() && (t = !1), t != this.visible) {
      this.visible = t, this.el.style.display = t ? "" : "none";
      const e = getMainInstance();
      e.gameManager.updateSdkGameplayStarted(), e.mainInfoTextManager.updateText(), this.updateToggleMenuVisible();
      for (const e of this.onVisibilityChangeCbs) e(t)
    }
  }
  setVisible(t) { }
  ...
  openShopDialog() {
    return this.shopDialog || (this.shopDialog = new ShopDialogUi, getMainInstance().dialogManager.addDialog(this.shopDialog), this.shopDialog.addOnCloseCb((() => {
      this.shopDialog = null
    }))), this.shopDialog
  }
  openSquadDialog() {
    this.squadDialog || (this.makeMainMenuVisibleFromUserGesture(), this.squadDialog = new SquadDialogUi(getMainInstance().network, getMainInstance().network.squadManager, getMainInstance().gameManager, getMainInstance().avatars, getMainInstance().skins), getMainInstance().dialogManager.addDialog(this.squadDialog), this.squadDialog.addOnCloseCb((() => {
  ...
  openMapsDialog() {
    ...
    const t = getMainInstance();
    this.mapsDialog = new MapsDialogUi(t.config, t.preferredMapManager, t.gameManager), getMainInstance().dialogManager.addDialog(this.mapsDialog), this.mapsDialog.addOnCloseCb((() => {
...
class AdBannerManager {
  ...
  setPageVisibility(t, e) {
    ...
    this.desktopBanner.classList.toggle("hidden", !i), this.mobileBanner.classList.toggle("hidden", !i), getMainInstance().poki.updateBannerVisibility()
  }
}
...
class TouchResponsiveAreaRadius extends TouchResponsiveArea {
  constructor(t, e, i) {
    super(i), this.pos = t || new Vector2, this.radius = e
  }
  testTouchInResponsiveArea(t) {
...
class TouchInputJoyStick extends TouchInputElement {
  ...
  onIsTouchingChange(t) {
    this.doubleTapped = !1, t != this.lastIsTouchingValue && (this.lastIsTouchingValue = t, getMainInstance().now - this.lastIsTouchingToggleTime < 200 && t && (this.doubleTapped = !0), this.lastIsTouchingToggleTime = getMainInstance().now)
  }
  setOpacity(t) {
    this.el.style.opacity = String(t)
  }
  setDefaultPos(t) {
    this.defaultPos = t.clone(), this.responsiveArea instanceof TouchResponsiveAreaRadius && this.responsiveArea.pos.copy(this.defaultPos), this.resetPos()
  }
  resetPos() {
  ...
  setStickPos(t) {
    ...
    n.x = clamp(n.x, 75, window.innerWidth - 75), n.y = clamp(n.y, 75, window.innerHeight - 75), this.stickEl.style.transform = `translate(${e.x}px, ${e.y}px) translate(-50%, -50%)`
  }
}
class TouchInputLook extends TouchInputElement {
  constructor() {
    super(), this.currentTouchId = null, this.prevTouchPos = new Vector2, this.lastDeltaPos = new Vector2
  }
  onUpdateTouch(t) {
  ...
  onEndTouch() {
    this.lastDeltaPos = new Vector2, this.currentTouchId = null
  }
}
class TouchInputButton extends TouchInputElement {
  constructor({
    ...
    super({
      responsiveArea: a,
      cancelOthers: r
    }), this.el.classList.add("touchInputButton", "touchInputWhiteBorder"), this.el.style.width = 2 * n + "px", this.el.style.height = 2 * n + "px", this.left = t, this.right = e, this.top = i, this.bottom = s, this.radius = n, o && (this.el.style.backgroundImage = `url(${o})`), this.updatePosition(), addResizeListener((() => {
      this.updatePosition()
...
class TouchInputManager {
    ...
    this.touchListener = document.createElement("div"), this.touchListener.classList.add("touchListener", "fullScreen"), document.body.appendChild(this.touchListener), this.joyStick = null, this.lookInput = null, this.jumpButton = null, this.fireButton = null, this.toggleWeaponButton = null, this.chatButton = null, this.playerListButton = null, this.thirdPersonButton = null, this.touchElements = [], this.smallCornerButtons = [], this.lastDeltaLook = new Vector2, this.touchSupported = !1, document.body.addEventListener("touchstart", (t => {
      if (!this.touchSupported) {
        this.touchSupported = !0, this.joyStick = new TouchInputJoyStick({
          ...
          cancelOthers: !0
        }), this.playerListButton.addInputKey(getMainInstance().input.getKey("playerListTouch")), this.thirdPersonButton = new TouchInputButton({
          left: 60,
          top: 100,
          radius: 15,
          responsiveArea: new TouchResponsiveAreaRadius(null, 20, !1),
          ...
          cancelOthers: !0
        }), this.thirdPersonButton.addInputKey(getMainInstance().input.getKey("toggleThirdPerson")), this.chatButton = new TouchInputButton({
          left: 100,
          top: 100,
          radius: 15,
          responsiveArea: new TouchResponsiveAreaRadius(null, 20, !1),
          ...
          cancelOthers: !0
        }), this.chatButton.setVisibility(!1), this.chatButton.addInputKey(getMainInstance().input.getKey("toggleChatVisibility")), this.smallCornerButtons = [this.playerListButton, this.thirdPersonButton, this.chatButton], this.touchElements.push(this.playerListButton, this.thirdPersonButton, this.chatButton, this.joyStick, this.jumpButton, this.fireButton, this.toggleWeaponButton, this.lookInput), this.onResize();
      ...
      this.updateCursorVisibility()
    })), this.updateCursorVisibility(), addResizeListener((() => {
      this.onResize()
    })), this.onResize()
  }
  get joyStickValue() {
  ...
  onResize() {
    ...
    for (const t of this.smallCornerButtons) t.top = e ? 50 : 100, t.updatePosition()
  }
...
class InputManager {
  constructor() {
    this.keys = new Map, this.keys.set("left", new InputKey({
      ...
      keyCodes: ["Tab"],
      gamepadButtons: [9]
    })), this.keys.set("playerListTouch", new InputKey), this.keys.set("toggleThirdPerson", new InputKey({
      keyCodes: ["KeyY"],
      gamepadButtons: [8]
    })), this.keys.set("chat", new InputKey({
      keyCodes: ["KeyT"]
    })), this.keys.set("toggleChatVisibility", new InputKey), this.desiredPointerLockedState = !1, window.addEventListener("keydown", (t => {
      this.setKeyCodePressed(t, !0), this._updatePointerLockedState()
    ...
    this.mouseIsOnDocument = !1, document.body.addEventListener("mouseenter", (() => {
      ...
      t(e) && (this.setMouseButtonPressed(e.button, !0), this.mouseIsOnDocument = !0, this._updatePointerLockedState())
    ...
    })), this.stickDeadZone = .1, this.gamepadLookSensivity = 1.2, this.touch = new TouchInputManager, this.mouseMove = new Vector2, this.walkInput = new Vector2, this.lookInput = new Vector2, this.gamepadAxes = []
  }
  init() {
    const t = getMainInstance();
  ...
  loop(t, e) {
    ...
    if (i.mainMenu.visible) this.lookInput.set(0, 0);
      ...
      this.lookInput.multiplyScalar(t.getValue("mouseSensitivity")), t.getValue("invertMouseY") && (this.lookInput.y *= -1), i.aprilFools.needsFlip && (this.lookInput.x *= -1)
    }
  ...
  setKeyCodePressed(t, e) {
    ...
    for (const n of this.keys.values()) {
      ...
      a && (i = !0), o && !s && (t.preventDefault(), s = !0)
    }
  ...
  fireWheelButton(t) {
    ...
    if (e < mapValue(4, 10, 0, 300, this.recentWheelButtonCount, !0)) return;
    this.recentWheelButtonCount += mapValue(50, 2e3, 1, -10, e, !0), this.recentWheelButtonCount = Math.max(0, this.recentWheelButtonCount), this.lastFiredWheelButtonTime = performance.now();
    let i = !1;
  ...
  updateDesiredPointerLockedState() {
    ...
    (e.mainMenu.visible || e.dialogManager.needsUnlockedPointer || i instanceof Game && (i.gameEndStepsReachedStatScreens || i.finishedGameEndFlow) || e.poki.isShowingBreak) && (t = !1), t != this.desiredPointerLockedState && (this.desiredPointerLockedState = t, this.onDesiredPointerLockChangeCbs.forEach((t => t(this.desiredPointerLockedState))), this._updatePointerLockedState())
  }
...
class ShopConfigLoader extends ConfigLoader {
  transformData(t) {
    return t ? (t.purchasableItems ? t.purchasableItems = t.purchasableItems.filter((t => t.id)) : t.purchasableItems = [], t.skinPresets && Array.isArray(t.skinPresets) ? t.skinPresets.map((t => sanitizeSkinData(t))) : t.skinPresets = [], t) : {
      purchasableItems: [],
      skinPresets: []
    }
  }
...
class ConfigManager {
  constructor() {
    this.basePath = null, this.suppressLogs = !1, this.shopConfig = new ShopConfigLoader(this, "shopConfig.json"), this.promosConfig = new PromosConfigLoader(this, "promosConfig.json"), this.mapsConfig = new MapsConfigLoader(this, "mapsConfig.json"), this.allConfigs = [this.shopConfig, this.promosConfig, this.mapsConfig]
  }
  init() {
    const t = parseSearch();
    t.configBasePath ? this.basePath = t.configBasePath : "dev" == t.configEnv || "staging" == t.configEnv || t.pokiDebug || "staging.narrow.one" == location.hostname ? this.basePath = "https://narrow-one.com/stagingconfig/" : "live" == t.configEnv ? this.basePath = "https://narrow-one.com/config/" : "local" == getMainInstance().env || "localhost" == location.hostname && location.pathname.startsWith("/dist/") ? this.basePath = `${location.protocol}//${location.host}/config/` : this.basePath = "https://narrow-one.com/config/", getMainInstance().assets.sendWorkerRequest("configBasePath", {
...
class OfflineRoamingGame {
  constructor() {
    this.physics = new PhysicsManager, this.hingeManager = new HingeManager, this.arrowManager = new ArrowManager(this.physics, this.hingeManager, 1), this.crosshair = new Crosshair, this.destructed = !1, this.receivedColliders = !1, this.scene = null, this.gameIsVisible = !1, this.onGameIsVisibleCbs = new Set, this.onSdkGameplayStartedChangeCbs = new Set, this.prevSdkGameplayStarted = !1;
    const t = getMainInstance();
    this.myPlayer = new Player(this, t.input, t.sfx, this.physics, t.settingsManager, t.hudIcons, 1, {
      needsPlayerModel: !1,
      needsSkeleton: !1
    }), this.myPlayer.init(), this.myPlayer.setHasOwnership(!0), this.loadMap(), this.boundUpdateUiVisible = this.updateUiVisible.bind(this), getMainInstance().mainMenu.onVisibilityChange(this.boundUpdateUiVisible), this.updateUiVisible()
  }
  destructor() {
    this.destructed = !0, this.physics.destructor(), this.hingeManager.destructor(), this.arrowManager.destructor(), this.crosshair.destructor(), this.myPlayer.destructor(), this.setMapScene(null), this.updateSdkGameplayStarted(), getMainInstance().mainMenu.removeOnVisibilityChange(this.boundUpdateUiVisible)
  }
  loadMap() {
    const t = t => {
      if ("colliders" == t.type) {
        ...
        this.physics.buildOctree(), this.receivedColliders = !0, this.updateGameIsVisible()
      } else "scene" == t.type && (this.destructed ? MapLoader.disposeMapGeometries(t.scene) : this.setMapScene(t.scene), this.hingeManager.setHingeObjects(t.hinges))
    };
    getMainInstance().mapLoader.loadLoadingMap(t)
  }
  setMapScene(t) {
    this.scene && (MapLoader.disposeMapGeometries(this.scene), getMainInstance().scene.remove(this.scene)), this.scene = t, t && getMainInstance().scene.add(t), this.updateGameIsVisible()
  }
  get gameStarted() {
    return !1
  }
  ...
  updateGameIsVisible() {
    ...
    t != this.gameIsVisible && (this.gameIsVisible = t, this.onGameIsVisibleCbs.forEach((t => t())), this.updateSdkGameplayStarted(), getMainInstance().renderer.renderWorthyEventHappened())
  }
  onGameIsVisible(t) {
    this.onGameIsVisibleCbs.add(t)
  }
...
class GameManager {
  constructor() {
    this.activeGame = null, this.loadingBackgroundGame = null, this.joinedOnce = !1, this.isInGamesLoop = !1, this.onIsInGamesLoopChangeCbs = new Set, this.onActiveGameChangeCbs = new Set, this.readyToJoin = !1, this.onReadyToJoinChangeCbs = new Set, this.onGameEndCbs = new Set, this.windSfx = null, this.waterSfx = null, this.birdsSfx = null, this.jungleSfx = null, this.rainSfx = null, this.insectsSfx = null
  }
  async init() {
    this.loadWindSfx(), this.loadWaterSfx(), this.loadBirdsSfx(), this.loadJungleSfx(), this.loadRainSfx(), this.loadInsectsSfx(), this.loadOfflineRoamingGame(), await getMainInstance().network.waitForInit(), this.setReadyToJoin(!0), await this.prepareMatchMaking()
  }
  async loadWindSfx() {
  ...
  setAmbientVolumes(t, e, i, s, n, a) {
    this.waterSfx && this.waterSfx.setVolume(e), this.windSfx && this.windSfx.setVolume(t), this.birdsSfx && this.birdsSfx.setVolume(i), this.jungleSfx && this.jungleSfx.setVolume(s), this.rainSfx && this.rainSfx.setVolume(n), this.insectsSfx && this.insectsSfx.setVolume(a)
  }
  ...
  loop(t, e) {
    if (this.activeGame && this.activeGame.loop(t, e), this.rainSfx) {
      ...
      if (e.mapLoader.mapVariablesManager.get("lightningEnabled")) {
        ...
        if (s > 0) {
          let e = 0;
          e += Math.cos(.02 * t), e += Math.cos(.06 * t), e += Math.cos(.09 * t), n += clamp01(e / 3) * s * 3
        }
  ...
  async prepareMatchMaking(t = !1, e = !1) {
    if ((!e || getMainInstance().network.matchMaking.isInUnreadyQueue) && getMainInstance().network.shouldUseMatchMaking && (await getMainInstance().network.matchMaking.initConnection(), t)) {
      if (e && !getMainInstance().network.matchMaking.isInUnreadyQueue) return;
      const t = this.getOnlineGame();
      if (t && !t.canEstimateGameEndWaitTime()) return;
  ...
  connectionClosed() {
    this.activeGame && this.activeGame instanceof Game && (this.activeGame.gameEnded || (this.loadOfflineRoamingGame(), this.updateSdkGameplayStarted(), this.fireCurrentGameChangeCbs(), getMainInstance().mainMenu.setJoinState("joinable"), this.setIsInGamesLoop(!1))), this.setReadyToJoin(!0)
  }
  destroyCurrentGame() {
  ...
  joinIfNotJoined(t = !1) {
    ...
    let s = !1,
      n = !1;
    if (i instanceof Game && !i.usedForCameraShotsOnly && (n = !0), !n) {
      ...
      if (i.isInSquad || i.isJoiningSquad) {
        if (i.isInSquad && 1 == i.totalSquadMemberCount && !i.matchMakeAllReady) {
          ...
          e.gameManager.activeGame instanceof OfflineRoamingGame && (e.mainMenu.openSquadDialog(), s = !0)
        }
  ...
  async checkExistingGameAndJoin() {
    const t = getMainInstance();
    if (getMainInstance().renderer.webglCreationFailed) return !1;
  ...
  joinGameWithoutAd() {
    this.readyToJoin && (this.setReadyToJoin(!1), getMainInstance().network.prepareJoinGame())
  }
  async joinGameAfterAd() {
    this.readyToJoin && (this.setReadyToJoin(!1), await getMainInstance().poki.commercialBreak(), await getMainInstance().network.prepareJoinGame())
  }
...
class CameraManager {
  constructor() {
    this.baseFov = 90, this.cam = new PerspectiveCamera(65, 1, .08, 900), this.cam.name = "cam", this.cam.updateMatrixWorld(), this.isDoingLobbyShots = !1, this.prevHasPlayer = !1, this.lobbyCamPositions = null, this.hasDoneFirstLobbyShot = !1, this.currentLobbyShot = null, this.currentLobbyShotT = 0, this.currentLobbyShotDuration = 5e3, this.thirdPersonMode = "none", this.onThirdPersonChangeCbs = new Set, this.thirdPersonPhysicsNeedsReset = !1, this.thirdPersonPhysics = new PhysicsValue3d({
      dampening: .1,
      springMultiplier: .08
  ...
  init() {
    ...
    t.scene.add(this.cam), t.settingsManager.onValueChange("fov", (t => {
      this.baseFov = t, getMainInstance().renderer.renderWorthyEventHappened()
    }));
  ...
  loop(t, e) {
    ...
    let n = !1;
    const a = !!i;
    if (a != this.prevHasPlayer && (this.prevHasPlayer = a, a || (this.cam.fov = 65, this.cam.updateProjectionMatrix())), a && i) {
      const n = i.getCamPos();
      let a;
      if (a = "front" == this.thirdPersonMode ? i.getFrontThirdPersonCamRot() : i.getCamRot(), this.cam.quaternion.copy(a), this.thirdPerson) {
        if (this.thirdPersonPhysicsNeedsReset) this.thirdPersonPhysics.value = n, this.thirdPersonOffsetPhysics.value = new Vector3(0, 0, 0), this.thirdPersonPhysicsNeedsReset = !1;
        else {
          const o = n.clone();
          ...
          this.thirdPersonPhysics.target = o, this.thirdPersonPhysics.loop(t, e);
          let r = 0;
          ...
          if (p) {
            ...
            if (t) {
              const e = p.physics.rayCastMapColliders(t, (t => !t.collider.ignoreArrows && (!(t.collider.excludeTeamId >= 0) && !(t.collider.slowDownPlayerAmount > 0))));
              if (e) {
                const t = e.dist - .3;
          ...
          this.thirdPersonOffsetPhysics.target = h, this.thirdPersonOffsetPhysics.loop(t, e)
        }
        const o = this.thirdPersonOffsetPhysics.value;
        o.applyQuaternion(a), this.cam.position.copy(this.thirdPersonPhysics.value), this.cam.position.add(o)
      } else this.cam.position.copy(n);
      let o = this.baseFov;
      i.activeWeapon && (o = i.activeWeapon.adjustFov(o)), this.cam.fov = lerp(this.cam.fov, o, .1), this.cam.updateProjectionMatrix(), this.cam.updateMatrixWorld()
    } else if (this.lobbyCamPositions && (n = !0, s.renderer.needsRenderFrame)) {
    ...
    n != this.isDoingLobbyShots && (this.isDoingLobbyShots = n, getMainInstance().renderer.updateMainCanvasRenderEnabled())
  }
...
class HudIcon {
  constructor(t, {
    ...
    this.manager = t, this.size = e, this.nearest = s, this.visible = !0, this.texture = null, this.mat = t.mat.clone(), this.obj = new Mesh(t.geo, this.mat), this.obj.renderOrder = 1, this.obj.frustumCulled = !1, getMainInstance().scene.add(this.obj), this.updateIconSize(window.innerHeight, window.innerWidth), this.setUrl(i)
  }
  destructor() {
    this.disposeTexture(), this.mat.dispose(), getMainInstance().scene.remove(this.obj)
  }
  updateIconSize(t, e) {
  ...
  setUrl(t) {
    this.disposeTexture();
    const e = new Image;
    e.src = t, e.width = 512, e.height = 512, this.texture = new Texture(e), this.nearest && (this.texture.minFilter = NearestFilter, this.texture.magFilter = NearestFilter), this.mat.uniforms.map.value = this.texture, e.onload = t => {
...
class HudIconsManager {
  constructor() {
    this.globalVisibility = !0, this.geo = new PlaneGeometry, this.mat = new ShaderMaterial({
      name: "hudIcon",
    ...
    }), this.createdIcons = new Set, addResizeListener((() => {
      this.onResize()
    })), this.onResize()
  }
  onResize() {
...
class ScreenFlash {
  constructor(t, e, i, s) {
    this.scene = t, this.material = e.clone(), this.material.uniforms.vignetteAmount.value = i, this.material.uniforms.theta.value = s;
    const n = new PlaneGeometry(2, 2);
    this.obj = new Mesh(n, this.material), this.obj.frustumCulled = !1, t.add(this.obj), this.creationTime = getMainInstance().now, this.shouldBeDestroyed = !1
  }
  destructor() {
...
class ScreenFlashManager {
  ...
  flash(t, e) {
    ...
    const i = this.getThetaFromArrowHitNormal(t),
      s = new ScreenFlash(this.scene, this.material, 1 - e, i);
    this.createdFlashes.add(s)
  }
  getThetaFromArrowHitNormal(t) {
    ...
    const n = e.dot(i);
    let a = Math.acos(n);
    return s.y > 0 && (a *= -1), mod(a, 2 * Math.PI) - Math.PI
  }
  loop(t) {
    const e = new Set;
...
class RenderOverlay {
  constructor({
    ...
    this.scene = new Scene, this.cam = new PerspectiveCamera, this.cam.matrixAutoUpdate = !1, this.minFov = t, this.maxFov = e, this.near = i, this.far = s, this.enabled = !0
  }
  updateProjectionMatrix() {
    this.cam.near = this.near, this.cam.far = this.far;
    const t = getMainInstance().cam;
    this.cam.fov = smoothClamp(t.fov, this.minFov, this.maxFov), this.cam.aspect = t.cam.aspect, this.cam.updateProjectionMatrix()
  }
}
class Renderer {
  constructor() {
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            console.error("Failed to create WebGLRenderer:", t), this.webglCreationFailed = !0, getMainInstance().mainInfoTextManager.updateText()
          }
        }
      }
    }
    this.renderer && (this.renderer.outputEncoding = sRGBEncoding, this.renderer.autoClear = !1, this.canvas = this.renderer.domElement, this.canvas.classList.add("fullScreen", "mainCanvas"), this.canvas.inert = !0, document.body.appendChild(this.canvas)), this.updateSmoothFiltering(), this.onResize()
  }
  ...
  updateMainCanvasRenderEnabled() {
    ...
    } else e.gameManager.activeGame && (t = this.renderWorthyEventEndTime > performance.now(), t = !0);
  ...
  renderCameras() {
    if (this.renderer) {
      ...
      if (i && this.setSize(s, n), this.needsRenderFrame && this.renderWidth > 0 && this.renderHeight > 0) {
        this.renderer.clear(), this.renderer.setViewport(0, 0, window.innerWidth * this.resolutionMultiplier, window.innerHeight * this.resolutionMultiplier), this.renderer.render(getMainInstance().scene, getMainInstance().cam.cam);
...
class ArrowAssetCache {
  constructor() {
    this.cachedAssetPromises = new Map
  }
  getArrowAssetWithCache(t, e) {
    let i = this.cachedAssetPromises.get(t);
    i || (i = new Map, this.cachedAssetPromises.set(t, i));
    const s = i.get(e);
    if (s) return s;
    const n = this.getAsset(t, e);
    return i.set(e, n), n
  }
  async getAsset(t, e) {
    const i = await getMainInstance().assets.loadGlbViaWorker(t, {
      teamId: e,
      packageName: "main",
      keepCustomProperties: []
    });
    if (!i) throw new Error(`Failed to load ${t}`);
    return i.name = "arrow", i
  }
}
...
class SfxSound {
  ...
  destructor() {
    this.destructed = !0, getMainInstance().sfx.sfxDestructed(this)
  }
  async init() {
    return !getMainInstance().sfx.muted || this.opts.loop || this.opts.overrideMute ? (this.setVolume(this.opts.volume || 0, !0), this.opts.autoPlay && await this.start(!0), this.setMuted(getMainInstance().sfx.muted), !0) : (this.destructor(), !1)
  }
  setVolume(t, e = !1) {
    const i = getMainInstance().sfx.ctx;
    if (!i) return;
    this.lastSetVolume = t;
    t *= getMainInstance().settingsManager.getValue(this.opts.isMusic ? "musicVolume" : "sfxVolume") / 100, this.gainNode && (e ? this.gainNode.gain.value = t : this.gainNode.gain.linearRampToValueAtTime(t, i.currentTime + .1))
  }
...
class SfxManager {
  constructor() {
    if (window.AudioContext = window.AudioContext || window.webkitAudioContext, this.supported = !!AudioContext, this.packageName = "sfx" + SfxManager.audioFormatCamelCase, this.cachedSfx = {}, this.createdSfx = [], this.settingsMuted = !0, this.adsMuted = !1, this.muted = !0, this.supported) {
      ...
      for (const t of this.soundsConfig) this.cachedSfx[t.name] = new CachedSfx(t, this.ctx);
  ...
  async downloadPackage() {
    ...
    await getMainInstance().mapLoader.waitForFirstMapDownload(), t.startDownloading()
  }
  loop(t, e) {
...
class LoginDialogUi extends DialogUi {
  constructor(t = "login") {
    ...
    if ("login" == t) {
      const t = document.createElement("div");
      t.classList.add("dialog-art-wrapper"), e.appendChild(t), e.classList.add("contains-art");
      ...
      for (const t of s) {
        let e = null;
        t === s[s.length - 1] ? (e = document.createElement("img"), e.src = t.src, e.classList.add("dialog-art")) : (e = document.createElement("source"), e.type = t.type, e.srcset = t.src), i.appendChild(e)
      }
    }
...
function getUrl() {
  ...
  return t.searchParams.get("useProductionServers") && (t.href = "https://narrow.one/"), getMainInstance().poki.isPokiBuild && (t.searchParams.get("pokiDebug") ? t.href = "https://staging.narrow.one/" : t.href = "https://narrow.one/"), t
}
...
class AuthManager {
    ...
    this.oAuthProviderConfigs = new Map, this.oAuthProviderConfigs.set("google", {
      ...
      if (t.origin == getOrigin() && t.data) {
        ...
        if ("requestOpenerOrigin" == t.data.type) t.source && e.postMessage({
          ...
          this.handleAuthToken(i), this.closeOpenOAuthWindows()
        }
      }
    })), this.syncGuestDataWithRestServiceInstance = new SingleInstancePromise((async () => await this.syncGuestDataWithRestServiceFn())), this.isInit = !1, this.onInitCbs = new Set
  }
  async init() {
    try {
      this.currentSessionData = await getMainInstance().indexedDb.get("currentAuthSessionData"), this.prevSessionNonce = await getMainInstance().indexedDb.get("prevSessionNonce")
    } catch { }
    this.isInit = !0;
    for (const t of this.onInitCbs) t();
    this.onInitCbs.clear();
  ...
  async showLoginDialog(t = "login") {
    ...
    return getMainInstance().dialogManager.addDialog(e), await e.waitForFlowEnd()
  }
  getSessionNonce() {
  ...
  async getOAuthUrl(t) {
    ...
    h.includes("id_token") && (l = "id_token"), !h.includes(l) && h.length > 0 && (l = h[0]), r.searchParams.set("response_type", l), r.searchParams.set("client_id", a.clientId);
    ...
    if (o.scopes_supported) {
      for (const t of c) o.scopes_supported.includes(t) || c.delete(t);
      if (0 == c.size)
        for (const t of o.scopes_supported) c.add(t)
    }
    const u = "facebook" == t ? "," : " ";
    return r.searchParams.set("scope", Array.from(c).join(u)), "apple" == t && o.response_modes_supported && o.response_modes_supported.includes("form_post") && r.searchParams.set("response_mode", "form_post"), r.searchParams.set("nonce", this.getSessionNonce()), r.href
  }
  async oAuthLogin(t) {
    let e = null;
    ...
    if (!s) return e && e.close(), getMainInstance().dialogManager.showAlert({
  ...
  async handleAuthToken(t, e = !1) {
    ...
    if (this.setAuthTokenBody(t, a), a.set("nonce", i), this.isLoggedIn) {
      ...
      n = await this.fetchAuthSessionData(t, a), n && (this.fireLoggedInAccountChange(), await this.mergeGuestDataWithLoggedInAccount())
    }
  ...
  async mergeAccountToCurrent(t, e) {
    ...
    this.setAuthTokenBody(t, s), s.set("nonce", e);
    let n = null;
    try {
    ...
    return !(!n || !n.ok) && (this.fireLoggedInAccountChange(), !0)
  }
  ...
  async mergeGuestDataWithLoggedInAccount() {
    ...
    if (n) a = !0;
      ...
      "invalid-guest-data" == t ? (console.error("Failed to merge guest data with login account. The guest data may already have been merged."), a = !0) : console.error("Failed to merge guest data with login account: " + t)
    }
    return a && await this.setGuestAccountData(null), n && this.fireLoggedInAccountChange(), !0
  }
  ...
  async getSessionDataForGameServer() {
    return await this.waitForInit(), this.isLoggedIn && (await this.refreshSessionIfNeeded(), this.currentSessionData) ? {
      type: "sessionToken",
...
class StateManager {
  constructor(t, e) {
    this.authManager = t, this.indexedDb = e, this.onStateChangedCbs = new Set, this.cachedStateIndexDbKey = "cachedState", this.getStateUrl = "", this.fetchCurrentDataInstance = new SingleInstancePromise((async () => await this.fetchCurrentDataFn())), this.stateIsStale = !0
  }
  init() {
...
class ProfileStateManager extends StateManager {
  ...
  async setUsername(t) {
    ...
    return s && (this.username = t, this.fireStateChanged()), s
  }
}
class ShopStateManager extends StateManager {
  ...
  async sendPurchaseItemRequest(t) {
    ...
    i || (i = (async () => {
      ...
      return await this.authManager.requestWithAuthHeader((async s => {
        ...
        return a.ok && (await this.waitForCurrentDataFetch(), t.price && t.price > 0 && (this.ownedCoins -= t.price), this.purchasedItems.add(e), this.fireStateChanged(), this.authManager.syncGuestDataWithRestService()), {
  ...
  async purchasePaidItem(t, e) {
    ...
    return i ? (getMainInstance().sfx.playSound("ui/purchaseShopItem"), !0) : ("not-enough-coins" === s ? e.showAlert({
...
class PokiManager {
  ...
  async init() {
    if (this.usePokiSdk) {
      ...
      this.onPokiInitCbs = [], this.updateBannerVisibility(), getMainInstance().mainMenu.onVisibilityChange((t => {
        this.updateBannerVisibility()
      }))
    }
  }
  ...
  async rewardedBreak({
    ...
    this.isShowingRewardedBreak = !0, this.updateIsShowingBreak(), await this.waitForInit(), getMainInstance().sfx.setMutedAds(!0);
    let s = !1;
    try {
    ...
    return getMainInstance().sfx.setMutedAds(!1), this.isShowingRewardedBreak = !1, this.updateIsShowingBreak(), this.onRewardedBreakFinishCbs.forEach((t => t())), this.onRewardedBreakFinishCbs.clear(), s ? {
      success: !0
    } : {
      success: !1,
  ...
  async rewardedBreakWithErrorDialog(t) {
    ...
    if (!e.success) {
      ...
      return "adblocker" == e.error && (t = "Please disable your adblocker."), getMainInstance().dialogManager.showAlert({
  ...
  async commercialBreak() {
    if (this.supported && this.pokiInit) {
      getMainInstance().sfx.setMutedAds(!0), this.isShowingCommercialBreak = !0, this.updateIsShowingBreak();
      try {
        await PokiSDK.commercialBreak()
      } catch (t) {
        console.error(t)
      }
      getMainInstance().sfx.setMutedAds(!1), this.isShowingCommercialBreak = !1, this.updateIsShowingBreak()
    }
  }
...
const quantcastFunction = function () {
    ...
    function () {
      ...
      i || (! function e() {
        ...
        s && window.__tcfapi(s.command, s.version, ((i, n) => {
          ...
          e && (a = JSON.stringify(a)), t && t.source && t.source.postMessage && t.source.postMessage(a, "*")
        }), s.parameter)
      }), !1))
    }();
  var n = function () {
  ...
  const a = function () {
    s++, window.__uspapi === n && s < 3 ? console.warn("USP is not accessible") : clearInterval(o)
  };
...
class QuantcastManager {
  init(t) {
    if (t && !getMainInstance().poki.isPokiBuild) try {
      quantcastFunction()
    } catch (t) {
...
class Avatar {
  constructor(t, e) {
    this.avatarsManager = t, this.config = e, this.blobUrlReferences = new Set, this.onDestructedCbs = new Set, this.blobUrl = null, this.createAvatarInstance = new SingleInstancePromise((async () => {
...
class AvatarsManager {
  ...
  async generateAvatarBlob(t) {
    ...
    } = this.fillConfigDefaults(t), h = new PlayerSkeleton({
    ...
    t.bow && (c = new BowAssetLoader({
      useWorldWeather: !1
    }), c.setConfig(t.bow), await c.waitForLoad()), await d.waitForInit(), await h.waitForLoad();
    const u = [];
    for (const t of l) {
    ...
    await Promise.all(u), h.applyLayers(), h.updateMatrices(), d.applySkeleton(h);
    const p = new Scene;
    if (p.name = "Avatar scene", !d.obj) return null;
    if (p.add(d.obj), c) {
      ...
      p.add(c.obj), c.obj.matrixAutoUpdate = !1, c.obj.matrix.copy(t.matrixWorld)
    }
    const g = new PerspectiveCamera;
    g.far = 10, g.aspect = i / s, g.updateProjectionMatrix(), "face-close" == e ? g.position.set(0, 1.75, .7) : "face" == e ? g.position.set(0, 1.7, .9) : "upper-body" == e ? g.position.set(0, 1.5, 1.3) : "full-body" == e && g.position.set(0, 1.1, 2.5);
    const m = this.renderer.createRenderView({
      width: i,
      height: s
    });
    m.setRenderObjects(p, g, !0), await m.waitForFrameRender();
    const f = await m.getBlob();
    if (this.renderer.removeRenderView(m), d.destructor(), c && c.destructor(), !f) return null;
    ...
    if ("circle" == r) {
      ...
      b.arc(i / 2, s / 2, .45 * t, 0, 2 * Math.PI), b.clip()
    }
    b.fillStyle = n, b.globalAlpha = a, b.fillRect(0, 0, i, s), b.globalAlpha = 1;
    const y = URL.createObjectURL(f),
      S = new Image;
    S.src = y, await new Promise(((t, e) => {
      S.onload = t, S.onerror = e
    })), b.drawImage(S, 0, 0), URL.revokeObjectURL(y);
  ...
  configToCacheKey(t) {
    ...
    h.push(e), h.push(i), h.push(s), h.push(n), h.push(a), h.push(r), h.push("skeletonStart");
    for (const t of l) h.push(t);
    return h.push("skeletonEnd"), h.push(getMainInstance().skins.skinObjectOptsToCacheKey(o)), h.join("-")
  }
  getAvatar(t) {
    const e = this.configToCacheKey(t);
    let i = this.createdAvatars.get(e);
    return i || (i = new Avatar(this, t), i.onDestructed((() => {
...
class ClassSelectionImageManager {
  ...
  async loadClassBlobUrl(t) {
    ...
    if (!(l && l.lastLoadingSym != a || (e.url = r, s && s.destructor(), n && n == r)))
  ...
  createClassBlobUrl(t) {
    ...
    return i.avatars.getAvatar({
      ...
      bow: {
        ...
        bowId: e.bowId,
        arrowCount: 1,
        skins: i.skins.skinNetworkDataToBowAssetNames(e.bowId, s)
      }
    }).getBlobUrlReference()
  }
  setTeamId(t) {
...
class AprilFoolsManager {
  constructor(t) {
    this.settingsManager = t, this.isAprilFirst = isDay(1, 4), t.onSettingsLoaded((() => {
...
class MainInfoText {
  constructor(t, {
    ...
    this.text = t, this.showPercentage = i, this.shouldBounce = s, this.showInMainMenu = n, this.priority = a, this.percentage = 0, this.isLoading = e, this.onStateChangeCbs = new Set
  }
  setIsLoading(t) {
...
class MainInfoTextManager {
  ...
  updateText() {
    ...
    let s = !0,
      n = null,
      a = !0;
    if (t.renderer.webglCreationFailed) n = "Failed to create WebGl context.", s = !1;
    else {
      const t = Array.from(this.loadingTexts);
      t.sort(((t, e) => e.priority - t.priority));
      for (const e of t)
        if ((e.showInMainMenu || !i) && e.isLoading) {
          s = e.shouldBounce, n = e.getText();
          break
        }
    }
    if (!n) switch (e.currentJoinState) {
      case "joinable":
        n = "Click to join";
        break;
      case "joined":
        n = "Click to play", i || (a = !1)
    }
    const o = t.gameManager.activeGame;
    o && o.gameEnded && o.getMyPlayer() && (a = !1), this.infoTextEl.textContent = n || "", this.infoTextEl.classList.toggle("scaleBounce", s), this.infoTextEl.classList.toggle("bottom", !i), this.infoTextEl.classList.toggle("hidden", !a)
  }
}
class Main {
  constructor() {
    ...
    const t = parseSearch();
    t.thirdParty && (this.thirdPartyEnabled = "false" != t.thirdParty), this.scene = new Scene, this.scene.autoUpdate = !1, DebugLine.setCurrentScene(this.scene), this.indexedDb = new IndexedDbUtil, this.settingsManager = new SettingsManager(this.indexedDb), this.mainInfoTextManager = new MainInfoTextManager, this.mainMenu = new MainMenu, this.adBanners = new AdBannerManager, this.dialogManager = new DialogManager, this.input = new InputManager, this.config = new ConfigManager, this.mapLoader = new MapLoader(this.config, this.config.mapsConfig), this.preferredMapManager = new PreferredMapManager(this.mapLoader, this.config.mapsConfig), this.gameManager = new GameManager, this.cam = new CameraManager, this.materials = new MaterialsManager, this.hudIcons = new HudIconsManager, this.screenFlash = new ScreenFlashManager(this.scene, this.cam.cam), this.renderer = new Renderer, this.assets = new AssetsManager, this.arrowAssetCache = new ArrowAssetCache, this.skins = new SkinManager, this.skeletons = new SkeletonLoader, this.avatars = new AvatarsManager(this.renderer), this.classSelectionImageManager = new ClassSelectionImageManager, this.sfx = new SfxManager, this.network = new NetworkManager(this.gameManager), this.auth = new AuthManager, this.profileState = new ProfileStateManager(this.auth, this.indexedDb), this.shopState = new ShopStateManager(this.auth, this.indexedDb), this.quantcastManager = new QuantcastManager, this.poki = new PokiManager(this.thirdPartyEnabled), this.aprilFools = new AprilFoolsManager(this.settingsManager), this.boundLoop = this.vsyncLoop.bind(this), this.prevNow = 0, this.now = 0, this.dt = 0, this.smoothDt = 0, this.useFakeNow = !1, this.fakeNow = 0, this.fastLoopCount = 1, this.frameCount = 0, this.frameCap = 1;
  ...
  init() {
    this.settingsManager.init(), this.mainMenu.init(), this.input.init(), this.adBanners.init(), this.mapLoader.init(), this.config.init(), this.materials.init(), this.gameManager.init(), this.cam.init(), this.renderer.init(), this.materials.screenFlashMat && this.screenFlash.setMaterial(this.materials.screenFlashMat), this.skins.init(), this.classSelectionImageManager.init(), this.sfx.init(), this.network.init(), this.auth.init(), this.profileState.init(), this.shopState.init(), this.quantcastManager.init(this.thirdPartyEnabled), this.poki.init(), window.requestAnimationFrame(this.boundLoop), this.settingsManager.onValueChange("theme", (() => {
      this.updateTheme()
    })), this.darkMedia.addEventListener("change", (() => {
      this.updateTheme()
    })), this.updateTheme(), installServiceWorker()
  }
  updateTheme() {
  ...
  loop() {
    ...
    this.prevNow = t, this.now += i, t = this.now, this.dt = i, this.dt16 = this.dt / 16.6666, this.smoothDt = lerp(this.smoothDt, this.dt, .1), this.mainMenu.loop(t, i), this.input.loop(t, i), this.gameManager.loop(t, i), this.cam.loop(t, i), this.screenFlash.loop(t), DebugLine.loop(), this.renderer.loop(t, i), this.sfx.loop(t, i)
  }
}
...
function init() {
  ...
  if (window.Intl && Intl.RelativeTimeFormat) {
    const e = new Intl.RelativeTimeFormat,
      i = Date.now() / 1e3 - Number("1677494561");
